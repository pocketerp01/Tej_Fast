<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="drawrcpt" Title="Drawing Receipt Entry" CodeFile="drawrcpt.aspx.cs" %>
   ...
   <span style="align:center;">   
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <asp:Label ID="lbl1a" runat="server" Text="DR" Style="width: 22px; float: right;" CssClass="col-sm-1 control-label"></asp:Label>
                                </div>
                                <div class="col-sm-3">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-1" style="display:none;">
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnedn_Click" />
                                </div>
                                <div class="col-sm-9">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                  ...
                                  <asp:Label ID="Label4" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Issued_By</asp:Label>                               
                                <div class="col-sm-3">
                 ...
                 <div class="col-md-6">
                    <div>
                        <div class="box-body">
                             ...
                             <div class="form-group">
                                <asp:Label ID="Label5" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Return_Target_Date</asp:Label>                               
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtrdate" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                  ...
                                  <asp:Label ID="Label6" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Issued_Date</asp:Label>                               
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtisdate" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                      <asp:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="True" TargetControlID="txtisdate" Format="dd/MM/yyyy">
                                    </asp:CalendarExtender>
                                    <asp:MaskedEditExtender ID="txtisdate_MaskedEditExtende3" runat="server" Mask="99/99/9999" MaskType="Date" TargetControlID="txtisdate" />
                                </div>
                            </div>

                               <div class="form-group">
                                <asp:Label ID="Label7" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Actual_Return_Date</asp:Label>                               
                                <div class="col-sm-3">
                                  ...
                                  <asp:Label ID="Label8" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Delay_if_Any</asp:Label>                               
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtdelay"  runat="server" CssClass="form-control" Width="100%" MaxLength="50"></asp:TextBox>
                                </div>
                            </div>

                              <div class="form-group">
                                <asp:Label ID="Label9" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Reason_for_Delay</asp:Label>                               
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtreason"  runat="server" CssClass="form-control" Width="100%" MaxLength="200"></asp:TextBox>
                                </div>                                  
                            </div>
    ...
    <%-- <table style="width: 100%;">
       <tr>
        ...
        <%--<tr>
            <td>EDN<span style="color: red">*</span></td>
            <td colspan="3">
                ...
                <asp:ImageButton ID="btnedn" runat="server" Height="22px"
                    ImageUrl="~/css/images/bdsearch5.png" ToolTip="EDN" Width="24px"
                    OnClick="btnctye_Click" ImageAlign="Middle" />

            </td>
        </tr>
              <tr style="background-color: #CDE8F0">
            <td>Drawing No.<span style="color: red">*</span></td>
            <td colspan="3">
       ...
       <%-- <tr>
            <td>Drawing Type<span style="color: red">*</span></td>
            <td colspan="3">
      ...
      <%--  <tr>
            ...
            <td>
                <asp:TextBox ID="txtiby" runat="server"
                    placeholder="Issued By" onfocus="Change(this, event)"
                    onblur="Change(this, event)" ReadOnly="true"></asp:TextBox>
      ...
      <%--  <tr style="background-color: #CDE8F0">
            <td>Return Target Date<span style="color: red">*</span></td>
            <td>
                <input name="txtrdate" type="text" id="txtrdate" placeholder="dd/mm/yyyy" runat="server" readonly="readonly" tabindex="-1" />
            </td>
            <td>Issued Date</td>
            <td>
                <input name="txtisdate" type="text" id="txtisdate" placeholder="dd/mm/yyyy" runat="server" readonly="readonly" tabindex="-1" />
            </td>
        </tr>--%>
       <%-- <tr>
            <td>Actual Return Date<span style="color: red">*</span></td>
            <td>
                <input name="txtidate" type="text" id="txtidate" placeholder="dd/mm/yyyy" runat="server" readonly="readonly" tabindex="-1" />
            </td>
            <td>Delay if Any</td>
            <td>
                <asp:TextBox ID="txtdelay" runat="server"
                    placeholder="Delay if Any" onfocus="Change(this, event)"
                    onblur="Change(this, event)" ReadOnly="true"></asp:TextBox>
...
<%--        <tr>
            <td>Reason for Delay<span style="color: red">*</span></td>
            <td colspan="3">
                <asp:TextBox ID="txtreason" runat="server"
                    placeholder="Reason for Delay" onfocus="Change(this, event)"
                    onblur="Change(this, event)" Width="845px"></asp:TextBox>
       ...
       <%-- <tr>
            ...
            <td>
                <asp:TextBox ID="txtpre" runat="server"
                    placeholder="Prepared By" onfocus="Change(this, event)"
            ...
            <td>
                <asp:TextBox ID="txtedit" runat="server"
                    placeholder="Modified By" onfocus="Change(this, event)"
                    onblur="Change(this, event)"
                    ReadOnly="true"></asp:TextBox>
            </td>
