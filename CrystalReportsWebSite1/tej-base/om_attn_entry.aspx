<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_attn_entry" CodeFile="om_attn_entry.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right">
                        ...
                        <button type="submit" id="btnlist" class="btn btn-info" style="width: 100px;" visible="false" runat="server" accesskey="t" onserverclick="btnlist_ServerClick">Lis<u>t</u></button>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtvchnum" runat="server" Width="80px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtvchdate" placeholder="Date" runat="server" Width="350px" CssClass="form-control" Height="24px"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl4" runat="server" Text="Grade" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4" runat="server" Width="80px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4a" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                    <td>
                                        <asp:Label ID="lbl7" runat="server" Text="Branch" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                    ...
                                    <td colspan="2">
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl7" runat="server" Width="467px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4" style="display: none">
                                            <asp:TextBox ID="txtlbl7a" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr style="display: none;">
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl101" runat="server" Width="80px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl101a" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="24px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl2" runat="server" Text="Ent_By" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl2" runat="server" ReadOnly="true" CssClass="form-control" Height="24px" Width="143px"></asp:TextBox>
                                        </div>
                                    </td>

                                    <td>
                                        <asp:Label ID="lbl3" runat="server" Text="Ent_Dt" CssClass="col-sm-2 control-label"></asp:Label>

                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl3" runat="server" ReadOnly="true" CssClass="form-control" Height="24px" Width="143px"> </asp:TextBox>
                                        </div>
                                    </td>
                                ...
                                <tr style="display: none;">
                                    <td>
                                        <asp:Label ID="lbl5" runat="server" Text="Edt_By" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl5" runat="server" ReadOnly="true" CssClass="form-control" Height="24px" Width="143px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl6" runat="server" Text="Edt_Dt" CssClass="col-sm-2 control-label"></asp:Label>

                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl6" runat="server" ReadOnly="true" CssClass="form-control" Height="24px" Width="143px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="Label1" Style="text-align: left; border-style: ridge; border-width: medium; border-color: Red;" runat="server" Text="Use 24 Hr Clock Format" CssClass="col-sm-12 control-label"></asp:Label>
                                    </td>
                                    <%-- <td>
                                        <asp:Label ID="Label2" Style="text-align:left;border-style:ridge;border-width:medium;border-color:Red;" runat="server" Text="Put 1 for SameDay or Put 2 for NextDay in Day_Flag"  CssClass="col-sm-6 control-label"></asp:Label>
                                    </td> --%>
                                </tr>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Attendance</a></li>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f1" HeaderText="Emp_Code" />
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Emp_Name" />
                                                <asp:BoundField DataField="sg1_f3" HeaderText="Deptt" />
                                                <asp:BoundField DataField="sg1_f4" HeaderText="Desg" />
                                                <asp:BoundField DataField="sg1_f5" HeaderText="JoinDt" />

                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t1</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' MaxLength="2" onkeypress="return isDecimalKey(event)" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' MaxLength="2" onkeypress="return isDecimalKey(event)" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t3</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" MaxLength="2" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t4</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' onkeypress="return isDecimalKey(event)" onchange="calculateTime()" MaxLength="2" Width="100%" Style="text-align: right"></asp:TextBox>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <%-- removed auto postback --%>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' MaxLength="1" Width="100%" onblur="calculateTime()"></asp:TextBox>
                                                        <%-- OnTextChanged="sg1_t5_TextChanged"--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t6</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' ReadOnly="true" Height="24px" CssClass="form-control" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t7</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' ReadOnly="true" CssClass="form-control" Height="24px" onkeypress="return isDecimalKey(event)" MaxLength="3" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t8</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' onkeyup="cal()" onkeypress="return isDecimalKey(event)" MaxLength="3" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onkeyup="cal()" onkeypress="return isDecimalKey(event)" MaxLength="3" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t10" runat="server" ReadOnly="true" CssClass="form-control" Height="24px" Text='<%#Eval("sg1_t10") %>' Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%-- <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t11</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t11" runat="server" Visible="false" MaxLength="3"  Text='<%#Eval("sg1_t11") %>' onkeyup="cal()"  onkeypress="return isDecimalKey(event)" Width="100%" Style="text-align: right"></asp:TextBox>  <%--OnTextChanged="sg1_t11_TextChanged"  AutoPostBack="true"--%>
                                                <%-- </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t12</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t12" runat="server" Visible="false" MaxLength="3" Text='<%#Eval("sg1_t12") %>' onkeyup="cal()"  onkeypress="return isDecimalKey(event)" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t13</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t13" runat="server" Visible="false" ReadOnly="true" CssClass="form-control" Height="24px" Text='<%#Eval("sg1_t13") %>' Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t14</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" MaxLength="3" Visible="false" runat="server" Text='<%#Eval("sg1_t14") %>' onkeypress="return isDecimalKey(event)" Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t15</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" MaxLength="3" Visible="false" runat="server" Text='<%#Eval("sg1_t15") %>' onkeypress="return isDecimalKey(event)"  Width="100%" ReadOnly="true" CssClass="form-control" Height="24px" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>sg1_t16</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t16" runat="server" Visible="false" Text='<%#Eval("sg1_t16") %>' Width="100%" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>  --%>
                                            </Columns>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            ...
            for (var i = 0; i < grid ; i++) {
                food = 0; dedn = 0; lt_cmng = 0; fine = 0; sleep = 0; tot = 0; downtime = 0;
                food = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t8_' + i).value);
                dedn = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t9_' + i).value);
                tot = food * 1 + dedn * 1;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t10_' + i).value = tot;
            }
        }
        function calculateTime() {
            var timeInHrs = 0, timeInMin = 0;
            var timeOutHrs = 0, timeOutMin = 0;
            var myDt = document.getElementById("ContentPlaceHolder1_txtvchdate").value;
            var grid = $("[id*=sg1].GridviewScrollItem2").length;
            var gridid = document.getElementById("<%= sg1.ClientID%>");
            var timeOut = 0, timeIn = 0;
            for (var i = 0; i < grid ; i++) {
                if (fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t5_' + i).value) <= 0)
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t5_' + i).value = "1";

                timeInHrs = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value)
                if (timeInHrs.toString().length == 1) timeInHrs = "0" + timeInHrs;
                if (timeInHrs.toString().length == 0) timeInHrs = "00";
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value = timeInHrs;

                timeInMin = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value)
                if ((timeInMin * 1) >= 60) timeInMin = 59;
                if (timeInMin.toString().length == 1) timeInMin = "0" + timeInMin;
                if (timeInMin.toString().length == 0) timeInMin = "00";
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value = timeInMin;

                timeOutHrs = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value)
                if (timeOutHrs.toString().length == 1) timeOutHrs = "0" + timeOutHrs;
                if (timeOutHrs.toString().length == 0) timeOutHrs = "00";
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value = timeOutHrs;

                timeOutMin = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t4_' + i).value)
                if ((timeOutMin * 1) >= 60) timeOutMin = 59;
                if (timeOutMin.toString().length == 1) timeOutMin = "0" + timeOutMin;
                if (timeOutMin.toString().length == 0) timeOutMin = "00";
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t4_' + i).value = timeOutMin;

                timeOut = (timeOutHrs * 60) + (timeOutMin * 1);
                timeIn = (timeInHrs * 60) + (timeInMin * 1);
                ...
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t6_' + i).value = hour;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t7_' + i).value = min;
            }
        }
    </script>
