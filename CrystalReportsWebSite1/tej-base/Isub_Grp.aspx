<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="Isub_Grp" CodeFile="Isub_Grp.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: left">
                        ...
                        <button type="submit" id="btndeact" class="btn btn-info" style="width: 100px;" runat="server" accesskey="d" onserverclick="btndeact_ServerClick"><u>D</u>eactivate</button>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label id="Label8" runat="server" class="col-sm-2 control-label" title="lbl1">Entry_Date</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label id="lbl3" runat="server" class="col-sm-3 control-label" title="lbl1">Main Group</label>
                                <div class="col-sm-1" id="divPersonName" runat="server">
                                    <asp:ImageButton ID="btnPersonName" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btn_mg_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" readonly="readonly" runat="server" placeholder="Main Group" maxlength="2" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl4" runat="server" class="col-sm-3 control-label" title="lbl1">Sub Group</label>
                                <div class="col-sm-1" id="div1" runat="server">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btn_sg_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" readonly="readonly" placeholder="Sub Group" maxlength="6" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-3 control-label" title="lbl1">Acct Code</label>
                                <div class="col-sm-1" id="div2" runat="server">
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnactg_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" readonly="readonly" placeholder="A/c Code" maxlength="6" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-3 control-label" title="lbl1">HSN Code</label>
                                <div class="col-sm-1" id="div3" runat="server">
                                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnhsn_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txthscode" type="text" class="form-control" runat="server" readonly="readonly" placeholder="HS Code No." maxlength="6" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl2" runat="server" class="col-sm-4 control-label" title="lbl1">Sub Grp Name</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" maxlength="50" placeholder="Master Name" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-3 control-label" title="lbl1">Inspection_Reqd</label>
                                <div class="col-sm-3">
                                    <input id="txtlbl6" type="text" class="form-control" runat="server" maxlength="1" placeholder="(Y/N)" />
                                </div>
                                <label id="Label4" runat="server" class="col-sm-3 control-label" title="lbl1">Template_Reqd</label>
                                <div class="col-sm-3">
                                    <input id="txtlbl7" type="text" class="form-control" runat="server" maxlength="1" placeholder="(Y/N)" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-3 control-label" title="lbl1">A/B/C_Class</label>
                                <div class="col-sm-3">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" maxlength="1" placeholder="A/B/C_Class" />
                                </div>
                                <label id="Label6" runat="server" class="col-sm-3 control-label" title="lbl1">Show_IN_Wip</label>
                                <div class="col-sm-3">
                                    <input id="txtlbl9" type="text" class="form-control" runat="server" maxlength="1" placeholder="(Y/N)" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-3 control-label" title="lbl1">Min_Level </label>
                                <div class="col-sm-3">
                                    <input id="txtlbl20" type="number" class="form-control" runat="server" placeholder="Min Level" min="0" max="9999999" onkeyup="max_length(this,7)" />
                                </div>
                                <label id="Label12" runat="server" class="col-sm-3 control-label" title="lbl1">Reorder_Level </label>
                                <div class="col-sm-3">
                                    <input id="txt_rol" type="number" class="form-control" runat="server" placeholder="ROL" min="0" max="9999999" onkeyup="max_length(this,7)" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-3 control-label" title="lbl1">Max Level </label>
                                <div class="col-sm-3">
                                    <input id="txtlbl21" type="number" class="form-control" runat="server" placeholder="Max Level" min="0" max="9999999" onkeyup="max_length(this,7)" />
                                </div>
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">PO_Tolerance%</label>
                                <div class="col-sm-3">
                                    <input id="txtlbl10" class="form-control" runat="server" type="number" placeholder="% Extra Accepted Over PO" min="0" max="99" onkeyup="max_length(this,2)" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">Deactivated_by</label>
                                <div class="col-sm-3">
                                    <input id="txt_deact_by" type="text" class="form-control" runat="server" readonly="true" maxlength="3" placeholder="Item Deactivated by" />
                                </div>
                                <label id="Label14" runat="server" class="col-sm-3 control-label" title="lbl1">Deactivation_dt</label>
                                <div class="col-sm-3">
                                    <input id="txt_deact_dt" type="text" class="form-control" runat="server" readonly="true" maxlength="3" placeholder="Item Deactivated Dt" />
                                </div>
                            </div>
                            <div class="form-group" id="divarate" runat="server">
                                <label id="Label15" runat="server" class="col-sm-3 control-label" title="lbl1">Approx_Rate</label>
                                <div class="col-sm-3">
                                    <input id="txt_arate" type="number" class="form-control" runat="server" readonly="true" maxlength="3" placeholder="Approx_Rate" />
                                </div>
                                <label id="Label16" runat="server" class="col-sm-3 control-label" title="lbl1">Grade_Rate</label>
                                <div class="col-sm-3">
                                    <input id="txt_grate" type="number" class="form-control" runat="server" readonly="true" maxlength="3" placeholder="Grade_Rate" />
                                </div>
                            </div>
                        ...
                        <div id="Tabs" role="tabpanel">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="DescTab">
                                    <div class="lbBody" style="height: 225px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <asp:GridView ID="sg5" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="1200px" Font-Size="14px">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab2">
                                    <div class="lbBody" id="gridDiv" style="color: White; height: 225px; overflow: hidden; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:TextBox ID="txtlbl10a" runat="server" Width="350px"></asp:TextBox>
