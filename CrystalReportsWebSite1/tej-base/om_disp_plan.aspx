<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_disp_plan" CodeFile="om_disp_plan.aspx.cs" %>
            ...
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="lbl1" runat="server" class="col-sm-4 control-label" title="lbl1">Dplan_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="Action No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl2" runat="server" class="col-sm-4 control-label" title="lbl1">Dplan_Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="Action Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl3" runat="server" class="col-sm-3 control-label" title="lbl1">Priority</label>
                                <div class="col-sm-1" id="div2" runat="server">
                                    <asp:ImageButton ID="btnShift" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnlbl4_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtbox3" type="text" class="form-control" maxlength="120" runat="server" placeholder="Dispatch Priority" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="lbl4" runat="server" class="col-sm-4 control-label" title="lbl1">Version</label>
                                <div class="col-sm-8">
                                    <input id="txtbox4" type="text" class="form-control" runat="server" placeholder="Version"  />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl5" runat="server" class="col-sm-4 control-label" title="lbl1">Instructed_BY</label>

                                <div class="col-sm-8">
                                    <input id="txtbox5" type="text" class="form-control" runat="server" placeholder="Instructed_By"  />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl6" runat="server" class="col-sm-4 control-label" title="lbl1">Made_By</label>

                                <div class="col-sm-8">
                                    <input id="txtbox6" type="text" class="form-control" runat="server" placeholder="Made_By"  />
                                </div>
                            </div>
                ...
                <div class="col-md-6" id="divWork1" runat="server" >
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="lbl7" runat="server" class="col-sm-4 control-label" title="lbl1">Action_No</label>
                                <div class="col-sm-8">
                                    <input id="txtbox7" type="text" class="form-control" runat="server" placeholder="Action No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl8" runat="server" class="col-sm-4 control-label" title="lbl1">Action_Date</label>
                                <div class="col-sm-8">
                                    <input id="txtbox8" type="text" class="form-control" runat="server" placeholder="Action Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl9" runat="server" class="col-sm-3 control-label" title="lbl1">Request_No</label>
                                <div class="col-sm-1" id="div1" runat="server">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnlbl4_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtbox9" type="text" class="form-control" maxlength="120" runat="server" placeholder="Maintenance Request Number" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6" id="divWork2" runat="server">
                    <div>
                        <div class="box-body">

                            <div class="form-group">
                                <label id="lbl10" runat="server" class="col-sm-4 control-label" title="lbl1">Shift</label>
                                <div class="col-sm-8">
                                    <input id="txtbox10" type="text" class="form-control" runat="server" placeholder="Shift" readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl11" runat="server" class="col-sm-4 control-label" title="lbl1">Department</label>

                                <div class="col-sm-8">
                                    <input id="txtbox11" type="text" class="form-control" runat="server" placeholder="Department" readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl12" runat="server" class="col-sm-4 control-label" title="lbl1">Machine</label>

                                <div class="col-sm-8">
                                    <input id="txtbox12" type="text" class="form-control" runat="server" placeholder="Machine" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6" id="divWork3" runat="server">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label15" runat="server" Text="Observation" CssClass="col-sm-4 control-label"></asp:Label>

                            <div class="col-sm-8">
                                <asp:TextBox ID="txtbox20" runat="server" Height="26px" Placeholder="Observation" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txtbox21" runat="server" Height="26px" Placeholder="Remarks" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="col-md-6" id="divWork4" runat="server">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label13" runat="server" Text="Corrective_Action" CssClass="col-sm-4 control-label"></asp:Label>

                            <div class="col-sm-8">
                                <asp:TextBox ID="txtbox22" runat="server" Height="26px" Placeholder="Corrective Action" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>

                        <div class="box-body">
                            <asp:Label ID="Label14" runat="server" Text="Preventive_Action" CssClass="col-sm-4 control-label"></asp:Label>

                            <div class="col-sm-8">
                                <asp:TextBox ID="txtbox23" runat="server" Height="26px" Placeholder="Preventive_Action" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Orders Planned</a></li>
                                <li><a href="#DescTab2" id="tab2" runat="server" aria-controls="DescTab2" role="tab" data-toggle="tab">Comm.Terms</a></li>
                                <li><a href="#DescTab3" id="tab3" runat="server" aria-controls="DescTab3" role="tab" data-toggle="tab">Lot/Reel Details</a></li>
                                ...
                                <li id="postB">
                                    <button type="submit" id="btnPost" class="bg-green btn-foursquare" style="width: 130px; margin-left: 60px; margin-top: 3px;" runat="server" onserverclick="btnPost_ServerClick">Post Lot/Reels</button>
                                </li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" TextMode="Date" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <div>
                                                <div class="box-body">
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_10" runat="server" Text="lbl10" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_11" runat="server" Text="lbl11" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_12" runat="server" Text="lbl12" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_13" runat="server" Text="lbl13" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_14" runat="server" Text="lbl14" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                    ...
                                    <div class="lbBody" style="height: 250px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <asp:GridView ID="sg2" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg2_f2" HeaderText="Product" ItemStyle-Width="300" HeaderStyle-Width="300" />
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Lot/Reel No</HeaderTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t8" runat="server" Text='<%#Eval("sg2_t8") %>' Width="100%" onkeyup="openBox(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
