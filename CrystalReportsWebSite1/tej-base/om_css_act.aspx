<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_css_act" CodeFile="om_css_act.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtDFno" runat="server" class="form-control" type="text" placeholder="Asg No" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label12" runat="server" class="col-sm-4 control-label" title="lbl1">Asg Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtDFdt" runat="server" class="form-control" type="text" placeholder="Asg Dt" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-4 control-label" title="lbl1">Assign To</label>
                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" placeholder="Assign to" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Analysis</label>
                                <div class="col-sm-8">
                                    <input id="ddStatus" runat="server" class="form-control" type="text" placeholder="Analysis" readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Priority(Hrs)</label>
                                <div class="col-sm-8">
                                    <input id="TxtPriority" runat="server" class="form-control" type="text" placeholder="Priority" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label3" runat="server" Text="Assignor Remarks" CssClass="col-sm-2 control-label"></asp:Label>
                            <asp:TextBox ID="txt_asg_rmk" runat="server" Width="99%" TextMode="MultiLine" placeholder="Assignor Remarks " ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label17" runat="server" class="col-sm-4 control-label" title="lbl1">Act No</label>
                                <div class="col-sm-8">
                                    <input id="txtAFno" runat="server" class="form-control" type="text" placeholder="Act No" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label18" runat="server" class="col-sm-4 control-label" title="lbl1">Act Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtAFdt" runat="server" class="form-control" type="text" placeholder="Act Dt" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Done On</label>
                                <div class="col-sm-8">
                                    <input id="txtDone" runat="server" class="form-control" type="date" placeholder="Done On Date" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-3 control-label" title="lbl1">Stage</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnStatus" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnStatus_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtStage" runat="server" class="form-control" type="text" placeholder="Stage" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Task Complete</label>
                                <div class="col-sm-8">
                                    <input id="Txt_TDONE" runat="server" class="form-control" type="text" placeholder="Task Complete" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Approx Compl Date</label>
                                <div class="col-sm-8">
                                    <input id="Txt_NEXTDT" runat="server" class="form-control" type="text" placeholder="Approx Compl Date." />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Action Remarks" CssClass="col-sm-2 control-label"></asp:Label>
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,200)" placeholder="Action Remarks"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
