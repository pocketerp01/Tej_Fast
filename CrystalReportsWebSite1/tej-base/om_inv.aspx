<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_inv" CodeFile="om_inv.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function gridviewScroll(gridId, gridDiv, headerFreeze, rowFreeze) {
            ...
            function calculateSum() {
                ...
                var formID = document.getElementById('ContentPlaceHolder1_lblFormID').value;
                for (var i = 0; i < grid.rows.length - 1; i++) {
                    var Qty = $("input[id*=sg1_t3]");
                    var Rate = $("input[id*=sg1_t4]");
                    var CGST = $("input[id*=sg1_t6]");
                    var SGST = $("input[id*=sg1_t7]");
                    var DiscPer = $("input[id*=sg1_t8]");
                    ...
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t5_' + i).value = fill_zero(AMOUNT).toFixed(3);

                    IAMOUNT += fill_zero(AMOUNT);

                    if (formID == "F50035") {
                        if ((CGST[i].value * 1) > 0) {
                            totCGST += (CGST[i].value * 1);
                        }
                        if ((SGST[i].value * 1) > 0) {
                            totSGST += (SGST[i].value * 1);
                        }
                    }
                    else {
                        if ((CGST[i].value * 1) > 0) {
                ...
                document.getElementById('ContentPlaceHolder1_txtlbl24').value = fill_zero(IAMOUNT).toFixed(3);
                document.getElementById('ContentPlaceHolder1_txtlbl26').value = fill_zero(totCGST).toFixed(3);
                document.getElementById('ContentPlaceHolder1_txtlbl28').value = fill_zero(totSGST).toFixed(3);
                if (formID == "F50035") {
                    document.getElementById('ContentPlaceHolder1_txtlbl24').value = 0;
                    TOTAMT = fill_zero(totCGST) + fill_zero(totSGST);
                }
                else TOTAMT = fill_zero(IAMOUNT) + fill_zero(totCGST) + fill_zero(totSGST);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:HiddenField ID="hfCG" runat="server" />
                                        <asp:Label ID="Label1" runat="server" Text="From_State" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:Label ID="lblFrom" runat="server" Text="" CssClass="col-sm-2 control-label"></asp:Label>
                                        </div>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="To_State" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:Label ID="lblTo" runat="server" Text="" CssClass="col-sm-2 control-label"></asp:Label>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t7</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t8</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl20" runat="server" Text="lbl20" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl20" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl20_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl20" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl21" runat="server" Text="lbl21" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl21" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl21_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl21" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl22" runat="server" Text="lbl22" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl22" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl22_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl22" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl32" runat="server" Text="lbl32" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl32" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl32_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl32" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl33" runat="server" Text="lbl33" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl33" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl33_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl33" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl56" runat="server" Text="lbl56" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl56" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl56_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl56" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl34" runat="server" Text="lbl34" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl34" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl34_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl34" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl35" runat="server" Text="lbl35" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl35" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl35_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl35" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl36" runat="server" Text="lbl36" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl36" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl36_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl36" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl37" runat="server" Text="lbl37" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl37" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl37_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl37" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl38" runat="server" Text="lbl38" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl38" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl38_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl38" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl57" runat="server" Text="lbl57" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl57" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl57_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl57" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl39" runat="server" Text="lbl39" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl39" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl39_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl39" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl52" runat="server" Text="lbl52" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl52" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl52_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl52" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl53" runat="server" Text="lbl53" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl53" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl53_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl53" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl54" runat="server" Text="lbl54" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl54" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl54_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl54" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl55" runat="server" Text="lbl55" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl55" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl55_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl55" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl58" runat="server" Text="lbl58" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnlbl58" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl58_Click" />
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl58" runat="server" Width="120px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl24" runat="server" Text="lbl24" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl26" runat="server" Text="lbl26" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl28" runat="server" Text="lbl28" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl29" runat="server" Text="lbl29" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl59" runat="server" Text="lbl59" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl59" runat="server" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl31" runat="server" Text="lbl31" CssClass="col-sm-4 control-label"></asp:Label>
                                <div class="col-sm-6">
    ...
    <asp:HiddenField ID="lblFormID" runat="server" />
    <script type="text/javascript">
        $(function () {
