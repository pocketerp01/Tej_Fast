...
public partial class frmLeaveUpd : System.Web.UI.Page
{
    ...
    protected void btnnew_ServerClick(object sender, EventArgs e)
    {
        ...
        if (chk_rights == "Y")
        {
            ...
            txtlbl7.Text = frm_UserID;
            txtlbl7a.Text = frm_uname;
            ...
            switch (btnval)
            {
                ...
                case "Edit":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl4.Text = dt.Rows[0]["log_ref"].ToString().Trim();
                        txtlbl4a.Text = dt.Rows[0]["DESIG"].ToString().Trim();
                        txtlbl7.Text = dt.Rows[0]["req_by"].ToString().Trim();
                        txtlbl7a.Text = dt.Rows[0]["req_name"].ToString().Trim();
                        edmode.Value = "Y";
    ...
    void save_fun()
    {
        ...
        oporow["REQ_BY"] = txtlbl7.Text.Trim();
        oporow["REQ_NAME"] = txtlbl7a.Text.Trim();

        oporow["log_ref"] = txtlbl4.Text.Trim();
        oporow["DESIG"] = txtlbl4a.Text.Trim();
