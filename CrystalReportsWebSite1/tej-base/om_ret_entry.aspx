<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_ret_entry" CodeFile="om_ret_entry.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function calculateSum() {
            ...
            for (var i = 0; i < gridCount; i++) {
                totQty += fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value * 1);
            }
            document.getElementById('ContentPlaceHolder1_txtlbl8').value = totQty;
        }
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <button type="submit" id="btnRead" class="btn-success" style="width: 100px; margin-left: 5px; margin-top: 3px;" runat="server" onserverclick="btnRead_ServerClick">Read Data</button>
                                </li>
                                <li id="postB">
                                    <button type="submit" id="btnPost" class="btn-success" style="width: 100px; margin-left: 60px; margin-top: 3px;" runat="server" onserverclick="btnPost_ServerClick">Post Reels</button>
                                </li>
                                    ...
                                    <div class="lbBody" style="height: 250px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <asp:GridView ID="sg2" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Suppler Reel</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t10" runat="server" Text='<%#Eval("sg2_t10") %>' ReadOnly="true" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
