<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="frmMProd_Disp" CodeFile="frmMProd_Disp.aspx.cs" %>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:ImageButton ID="btnstage" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png"
                                            ToolTip="Select Stage" Style="width: 22px;" OnClick="btnstage_Click" />
                                    </td>
                                    <td colspan="5">
