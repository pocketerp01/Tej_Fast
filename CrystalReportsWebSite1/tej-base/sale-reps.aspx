<%@ Page Language="C#" AutoEventWireup="true" Inherits="sale_reps" CodeFile="sale-reps.aspx.cs" %>
            ...
            <table>
                ...
                <tr>
                    <td valign="top" style="position: fixed;" id="tdprint" runat="server">
                        ...
                        <br />
                        <asp:ImageButton ID="btnExptoTiff" runat="server" ImageUrl="~/tej-base/images/tiff_icon.png" ToolTip="Export to Tiff" Width="30px" Height="25px"
                            OnClick="btnExptoTiff_Click" />
                        <br />
                        ...
                        <br />
                        <asp:ImageButton ID="btnexpwithsig" runat="server"
                            ImageUrl="~/tej-base/images/digital-signature-online.png" ToolTip="Export to Signature"
                            OnClick="btnexpwithsig_Click" Style="margin-top: 0px" Width="30px" Height="30px" />
                    </td>
                    <td valign="top">
