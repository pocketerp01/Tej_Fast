<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_tgpop_mst" CodeFile="om_tgpop_mst.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            formID = document.getElementById('ContentPlaceHolder1_hcid').value;
            //gridviewScroll('#<%=sg5.ClientID%>', gridDiv, 1, 1);
            //calculateSum();            
            if (formID == "F70177") {
                $("#ContentPlaceHolder1_txtlbl4").keypress(function () {                    
                    var x = event.keyCode;
                    if (x == 103 || x == 115 || x == 71 || x == 83) {
                    }
                    else return false;
                });

                $("#ContentPlaceHolder1_txtlbl9").keypress(function () {
                    var x = event.keyCode;
                    if (x == 121 || x == 89 || x == 110 || x == 78) {
                    }
                    else return false;
                });
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Parameter 1" />
                                </div>
                            </div>
    ...
    <asp:HiddenField ID="ID_TWIP" runat="server" />
