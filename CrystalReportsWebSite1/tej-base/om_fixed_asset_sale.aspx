<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_fixed_asset_sale" CodeFile="om_fixed_asset_sale.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">I/U Sale</label>
                               
                                <div class="col-sm-8">
                                    <select id="txtlbl4" runat="server" placeholder="I/U Sale" class="form-control" >
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtSup_Address" type="text" class="form-control" runat="server" placeholder="Supplier Address" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txt_invno" type="text" class="form-control" runat="server"  placeholder="Invoice Number" />
                                </div>
                            </div>
                          
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Pur. Inv. Date</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder=" Invoice Date" maxlength="30" />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label18" runat="server" class="col-sm-3 control-label" title="lbl1">Sale Inv. No.</label>
                                 ...
                                 <div class="col-sm-8">
                                  <input id="txtSale_Invoice" type="text" class="form-control" runat="server" placeholder=" Sale Invoice No." />
                                </div>
                            </div>
                             <div class="form-group">
                                <label id="Label17" runat="server" class="col-sm-4 control-label" title="lbl1">Sold  TO</label>
                                <div class="col-sm-8">
                                    <input id="txtSold_to" type="text" class="form-control" runat="server" placeholder="Sold To" maxlength="30"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Sale Inv. Date</label>
                                <div class="col-sm-8">
                                    <input id="txt_saledt" type="date" class="form-control" runat="server"  placeholder="Sale Invoice Date" maxlength="30" />
                                </div>
                            </div>


                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-4 control-label" title="lbl1">Quantity</label>
                                
                                <div class="col-sm-8">
                                       <input id="txtQuantity" type="text" class="form-control" runat="server" readonly="true" placeholder="Quantity" />
                                </div>
                            </div>
                            <%--<div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Module Name</label>
                   ...
                   <div class="col-md-6">
                    <div>
                        <div class="box-body">
                              ...
                              <div class="form-group">
                                  <label id="Label20" runat="server" class="col-sm-4 control-label" title="lbl1">Original Cost</label>
                                <div class="col-sm-8">
                                    <input id="txtOriginalCost" type="text" class="form-control" runat="server" readonly="readonly" placeholder="Original Cost" maxlength="30" />
                                </div>
                            ...
                            <div class="form-group">
                                <label id="Label23" runat="server" class="col-sm-4 control-label" title="lbl1">Sale Amount</label>
                                <div class="col-sm-8">
                                  <input id="txtSold_for" type="text" class="form-control" runat="server" placeholder="Sale Amount" />
                                   
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">Depr_Pr_Yr_ Write/back</label>
                                <div class="col-sm-8">
                                    <input id="txtdepoldyr" type="text" class="form-control" runat="server" placeholder="Deprciation written back earlier years" maxlength="10" readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label24" runat="server" class="col-sm-4 control-label" title="lbl1">Depr Part Year</label>
                                <div class="col-sm-8">
                                    <input id="txtDepr_Part" type="text" class="form-control" runat="server" placeholder="Depr For current year (Upto Sale Date)" maxlength="8" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Installation Date</label>
                                <div class="col-sm-3">
                                  <input id="txtInstall_dt" type="date" class="form-control" style="font-size:small" runat="server" readonly="readonly" placeholder="Installation Date" />
                                   </div>
                                    <label id="Label40" runat="server" class="col-sm-2 control-label" title="">Sale/Discard</label>
                                   <div class="col-sm-3"> 
                                     <select id="ddsaleent" runat="server" class="form-control" >
                 ...
                 <div class="col-md-12" id="div3" runat="server">
                    <div>
                        <div class="box-body">
                            ...
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" MaxLength="150" placeholder="Remarks upto 100 Char" ></asp:TextBox>
