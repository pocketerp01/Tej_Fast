<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_paper_index" CodeFile="om_paper_index.aspx.cs" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-3 control-label" title="lbl1">Code</label>
                                <div class="col-sm-1">
                                    <asp:Label ID="lbl1a" runat="server" Text="TC" Style="width: 22px; float: right;" CssClass="col-sm-1 control-label"></asp:Label>
                                </div>
                                <div class="col-sm-8">
                                    <input id="txt_code" type="text" class="form-control" runat="server"   maxlength="6" />
                                    <asp:TextBox ID="txtvchdate" placeholder="Date" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">Burst Factor (BF)</label>
                                
                                <div class="col-sm-8">
                                    <input id="txt_Bf" type="text" class="form-control" runat="server"  maxlength="10" onkeypress="return isDecimalKey(event)" />
                                </div>
                            </div>

                                      <div class="form-group">
                                                    <label id="Label1_gsm" runat="server" class="col-sm-4 control-label" title="lbl1">RCT_for_CS-BS</label>
                                                    <div class="col-sm-8">
                                                        <input id="txt_GSM" type="text" class="form-control" runat="server"  maxlength="10" onkeypress="return isDecimalKey(event)" />
                                                    </div>
                                                </div>
                               
                            <div class="form-group">
                                                    <label id="Label2_rmk" runat="server" class="col-sm-4 control-label" title="lbl1"> Remarks1</label>
                                                    <div class="col-sm-8">
                                                        <input id="txt_rmk" type="text" class="form-control" runat="server"  maxlength="50" />
                                                    </div>
                                                </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                             ...
                             <div class="form-group">
                                      <label id="Label17" runat="server" class="col-sm-4 control-label" title="lbl1"> Normal RCT  Rate</label>
                                        <div class="col-sm-8">
                                        <input id="txt_normalrctrate" type="text" class="form-control" runat="server"  maxlength="10" onkeypress="return isDecimalKey(event)"/>
                                            </div>
                               </div>
                                                      
                                <div class="form-group">
                                        <label id="Label67" runat="server" class="col-sm-4 control-label" title="lbl1"> Normal RCT  Index</label>
                                          <div class="col-sm-8">
                                             <input id="txt_normalrctindex" type="text" class="form-control" runat="server"  maxlength="10" onkeypress="return isDecimalKey(event)"/>
                                                </div>
                                   </div>
                               <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-4 control-label" title="lbl1">High RCT Rate</label>
                               
                                <div class="col-sm-8">
                                    <input id="txt_highrctrate" type="text"  class="form-control" runat="server"   maxlength="10" onkeypress="return isDecimalKey(event)"/>
                                </div>
                            </div>
                           
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">High RCT Index</label>
                                
                                <div class="col-sm-8">
                                    <input id="txt_highrctindex" type="text" class="form-control" runat="server"  maxlength="10" onkeypress="return isDecimalKey(event)"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="col-lg-12 connectedSortable" id="AllTabs" runat="server" style="display:none">
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                               
                              <li><a href="#DescTab1" id="tab1" runat="server" aria-controls="DescTab1" role="tab" data-toggle="tab" style="visibility:hidden;">Address Details</a></li>
                               <li><a href="#DescTab2" id="tab2" runat="server" aria-controls="DescTab2" role="tab" data-toggle="tab" style="visibility:hidden;">Contact,Excise Details</a></li>                              
                                <li><a href="#DescTab3" id="tab3" runat="server" aria-controls="DescTab3" role="tab" data-toggle="tab" style="visibility:hidden;">Bank Details</a></li>
                                <li><a href="#DescTab4" id="tab4" runat="server" aria-controls="DescTab4" role="tab" data-toggle="tab" style="visibility:hidden;">Control Dates/Others</a></li>
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">GST No.</label>

                                                    <div class="col-sm-8">
                                                        <input id="txt_gst_no" type="text" class="form-control" maxlength="15" runat="server" placeholder="GST No." />
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="txt_head_off" type="text" class="form-control" runat="server" placeholder="Head-Office For TDS Challan" maxlength="50" />
                                                        </div>
                                                    </div>
