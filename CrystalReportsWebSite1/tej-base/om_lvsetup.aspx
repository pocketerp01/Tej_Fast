<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_lvsetup" CodeFile="om_lvsetup.aspx.cs" %>
            ...
            <div class="row">
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" MaxLength="20" placeholder="Specify Other Leave"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t2" runat="server" Width="100%">
                                                            ...
                                                            <asp:ListItem Text="CALCULATE" Value="CALCULATE"></asp:ListItem>
                                                        </asp:DropDownList>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Max.No.Of_Leave</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' Width="100%" MaxLength="8" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Max.No.Of_Leave</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t4" runat="server" Width="100%">
                                                            <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                                            <asp:ListItem Text="PER_MONTH" Value="PER_MONTH"></asp:ListItem>
                                                            <asp:ListItem Text="PER_YEAR" Value="PER_YEAR"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="cmd2" Value='<%#Eval("sg1_t4") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Balance_Leave_Treatment_CF_Next_Month</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t5" runat="server" Width="100%">
                                                            <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                                            <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                            <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="cmd3" Value='<%#Eval("sg1_t5") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Balance_Leave_Treatment_Next_Year</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t6" runat="server" Width="100%">
                                                            <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                                            <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                                            <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="cmd4" Value='<%#Eval("sg1_t6") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label4" runat="server" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Short_Leave_Max_Hrs</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtShort_Hrs" runat="server" Width="100%" CssClass="form-control" onkeypress="return isDecimalKey(event)" MaxLength="8"></asp:TextBox>
                                </div>

                                <asp:Label ID="Label5" runat="server" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Short_Leave_Max_Per_Month</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtMax" runat="server" Width="100%" CssClass="form-control" onkeypress="return isDecimalKey(event)" MaxLength="8"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label6" runat="server" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Ded_In_Days(If Short Leave More Than Max Per Month)</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtLimit" runat="server" Width="100%"  CssClass="form-control" onkeypress="return isDecimalKey(event)" MaxLength="8"></asp:TextBox>
                                </div>

                                <asp:Label ID="Label7" runat="server" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Max_Ded</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txt_MaxDed" runat="server" Width="100%"  CssClass="form-control" onkeypress="return isDecimalKey(event)" MaxLength="8"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label8" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Casual Leaves Can Be Availed In Same Year ?</asp:Label>
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="txtCL" runat="server" Width="100%" CssClass="form-control">
                                        <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label9" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Earned Leaves Can Be Availed In Same Year ?</asp:Label>
                                <div class="col-sm-3">
                                    <asp:DropDownList ID="txtEL" runat="server" Width="100%" CssClass="form-control">
                                        <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                    </asp:DropDownList>
