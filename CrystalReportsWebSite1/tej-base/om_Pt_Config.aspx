<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_Pt_Config" CodeFile="om_Pt_Config.aspx.cs" %>
<%--  --%>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl1" runat="server" Text="lbl1" CssClass="col-sm-2 control-label" Font-Size="14px" >Entry No.</asp:Label>
                                  <div class="col-sm-1">
                                ...
                                <asp:Label ID="Label1" runat="server" Text="lbl1" CssClass="col-sm-2 control-label" Font-Size="14px" >Entry_Date</asp:Label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label14" runat="server" Text="State"  CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-1" >
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl4" runat="server" Text="lbl4" CssClass="col-sm-2 control-label" Font-Size="14px" >Grade</asp:Label>
                                 <div class="col-sm-1">
                 ...
                 <div class="col-md-6" >
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label20" runat="server" Text="Eff_From"  CssClass="col-sm-2 control-label"></asp:Label>
                                ...
                                <asp:Label ID="Label21" runat="server" Text="Eff_upto"  CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-5">
                           ...
                           <div class="form-group">
                                <asp:Label ID="lbl5" runat="server" Text="Ent_By" CssClass="col-sm-2 control-label" Font-Size="14px" ></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl5" runat="server" Width="100%" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                                </div>
                                <asp:Label ID="lbl6" runat="server" Text="Ent_Dt" CssClass="col-sm-1 control-label" Font-Size="14px" ></asp:Label>
                                <div class="col-sm-5">
                                <asp:TextBox ID="txtlbl6" runat="server" Width="100%" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                                    </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" Text="Deactivated(Y/N)"  CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtstatus" runat="server" CssClass="form-control" MaxLength="1" Text="N" ForeColor="Red"></asp:TextBox>
                                </div>
                                <asp:Label ID="lbldeac" runat="server" Text="(Y:Close,N:Open)" Font-Size="Small"  CssClass="col-sm-2 control-label" ForeColor="Red"></asp:Label>
                            
                               <asp:Label ID="Label3" runat="server" Text="Gender"  CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtGender" runat="server" CssClass="form-control" MaxLength="1" ForeColor="Red"></asp:TextBox>
                                </div>
                              <asp:Label ID="Label4" runat="server" Text="(M:Male,F:Female)" Font-Size="Small"  CssClass="col-sm-2 control-label" ForeColor="Red"></asp:Label>
                ...
                <section class="col-lg-12 connectedSortable">
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>'  Width="100%" MaxLength="6" onkeypress="return isDecimalKey(event)"  Style="text-align: right"></asp:TextBox>                                                   
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="110px">
                                                    ...
                                                    <ItemTemplate>                                          
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onChange="Cal()" Width="100%" MaxLength="6" onkeypress="return isDecimalKey(event)"  Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Width="80px" >
                                                    <HeaderTemplate>April</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' onChange="Cal()" onkeypress="return isDecimalKey(event)" Width="100%" maxlength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>May</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" maxlength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>June</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" maxlength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>July</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" maxlength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>August</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" maxlength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>September</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)"  MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>October</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t10" runat="server" Text='<%#Eval("sg1_t10") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>November</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t11" runat="server" Text='<%#Eval("sg1_t11") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>December</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t12" runat="server" Text='<%#Eval("sg1_t12") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>January</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t13" runat="server" Text='<%#Eval("sg1_t13") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Febuary</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' onChange="Cal()" Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>March</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" runat="server" Text='<%#Eval("sg1_t15") %>' Width="100%" onChange="Cal()" onkeypress="return isDecimalKey(event)" MaxLength="6" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t16" runat="server" Text='<%#Eval("sg1_t16") %>' Width="100%" onkeypress="return isDecimalKey(event)" MaxLength="6" ReadOnly="true" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                  ...
                  <div class="col-md-12" style="display:none;">
                    <div>
                        <div class="box-body">
                           <div class="form-group">
                               <asp:Label ID="Label11" runat="server" Text="lbl7" CssClass="col-sm-1 control-label" Font-Size="14px" >Footer_Notes</asp:Label>
                               <div class="col-sm-11">
