<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_maint_plan" CodeFile="om_maint_plan.aspx.cs" %>
                    ...
                    <div>
                         ...
                         <div class="box-body">
                             ...
                             <div class="form-group" style="display:none;">  <%--//ACREF--%>
                                 <asp:Label ID="Label1" runat="server" Text="ACREF" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                     <asp:TextBox ID="txtCpartno" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                 </div>
                    ...
                    <div>
                         ...
                         <div class="box-body">
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl5" runat="server" CssClass="form-control" Width="100%" placeholder="DD/MM/YYYY" TextMode="Date" Font-Size="Small"></asp:TextBox>
                                 </div>

                                 <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" Width="100%" placeholder="HH/MM/SS" TextMode="Time"></asp:TextBox>
                                 </div>                                 
                             </div>
                             <div class="form-group">
                                 <asp:Label ID="lbl8" runat="server" Text="lbl8" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-9">
                                     <asp:TextBox ID="txtlbl8" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>                                                                      
                                 </div>

                                 <%--<asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                     <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                 </div>--%>
                             ...
                             <div class="form-group">
                                 <asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-9">
                                     <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" ReadOnly="true" Width="30%"></asp:TextBox>
                                 </div>
                             </div>
                             
                             <asp:Label ID="lbl2" runat="server" Text="lbl2" CssClass="col-sm-12 control-label" ForeColor="Black" Font-Size="14px" BackColor="MediumTurquoise"  Font-Bold="True"></asp:Label>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Moulds Details</a></li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnadd" runat="server" CommandName="SG1_ROW_ADD" ImageAlign="Middle" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ToolTip="Insert Mould" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Del</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnrmv" runat="server" CommandName="SG1_RMV" ImageUrl="../tej-base/images/Btn_remn.png" Width="20px" ImageAlign="Middle" ToolTip="Remove Mould" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" onkeypress="return isDecimalKey(event)" onkeyup="cal()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t2</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" MaxLength="10" onkeypress="return isDecimalKey(event)" onkeyup="cal()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Add R/n</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_addmac" runat="server" CommandName="SG1_ADD_MAC" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ImageAlign="Middle" ToolTip="Add Machine" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' MaxLength="10" Width="100%" TextMode="Time" ReadOnly="false"></asp:TextBox>                                                      
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>D/t(To)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" runat="server" Text='<%#Eval("sg1_t15") %>' MaxLength="10" Width="100%" TextMode="Time" OnKeyUp="mytime()"></asp:TextBox>                                                     
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Width="100%" TextMode="Date"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%--//----------%>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Add S/p</HeaderTemplate>
                                                    <ItemTemplate>
                                                       <asp:ImageButton ID="sg1_addspr" runat="server"  CommandName="SG1_ADD_SPR" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ImageAlign="Middle" ToolTip="Add Spare Used" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%--//--------%>
                                                 <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>'  Width="100%" MaxLength="10"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList id="dd1" runat="server" Width="100%">
                                                            ...
                                                            <asp:ListItem>P/MAINT</asp:ListItem>
                                              ...
                                              <%--  <asp:TemplateField Visible="false">
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>sg1_t16</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t16" runat="server" Text='<%#Eval("sg1_t16") %>' Width="100%" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                qty = 0; rate = 0; amt = 0;
                qty = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value) * 1;
                rate = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value) * 1;
                amt = qty * rate;
                tot += amt;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t5_' + i).value = fill_zero(amt);
                document.getElementById('ContentPlaceHolder1_txtlbl9').value = fill_zero(tot);
            }
            // document.getElementById('ContentPlaceHolder1_txtlbl5').value = fill_zero(tot);
        }
        function fill_zero(val) { if (isNaN(val)) return 0; if (isFinite(val)) return val; }
