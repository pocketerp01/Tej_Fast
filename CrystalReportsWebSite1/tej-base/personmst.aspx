<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="frmUmst" CodeFile="personmst.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtUserIDNo" type="text" class="form-control" runat="server" placeholder="UserId No." readonly="true" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="lbl3" runat="server" class="col-sm-4 control-label" title="lbl1">User Name</label>
                                <div class="col-sm-8">
                                    <input id="txtUserName" type="text" class="form-control" runat="server" placeholder="User Full Name" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtMobile" type="tel" class="form-control" runat="server" placeholder="Mobile No" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Email ID</label>
                                <div class="col-sm-8">
                                    <input id="txtEmail" type="email" class="form-control" runat="server" placeholder="Email ID" />
                                </div>
                            </div>
                        </div>
                    </div>
