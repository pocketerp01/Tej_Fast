<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_qa_bas" CodeFile="om_qa_bas.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function calculateSum() {
            ...
            for (var i = 0; i < gridCount; i++) {
                var t1 = document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value;
                var t2 = document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value = (fill_zero(t1) - fill_zero(t2)).toFixed(3);

                if (fill_zero(t2 * 1) > fill_zero(t1 * 1)) {
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value = "0";
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value = "0";
                }
            }
        }
        function calculateSum1() {
            ...
            for (var i = 0; i < gridCount; i++) {
                var t1 = document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value;
                var t2 = document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value = (fill_zero(t1) - fill_zero(t2)).toFixed(3);
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl7" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl7_Click" /></td>
                                    <td>
                                        <div class="col-sm-4">
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li style="margin-left: 30px">Barcode : 
                                    <asp:TextBox ID="txtBarCode" runat="server" OnTextChanged="txtBarCode_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </li>
                            </ul>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Style="text-align: right" Text='<%#Eval("sg1_t1") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Style="text-align: right" Text='<%#Eval("sg1_t2") %>' onkeypress="return isDecimalKey(event)" Width="100%" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Style="text-align: right" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" Width="100%" onkeyup="calculateSum1()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t4</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Style="text-align: right" Text='<%#Eval("sg1_t4") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Style="text-align: right" Text='<%#Eval("sg1_t5") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
