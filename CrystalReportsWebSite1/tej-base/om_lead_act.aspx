<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_lead_act" CodeFile="om_lead_act.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="Lead No." readonly="readonly" />
                                </div>
                                <div class="col-sm-3">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="Lead Date" readonly="readonly" />
                                </div>
                                <label id="Label8" runat="server" class="col-sm-2 control-label" title="lbl1">Order_Type</label>
                                <div class="col-sm-3">
                                    <input id="ddLeadType" type="text" class="form-control" runat="server" placeholder="Lead Type" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label18" runat="server" class="col-sm-2 control-label" title="lbl1">Lead_Source</label>
                                <div class="col-sm-5">
                                    <input id="ddOrderTyp" type="text" class="form-control" runat="server" placeholder="Lead Source" maxlength="40" readonly="readonly" />
                                </div>
                                <label id="Label19" runat="server" class="col-sm-2 control-label" title="lbl1">Lead_Priority</label>
                                <div class="col-sm-3">
                                    <input id="ddOrderPri" type="text" class="form-control" runat="server" placeholder="Lead Priority" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-2 control-label" title="lbl1">Industry/Vertical</label>
                                <div class="col-sm-10">
                                    <input id="ddModule" runat="server" class="form-control" type="text" placeholder="Industry/Vertical" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-2 control-label" title="lbl1">Lead_Category</label>
                                <div class="col-sm-10">
                                    <input id="txtlbl9" runat="server" class="form-control" type="text" placeholder="Lead_Category" readonly="readonly" />

                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-2 control-label" title="lbl1">Specific Interest</label>
                                <div class="col-sm-10">
                                    <input id="ddIssueType" runat="server" class="form-control" placeholder="Specific Interest" type="text" readonly="readonly" />
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Name of Co." readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Contact Name</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Contact Name" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">Contract_Level</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Contract_Level" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Contact No.</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server" placeholder="Contact No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Email Id</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Mail ID" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label17" runat="server" Text="Client Remarks / Comments / Requiment" CssClass="col-sm-12 control-label"></asp:Label>
                            <asp:TextBox ID="Text_cl_rmk" runat="server" Width="99%" TextMode="MultiLine" placeholder="Client Remarks / Comments / Requiment" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">Act No</label>
                                <div class="col-sm-8">
                                    <input id="txtDFno" runat="server" class="form-control" type="text" placeholder="Act No" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label12" runat="server" class="col-sm-4 control-label" title="lbl1">Act Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtDFdt" runat="server" class="form-control" type="text" placeholder="Act Dt" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-3 control-label" title="lbl1">Lead_Stage</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnstg_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtstage" runat="server" class="form-control" type="text" placeholder="Stage of Lead" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">Lead_Action</label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" placeholder="Action Taken" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Next_Followup_Mode_Days</label>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Lead Value</label>
                            </div>
                            <div class="col-sm-8">
                                <input id="txtlvalue" runat="server" class="form-control" type="text" placeholder="Lead_Value" readonly="readonly" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <section class="col-lg-12 connectedSortable" id="AllTabs" runat="server" visible="false">
