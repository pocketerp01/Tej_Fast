<%@ Page Language="C#" AutoEventWireup="true" Inherits="activPwd" CodeFile="activPwd.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div class="mid-signin" style="padding-top: 40px">
            <input type="password" class="stealthy" tabindex="-1" />
            <input id="txtUserName" runat="server" class="signin-textfield"
                placeholder="User Name" autocomplete="off" />
            <input type="password" class="stealthy" tabindex="-1" />
            <input id="txtPwd" runat="server" class="signin-textfield"
                placeholder="Confirm Password" autocomplete="off" />

            <div style="padding-top: 10px; padding-bottom: 10px;">
                <asp:Label ID="lblerr" runat="server" Style="color: #f62217; font-size: 13px; font-family: Arial; text-decoration: none;" Text="Please Enter Password!"></asp:Label>
            </div>
