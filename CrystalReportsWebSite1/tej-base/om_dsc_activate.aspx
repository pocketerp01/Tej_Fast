<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_dsc_activate" CodeFile="om_dsc_activate.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-6 control-label" title="lbl1">Step 1 : (Setting Strucutre) </label>
                                <div class="col-sm-6">
                                    <button type="submit" id="btnStructure" class="btn btn-info" runat="server" accesskey="N" onserverclick="btnStructure_ServerClick">Make Structure</button>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-6 control-label" title="lbl1">Step 2 : (Activate Company) </label>
                                <div class="col-sm-6">
                                    <button type="submit" id="btnActivate" class="btn btn-info" runat="server" accesskey="N" onserverclick="btnActivate_ServerClick">Activate Company</button>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-6 control-label" title="lbl1">Step 3 : (Import DSC) </label>
                                <div class="col-sm-6">
                                    <button type="submit" id="btnImportDSC" class="btn btn-info" runat="server" accesskey="N" onserverclick="btnImportDSC_ServerClick">Import DSC</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="content" style="display: none">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Opt_Enabled</label>
                                <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Parameter_1</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Parameter 1" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Parameter_2</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server" placeholder="Parameter 2" />
                                </div>
                            </div>


                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Exclude_Plant</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Exclude Plant" />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Option_description" CssClass="col-sm-2 control-label"></asp:Label>
                            <asp:TextBox ID="txtrmk" runat="server" MaxLength="150" Width="99%" TextMode="MultiLine" placeholder="Option_description"></asp:TextBox>
                        </div>
                    </div>
                </div>
