<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_asset_stkr" CodeFile="om_asset_stkr.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">Entry No.</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="Entry No." readonly="readonly" />
                                </div>
                            </div>
                           
                            <div class="form-group" style="visibility:hidden;">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1" >ASSET CODE</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="ASSET CODE" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Deptt Name</label>
                                <div class="col-sm-8">
                                    <input id="ddModule" runat="server" class="form-control" type="text" placeholder="Department Name" readonly="readonly"  visible="false"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Machine</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Machine" readonly="readonly"  visible="false"/>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="box-body">
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group" style="visibility:hidden;">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1" >ASSET NAME</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl9" runat="server" class="form-control" type="text" placeholder="ASSET NAME" readonly="readonly" />

                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Occurance</label>
                                <div class="col-sm-8">
                                    <input id="ddIssueType" runat="server" class="form-control" placeholder="Occurance" type="text" readonly="readonly" visible="false" />

                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Complain By</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Complain By" readonly="readonly" visible="false" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Expected  Date</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server" placeholder="Expected Date" readonly="readonly" visible="false" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false">Email Id</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Mail ID" readonly="readonly" visible="false" />
                                </div>
                            </div>
                ...
                <div class="col-md-12" style="visibility:hidden;">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label17" runat="server" Text="Initial Remarks" CssClass="col-sm-2 control-label" visible="false" ></asp:Label>
                            <asp:TextBox ID="Text_cl_rmk" runat="server" Width="99%" TextMode="MultiLine" visible="false"  placeholder="Client Remarks" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-12" id="divAtch" runat="server" visible="false">
                    <div>
                        <div class="box-body">
                           Attachment : &nbsp; <asp:Label ID="lblAtch" runat="server"></asp:Label> &nbsp;&nbsp;&nbsp;
                            <asp:HiddenField ID="hfAtchPath" runat="server"></asp:HiddenField> &nbsp;&nbsp;
                            <asp:ImageButton ID="btnView" runat="server" ImageUrl="~/tej-base/images/preview-file.png" OnClick="btnView_Click" /> &nbsp;&nbsp;
                            <asp:ImageButton ID="btnDwnld" runat="server" ImageUrl="~/tej-base/images/Save.png" OnClick="btnDwnld_Click" />
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                              ...
                              <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Field1</label>
                                <div class="col-sm-8">
                                    <select id="ddfield1" runat="server" class="form-control">
                                        <option value="ASSETSUPP">Supply By</option>
                                        <option value="INVNO">Invoice Number</option>
                              ...
                              <div class="form-group">
                                <label id="Label26" runat="server" class="col-sm-4 control-label" title="lbl1">Field2</label>
                                <div class="col-sm-8">
                                    <select id="ddfield2" runat="server" class="form-control">
                                       <%-- <option value="ASSETSUPPADD">Supply Address</option>--%>
                              ...
                              <div class="form-group">
                                <label id="Label27" runat="server" class="col-sm-4 control-label" title="lbl1">Field3</label>
                                <div class="col-sm-8">
                                    <select id="ddfield3" runat="server" class="form-control">
                            ...
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Act No</label>
                                <div class="col-sm-8">
                                    <input id="txtDFno" runat="server" class="form-control" type="text" placeholder="Act No" visible="false" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label12" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Act Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtDFdt" runat="server" class="form-control" type="text" placeholder="Act Dt"  visible="false" readonly="readonly" />
                                </div>
                            </div>
                          

                            <div class="form-group">
                                <label id="Label18" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Problem Observed</label>
                                <div class="col-sm-8">
                                    <input id="Text1" runat="server" class="form-control" type="text" placeholder="Problem Observed" readonly="readonly" visible="false" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Corrective Action</label>
                                <div class="col-sm-8">
                                    <input id="Text2" runat="server" class="form-control" type="text" placeholder="Corrective Action" readonly="readonly" visible="false"/>
                                </div>
                            </div>
                              <div class="form-group">
                                <label id="Label20" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Spares/Cons.Used</label>
                                <div class="col-sm-8">
                                    <input id="Text3" runat="server" class="form-control" type="text" visible="false"  placeholder="Spares/Cons.Used" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label21" runat="server" class="col-sm-4 control-label" visible="false"  title="lbl1">Containment Action</label>
                                <div class="col-sm-8">
                                    <input id="Text4" runat="server" class="form-control" type="text" visible="false"  placeholder="Containment Action" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6" style="visibility:hidden;">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1" visible="false" >Preventive  Action</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnAsgn" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnAsgn_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" visible="false"  placeholder="Preventive Action" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Nature</label>
                                <div class="col-sm-8">
                                    <select id="ddCmode" runat="server" class="form-control">
                                        <option value="Logistics">Logistics</option>
                                        <option value="P.D.I.">P.D.I.</option>
                                        <option value="Prodn">Prodn</option>
                                        <option value="I.Q.C">I.Q.C</option>
                                        <option value="Vendor">Vendor</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1"> Date of Closure </label>
                                <div class="col-sm-8">
                                    <select id="ddnextfolo" runat="server" class="form-control">
                            ...
                            <div class="form-group">
                                <label id="Label22" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Cost(If any)</label>
                                <div class="col-sm-8">
                                    <input id="Text5" runat="server" class="form-control" type="text" visible="false"  placeholder="Cost( If Any)" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label23" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Cleared Time</label>
                                <div class="col-sm-8">
                                    <input id="Text6" runat="server" class="form-control" type="text" placeholder="Cleared Time" visible="false"  readonly="readonly" />
                                </div>
                            </div>
                              <div class="form-group">
                                <label id="Label24" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Down Type</label>
                                <div class="col-sm-8">
                                    <input id="Text7" runat="server" class="form-control" type="text" placeholder="Down Type" visible="false"  readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label25" runat="server" class="col-sm-4 control-label" title="lbl1" visible="false" >Complain Type</label>
                                <div class="col-sm-8">
                                    <input id="Text8" runat="server" class="form-control" type="text" placeholder="Complain Type"  visible="false" readonly="readonly" />
                                </div>
                            </div>
