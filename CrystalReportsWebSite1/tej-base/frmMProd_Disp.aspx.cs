...
public partial class frmMProd_Disp : System.Web.UI.Page
{
    ...
    string pk_error = "Y", chk_rights = "N", DateRange, Checked_ok, save_it, Prg_Id;
    ...
    public void enablectrl()
    {
        ...
        btnmachine.Enabled = false; btnshift.Enabled = false; btnstage.Enabled = false; btnConsume.Disabled = true;
    ...
    public void disablectrl()
    {
        ...
        btnmachine.Enabled = true; btnshift.Enabled = true; btnstage.Enabled = true; btnConsume.Disabled = false;
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "sg1_Row_Add_E":
                ...
                SQuery = "SELECT A.ICODE,B.INAME AS RAW_MAT,B.CPARTNO AS PARTNO,B.UNIT,A.BTCHNO AS BATCH_NO,sum(A.QTY) AS BAL,a.icode as code FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(IQTYOUT) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND SUBSTR(TYPE,1,1) IN ('3','1') AND TYPE!='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='Y' GROUP BY TRIM(ICODE),TRIM(BTCHNO) UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(IQTYIN) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND SUBSTR(TYPE,1,1) IN ('3','1') AND TYPE!='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='W' GROUP BY TRIM(ICODE),TRIM(BTCHNO) UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(-1*iqtyout) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='W' GROUP BY TRIM(ICODE),TRIM(BTCHNO) ) A,ITEM B," + frmTabItemOSP + " C WHERE TRIM(a.ICODE)=TRIM(B.ICODE) AND TRIM(A.ICODE)=TRIM(C.IBCODe) AND TRIM(C.ICODE)='" + txticode.Text.Trim() + "' group by a.icode,b.iname,b.cpartno,b.unit,a.btchno having sum(a.qty)>0 ORDER BY B.INAME";
                SQuery = "SELECT A.ICODE,B.INAME AS RAW_MAT,B.CPARTNO AS PARTNO,B.UNIT,A.BTCHNO AS BATCH_NO,sum(A.QTY) AS BAL,a.icode as code FROM (select ICODE,BTCHNO,SUM(QTY) AS QTY FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(IQTYOUT+iqtyin) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND (TYPE='31' or SUBSTR(TYPE,1,1)='1') AND TYPE!='39' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE in ('Y','W') UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(WOLINK) AS BTCHNO,(IQTYIN) AS QTY FROM WIPSTK WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='50' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(-1*iqtyout) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='39' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE='W') GROUP BY ICODE,BTCHNO ) A,ITEM B," + frmTabItemOSP + " C WHERE TRIM(a.ICODE)=TRIM(B.ICODE) AND TRIM(A.ICODE)=TRIM(C.IBCODe) AND TRIM(C.ICODE)='" + txticode.Text.Trim() + "' and trim(a.icode)='" + sg1.Rows[Convert.ToInt32(hf1.Value)].Cells[3].Text + "' group by a.icode,b.iname,b.cpartno,b.unit,a.btchno having sum(a.qty)>0  ORDER BY B.INAME";

                //15 /09/ 2020
                SQuery = "SELECT A.ICODE,B.INAME AS RAW_MAT,B.CPARTNO AS PARTNO,B.UNIT,A.BTCHNO AS BATCH_NO,sum(A.QTY) AS BAL,a.icode as code FROM (select ICODE,BTCHNO,SUM(QTY) AS QTY FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(IQTYOUT+iqtyin) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND (TYPE in ('31','70') or SUBSTR(TYPE,1,1)='1') AND TYPE not in ('39','3A','13') AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE in ('W','Y') AND STAGE='61' UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(WOLINK) AS BTCHNO,(IQTYIN) AS QTY FROM WIPSTK WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='50' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STAGE='61' UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(-1*(iqtyin+IQTYOUT)) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE in ('13','3A','39') AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STAGE='61' ) GROUP BY ICODE,BTCHNO ) A,ITEM B," + frmTabItemOSP + " C  WHERE TRIM(a.ICODE)=TRIM(B.ICODE) AND TRIM(A.ICODE)=TRIM(C.IBCODe) AND TRIM(C.ICODE)='" + txticode.Text.Trim() + "' and trim(a.icode)='" + sg1.Rows[Convert.ToInt32(hf1.Value)].Cells[3].Text + "' group by a.icode,b.iname,b.cpartno,b.unit,a.btchno having sum(a.qty)>0  ORDER BY B.INAMe";
            ...
            case "STG":
                ...
                break;
            case "TICODE":
                SQuery = "SELECT TRIM(A.ICODE) AS FSTR,B.INAME AS INAME,B.CPARTNO,B.UNIT,TRIM(A.ICODE)||'-'||TRIM(A.STATIONNO) AS CODE,C.INAME AS MLD_NAME,A.CAVITY,A.SHOTS_DAY AS SHOTS FROM MACHMST A,ITEM B,ITEM C WHERE TRIM(A.ICODE)=TRIM(B.ICODE) AND TRIM(A.STATIONNO)=TRIM(c.ICODe) AND A.BRANCHCD = '" + frm_mbr + "' AND A.MCHNUM='" + txtmchcode.Text.Trim() + "' and trim(a.icode) in (SELECT ICODE FROM (SELECT TRIM(ICODE) AS ICODE,iqtyout AS QTY FROM PROD_SHEET WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='25' AND VCHDATE " + DateRange + " AND TRIM(MCHCODE)='" + txtmchcode.Text.Trim().Split('/')[0].ToString().toDouble() + "/" + txtmchcode.Text.Trim().Split('/')[1].ToString().toDouble() + "' UNION ALL SELECT TRIM(ICODE) AS ICODE,-1*iqtyin AS QTY FROM PROD_SHEET WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='90' AND VCHDATE>=TO_dATE('" + frm_CDT1 + "','DD/MM/YYYY') AND MCHCODE='" + txtmchcode.Text.Trim() + "' ) GROUP BY ICODE HAVING SUM(QTY)>0 )  ORDER BY B.INAME";
                //SQuery = "SELECT TRIM(A.ICODE) AS FSTR,B.INAME AS INAME,B.CPARTNO,B.UNIT,TRIM(A.ICODE)||'-'||TRIM(A.STATIONNO) AS CODE,C.INAME AS MLD_NAME,A.CAVITY,A.SHOTS_DAY AS SHOTS FROM MACHMST A,ITEM B,ITEM C WHERE TRIM(A.ICODE)=TRIM(B.ICODE) AND TRIM(A.STATIONNO)=TRIM(c.ICODe) AND A.BRANCHCD = '" + frm_mbr + "' AND A.MCHNUM='" + txtmchcode.Text.Trim() + "' and trim(a.icode) in (SELECT ICODE FROM (SELECT TRIM(ICODE) AS ICODE,iqtyout AS QTY FROM PROD_SHEET WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='25' AND VCHDATE " + DateRange + " UNION ALL SELECT TRIM(ICODE) AS ICODE,-1*iqtyin AS QTY FROM PROD_SHEET WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='90' AND VCHDATE>=TO_dATE('" + frm_CDT1 + "','DD/MM/YYYY')) GROUP BY ICODE HAVING SUM(QTY)>0 )  ORDER BY B.INAME";
                break;
            case "OPNAME":
    ...
    protected void btnnew_ServerClick(object sender, EventArgs e)
    {
        ...
        if (chk_rights == "Y")
        {
            frm_vnum = fgen.next_no(frm_qstr, frm_vnum, "SELECT MAX(vCHNUM) AS VCH FROM " + frm_tabname2 + " WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='" + frm_vty2 + "' AND VCHDATE " + DateRange + " ", 6, "VCH");
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gr in sg1.Rows)
        {
            ...
            {
                dt = new DataTable();
                if (gr.Cells[7].Text.Trim() == "-" || gr.Cells[7].Text.Trim() == "")
                {
                    fgen.msg("-", "AMSG", "Batch is not selected!!'13'Row No. " + gr.Cells[2].Text.Trim());
                    return;
                }
                else
                {
                    ...
                    SQuery = "SELECT TRIM(a.ICODE) AS ICODE,trim(A.BTCHNO) AS BATCH_NO,sum(A.QTY) AS QTY FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(IQTYOUT) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND SUBSTR(TYPE,1,1) IN ('3','1') AND TYPE!='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='Y'  AND ICODE='" + gr.Cells[3].Text.Trim() + "' AND btchno='" + gr.Cells[7].Text.Trim() + "' GROUP BY TRIM(ICODE),TRIM(BTCHNO) UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(IQTYIN) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND SUBSTR(TYPE,1,1) IN ('3','1') AND TYPE!='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='W'  AND ICODE='" + gr.Cells[3].Text.Trim() + "' AND btchno='" + gr.Cells[7].Text.Trim() + "' GROUP BY TRIM(ICODE),TRIM(BTCHNO) UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,SUM(-1*iqtyout) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='39' AND VCHDATE>TO_dATE('01/04/2010','DD/MM/YYYY') AND STORE='W'  AND ICODE='" + gr.Cells[3].Text.Trim() + "' AND btchno='" + gr.Cells[7].Text.Trim() + "' GROUP BY TRIM(ICODE),TRIM(BTCHNO) ) A GROUP BY TRIM(a.ICODE),trim(A.BTCHNO)";
                    SQuery = "SELECT TRIM(a.ICODE) AS ICODE,trim(A.BATCH_NO) AS BATCH_NO,sum(A.BAL) AS QTY FROM (SELECT A.ICODE,B.INAME AS RAW_MAT,B.CPARTNO AS PARTNO,B.UNIT,A.BTCHNO AS BATCH_NO,sum(A.QTY) AS BAL,a.icode as code FROM (select ICODE,BTCHNO,SUM(QTY) AS QTY FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(IQTYOUT+IQTYIN) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND (SUBSTR(TYPE,1,1)='3' or SUBSTR(TYPE,1,1)='1') AND TYPE!='39' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE IN ('Y','W') UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(WOLINK) AS BTCHNO,(IQTYIN) AS QTY FROM WIPSTK WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='50' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(-1*iqtyout) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='39' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE='W') GROUP BY ICODE,BTCHNO ) A,ITEM B," + frmTabItemOSP + " C WHERE TRIM(a.ICODE)=TRIM(B.ICODE) AND TRIM(A.ICODE)=TRIM(C.IBCODe) AND TRIM(C.ICODE)='" + txticode.Text.Trim() + "' group by a.icode,b.iname,b.cpartno,b.unit,a.btchno having sum(a.qty)>0 ) A WHERE trim(A.BATCH_NO)='" + gr.Cells[7].Text.Trim() + "' GROUP BY TRIM(a.ICODE),trim(A.BATCH_NO)";
                    SQuery = "SELECT TRIM(a.ICODE) AS ICODE,trim(A.BATCH_NO) AS BATCH_NO,sum(A.BAL) AS QTY FROM (SELECT A.ICODE,B.INAME AS RAW_MAT,B.CPARTNO AS PARTNO,B.UNIT,A.BTCHNO AS BATCH_NO,sum(A.QTY) AS BAL,a.icode as code FROM (select ICODE,BTCHNO,SUM(QTY) AS QTY FROM (SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(IQTYOUT+iqtyin) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND (TYPE in ('31','70') or SUBSTR(TYPE,1,1)='1') AND TYPE not in ('39','3A','13') AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STORE in ('W','Y') AND STAGE='61' UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(WOLINK) AS BTCHNO,(IQTYIN) AS QTY FROM WIPSTK WHERE BRANCHCD='" + frm_mbr + "' AND TYPE='50' AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STAGE='61' UNION ALL SELECT TRIM(ICODE) AS ICODE,TRIM(BTCHNO) AS BTCHNO,(-1*(iqtyin+IQTYOUT)) AS QTY FROM IVOUCHER WHERE BRANCHCD='" + frm_mbr + "' AND TYPE in ('13','3A','39') AND VCHDATE>=TO_dATE('" + R10 + "','DD/MM/YYYY') AND STAGE='61' ) GROUP BY ICODE,BTCHNO ) A,ITEM B," + frmTabItemOSP + " C  WHERE TRIM(a.ICODE)=TRIM(B.ICODE) AND TRIM(A.ICODE)=TRIM(C.IBCODe) AND TRIM(C.ICODE)='" + txticode.Text.Trim() + "' and trim(a.icode)='" + sg1.Rows[Convert.ToInt32(hf1.Value)].Cells[3].Text + "' group by a.icode,b.iname,b.cpartno,b.unit,a.btchno having sum(a.qty)>0  ) A WHERE trim(A.BATCH_NO)='" + gr.Cells[7].Text.Trim() + "' GROUP BY TRIM(a.ICODE),trim(A.BATCH_NO)";
        ...
        if (fgen.make_double(txtLump.Text.Trim()) > 0)
        {
            ...
            if (mhd == "0" && mhd.Length < 3)
            {
                fgen.msg("-", "AMSG", "Lump not linked in Product Sub Group Code!!");
                return;
            }
        }
        if (txtNetWt.Text.toDouble() == 0)
        {
            fgen.msg("-", "AMSG", "Dear " + frm_uname + ", Net Wt can not by zero. Please Correct to proceed for this entry!! ");
            return;
        }
    ...
    protected void btnhideF_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "D")
        {
            ...
            if (col1 == "Y")
            {
                ...
                fgen.msg("-", "AMSG", "Details are deleted for " + lblheader.Text + " No." + edmode.Value.Substring(0, 6) + "");
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "Edit":
                    ...
                    if (col1 == "") return;
                    clearctrl();
                    SQuery = "Select a.*,b.iname,B.CPARTNO AS RCPARTNO,B.UNIT AS RUNIT,c.iname AS RINAME,c.cpartno,c.unit from " + frm_tabname + " a,item b,item c where trim(a.icode)=trim(b.icode) and trim(a.rcode)=trim(c.icode) and a.branchcd||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')='" + frm_mbr + col1 + "' and a.type in ('" + frm_vty + "','39') and a.stage in ('61','6R') order by a.srno ";
                    ViewState["fstr"] = col1;
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txticode.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "icode");
                        txtiname.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "iname");
                        ...
                        txtmicode.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "rcode");
                        txtminame.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "riname");

                        txtmchcode.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "acode");
                        ...
                        txtshiftcode.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "O_DEPTT");
                        ...
                        txtstage.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "stage");
                        txtstagename.Text = fgen.seek_iname(frm_qstr, frm_cocd, "SELECT NAME FROM TYPE WHERE ID='1' AND TYPE1='" + txtstage.Text.Trim() + "'", "NAME");

                        txtTimeIn.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "mtime");
                        txtTimeOut.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "revis_no");
                        txtWorkingHrs.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "et_topay");

                        txtbatchno.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "btchno");
                        txtActualCavity.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "ipack");
                        txtRunCavity.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "cavity");

                        txtTargetShot.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "rlprc");
                        txtactshot.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "shots");
                        txtShotHrs.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "segment_");

                        txtOkProd.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "iqtyin");
                        txtTotRej.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "rej_rw");
                        txtLump.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "rej_sdp");
                        txtSampQty.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "rej_sdv");

                        txtoprtr.Text = fgen.seek_iname_dt(dt, "type='15' and stage='61'", "pname");
                        ...
                        {
                            mhd = fgen.seek_iname_dt(dt, "mode_tpt='" + gr.Cells[0].Text.Trim() + "' and stage='6R'", "iqtyin");
    ...
    void save_fun()
    {
        ...
        #region Runner
        if (fgen.make_double(txtRRPerPcs.Text.Trim()) > 0)
        {
            mhd = fgen.seek_iname(frm_qstr, frm_cocd, "SELECT TRIM(SRC2) AS SRC1 FROM ITEM WHERE SUBSTR(TRIM(ICODE),1,4) = '" + txticode.Text.Trim().Substring(0, 4) + "' ", "SRC1");
            if (mhd != "0" && mhd.Length > 2)
            {
                oporow = oDS.Tables[0].NewRow();
                oporow["BRANCHCD"] = frm_mbr;
                ...
                oporow["iqtyOUT"] = 0;
                //oporow["IQTYIN"] = Math.Round(fgen.make_double(txtRRPerPcs.Text) * fgen.make_double(txtTotProd.Text), 4);
                // changed on 2807
                oporow["IQTYIN"] = Math.Round(fgen.make_double(txtRRPerPcs.Text) * fgen.make_double(txtActualCavity.Text) * fgen.make_double(txtactshot.Text), 4);
                oporow["STORE"] = "W";
                oporow["STAGE"] = "6R";
