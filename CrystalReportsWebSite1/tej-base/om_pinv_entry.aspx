<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_pinv_entry" CodeFile="om_pinv_entry.aspx.cs" %>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td><asp:Button ID="btnPMRR" runat="server" CssClass="btn-default" Text="Pending MRR" Width="120px" ToolTip="Pending MRR" OnClick="btnPMRR_Click" /></td>
                                    <td></td>
                                    <td>
