<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="prod_entryy" CodeFile="prod_entryy.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Part No.</label>
                                <div class="col-sm-8">
                                    <input id="txtCpartno" type="text" class="form-control" runat="server" placeholder="Part No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">                                
                                <div class="col-sm-4">
                                    <input id="txtControl" type="text" class="form-control" runat="server" placeholder="Control No." readonly="readonly" />
                                </div>
                                <div class="col-sm-4">
                                    <input id="txtBtchno" type="text" class="form-control" runat="server" placeholder="Batch No." readonly="readonly" />
                                </div>
                                <div class="col-sm-4">
                                    <input id="txtIDNo" type="text" class="form-control" runat="server" placeholder="ID No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">OBS_OD</label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtOBSODmin" CssClass="form-control" runat="server"  placeholder="MIN" ></asp:TextBox>
                                </div>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtOBSODmax" CssClass="form-control" runat="server"  placeholder="MAX" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">OBS_Thik</label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtOBSthikmin" CssClass="form-control" runat="server"  placeholder="MIN" ></asp:TextBox>
                                </div>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtOBSthikmax" CssClass="form-control" runat="server"  placeholder="MAX" ></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
