<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="frmBoxMaster" CodeFile="frmBoxMaster.aspx.cs" %>
        ...
        <section class="content-header">
            <table style="width: 100%">
                ...
                <button type="submit" class="btn btn-info" style="width: 100px;" runat="server" id="cmdexit" accesskey="X" onserverclick="cmdexit_Click">E<u>x</u>it</button>
                    ...
                    <td>
                        <asp:Label ID="lblheader" Text="Costing Master" runat="server" Font-Bold="True" Font-Size="X-Large"></asp:Label>
                    </td>
                </tr>
            </table>
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <table>
                                    <tr>
                                        <td class="auto-style19">Party Master
                                        </td>
                                    ...
                                    <tr>
                                        <td class="auto-style19">Process Wastage </td>
                                        <td class="auto-style35">in %</td>
                                    ...
                                    <tr>
                                        <td class="auto-style19">Board Making Charges </td>
                                        <td class="auto-style35">/ Kg.</td>
                                        <td class="auto-style1" colspan="2">
                                    ...
                                    <tr>
                                        <td class="auto-style19">Printing / Slotting</td>
                                        <td class="auto-style35">in Sq.M.</td>
                                        <td class="auto-style1" colspan="2">
                                    ...
                                    <tr>
                                        <td class="auto-style19">Die Cutting</td>
                                        <td class="auto-style35">/ Sq. M.</td>
                                        <td class="auto-style1" colspan="2">
                                    ...
                                    <tr>
                                        <td class="auto-style19">Taping Or Binding Cloth </td>
                                        <td class="auto-style7">
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <table>
                                    <tr>
                                        <td class="auto-style30">Freight </td>
                                        <td class="auto-style26">in %</td>
                                    ...
                                    <tr>
                                        <td class="auto-style24">Payment Terms</td>
                                        <td class="auto-style12">in %</td>
                                    ...
                                    <tr>
                                        <td class="auto-style30">Excises </td>
                                        <td class="auto-style27">in %</td>
                                        <td class="auto-style1">
                                    ...
                                    <tr>
                                        <td class="auto-style30">Sales Tax </td>
                                        <td class="auto-style27">in %</td>
                                        <td class="auto-style1">
                                    ...
                                    <tr>
                                        <td class="auto-style30">Minimum Order Quantity</td>
                                      ...
                                      <tr>
                                        <td class="auto-style19">Packing </td>
                                        <td class="auto-style35">in %</td>
                                        <td class="auto-style1" colspan="2">
                                ...
                                <asp:BoundField DataField="Aname" HeaderText="Party Name" ReadOnly="True">
                                    ...
                                    <tr>
                                        <td class="auto-style19">Profit Margin </td>
                                        <td class="auto-style36">in %</td>
                                        <td class="auto-style1" colspan="2">
                            ...
                            <div class="form-group">
                                <div id="order_details_grid" style="height: 250px; max-height: 250px; max-width: 1290px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="auto-style31">Paper Price Grade Wise</td>
                                ...
                                <asp:BoundField DataField="Aname" HeaderText="Party Name" ReadOnly="True">
                                    ...
                                    <ItemStyle Width="500px" />
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtCol16" runat="server" Width="70px" Text='<%#Eval("Col16") %>' MaxLength="25" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Style="text-align: right"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
