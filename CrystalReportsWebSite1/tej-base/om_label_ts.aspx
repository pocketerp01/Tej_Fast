<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_label_ts" CodeFile="om_label_ts.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right">
                        ...
                        <button type="submit" id="btnCal" class="btn btn-info" style="width: 100px;" runat="server" accesskey="a" onserverclick="btnCal_ServerClick">Calculate</button>
            ...
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label4" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Sheet No./Date</asp:Label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-5">
                                    <asp:TextBox ID="txtvchdate" runat="server" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl1" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Master No./Date</asp:Label>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label6" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Customer_Name</asp:Label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl101" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="txtlbl101a" runat="server" CssClass="form-control" MaxLength="15" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label5" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Name_of_Sales_Exe</asp:Label>
                                <div class="col-sm-1">
                                ...
                                <asp:TextBox ID="txtlbl7" runat="server" Width="100%" ReadOnly="true" CssClass="form-control" Visible="false"></asp:TextBox>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtlbl7a" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label7" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Name_of_Tag_Insert</asp:Label>
                                <div class="col-sm-1">
                                </div>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtTag" runat="server" Width="100%" MaxLength="15" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Paper Quality GSM</asp:Label>
                                <div class="col-sm-1">
                                </div>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtGSM" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label15" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">App. Order Qty</asp:Label>
                                <div class="col-sm-1">
                                </div>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl2" runat="server" CssClass="form-control" MaxLength="10" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label16" runat="server" CssClass="col-sm-2 control-label" Font-Size="14px">Tag P / Sh.</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl3" runat="server" CssClass="form-control" MaxLength="10" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label12" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Paper_Sheet_Size</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label14" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Printed_Paper_Size</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtPaper_Size" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label8" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">No_of_Colors</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtColors" runat="server" CssClass="form-control" MaxLength="15"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label9" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">ReqSheet</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl5" runat="server" Width="100%" MaxLength="15" CssClass="form-control" ReadOnly="true" Style="text-align: right"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label10" runat="server" CssClass="col-sm-2 control-label" Font-Size="14px">Wastage</asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" MaxLength="15" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label11" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Prosposed_Prod</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtlbl8" runat="server" Width="100%" MaxLength="15" CssClass="form-control" ReadOnly="true" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label13" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">Total_Sheet_for_Printing</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl102" runat="server" Width="100%" MaxLength="15" CssClass="form-control" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl102a" runat="server" Width="100%" MaxLength="15" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px">No_of_Sheet</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl103" runat="server" Width="100%" MaxLength="15" CssClass="form-control" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtlbl103a" runat="server" Width="100%" MaxLength="15" CssClass="form-control" ReadOnly="True" Style="text-align: right"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <<fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Type Of Charges</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" MaxLength="150" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" MaxLength="150" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>True Or False</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t3") %>' Width="100%" MaxLength="100" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Standard</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t4") %>' Width="100%" MaxLength="100"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Master Rate</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t5") %>' Width="100%" MaxLength="9" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Master SrNo</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t6") %>' Width="100%" MaxLength="9" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Rate1</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' Width="100%" MaxLength="9" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Rate2</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' Width="100%" MaxLength="9" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Tot Amt</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t9") %>' Width="100%" MaxLength="9" onkeypress="return isDecimalKey(event)" Style="text-align: right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
