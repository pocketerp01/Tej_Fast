<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_leave_req" CodeFile="om_leave_req.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-2 control-label" title="lbl1">Lv_Req_No</label>
                                  <div class="col-sm-1">                      
                            ...
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-3 control-label" title="lbl1">LV_Req_Dt</label>
                                <div class="col-sm-9">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="lvfromlb" runat="server" class="col-sm-3 control-label" title="lbl1">Leave_Date</label>
                                <div class="col-sm-4">
                                    <input id="lvfrom" type="date" class="form-control"  onkeyup="cal()" runat="server"   maxlength="10" />
                                                              
                                </div>
                                
                                  <label id="Label2" runat="server" class="col-sm-2 control-label" title="lbl1">Leave_Time</label>
                                <div class="col-sm-3">
