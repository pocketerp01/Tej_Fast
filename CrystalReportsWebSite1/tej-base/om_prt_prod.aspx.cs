...
public partial class om_prt_prod3 : System.Web.UI.Page
{
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        //if (fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL1").Length > 0 || fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL2").Length > 0 || fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL3").Length > 0)
        {
            ...
            {
                case "F20121":
                    SQuery = "Select " + rep_flds + " from " + table1 + " , " + table2 + ", " + table3 + "   where a." + branch_Cd + "  and a.type='00' and " + datefld + " " + xprdrange + " and " + joincond + "  order by " + sortfld;
                    fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
                    fgen.Fn_open_rptlevel("Gate Inward Checklist for the Period " + value1 + " to " + value1, frm_qstr);
                    break;
                case "F20126":
                    SQuery = "Select " + rep_flds + " from " + table1 + " , " + table2 + ", " + table3 + "   where a." + branch_Cd + "  and a.type='2G' and " + datefld + " " + xprdrange + " and " + joincond + "  order by " + sortfld;
                    fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
                    fgen.Fn_open_rptlevel("Gate Outward Checklist for the Period " + value1 + " to " + value1, frm_qstr);
                    break;
