<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_Sagm_mast" CodeFile="om_Sagm_mast.aspx.cs" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl2" runat="server" Text="Licence_No" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl2" runat="server" CssClass="form-control" Width="100%" MaxLength="20"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                               <asp:Label ID="lbl5" runat="server" Text="Import_Quantity" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl5" runat="server" CssClass="form-control" ReadOnly="true" onChange="calqty()" MaxLength="25"></asp:TextBox>
                                </div>
                                <asp:Label ID="lbl6" runat="server" Text="Import_Value" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                 <div class="col-sm-4">
                                     <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" ReadOnly="true" onChange="calqty()" MaxLength="25"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl8" runat="server" Text="Export_Quantity" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl8" runat="server" CssClass="form-control" ReadOnly="true" onChange="calqty()" MaxLength="25"></asp:TextBox>
                                </div>
                                <asp:Label ID="lbl9" runat="server" Text="Export_Value" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" ReadOnly="true" onChange="calqty()" MaxLength="25"></asp:TextBox>
                                </div>
                            </div>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f1" HeaderText="HSN_Code" />
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Import_Raw_Material" />
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Value(Rs.)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' onkeypress="return isDecimalKey(event)" Width="100%" onChange="calqty()" MaxLength="22"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <div class="lbBody" style="height: 250px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg3" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg3_f1" HeaderText="HSN_Code" />
                                                <asp:BoundField DataField="sg3_f2" HeaderText="Export_Item" />

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Quantity(Kgs)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg3_t1" runat="server" Text='<%#Eval("sg3_t1") %>' onkeypress="return isDecimalKey(event)" MaxLength="22" Width="100%" onChange="calqty()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Value(Rs.)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg3_t2" runat="server" Text='<%#Eval("sg3_t2") %>' onkeypress="return isDecimalKey(event)" MaxLength="22" Width="100%" onChange="calqty()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Value(US$)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg3_t3" runat="server" Text='<%#Eval("sg3_t3") %>' onkeypress="return isDecimalKey(event)" MaxLength="25" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
    ...
    <script>
        function calqty() {
            ...
            for (var i = 0; i < sg1.Rows.Count - 1; i++) {
                imqty = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value));
                alert(imqty);
                imval = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value));
            }
            for (var k = 0; k < sg3.Rows.Count - 1; k++) {
                expqty = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg3_sg3_t1_' + k).value));
                expval = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg3_sg3_t2_' + k).value));
            }
        }
