<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_EPCG_Implic" CodeFile="om_EPCG_Implic.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label15" runat="server" Text="No_Of_Times" Font-Bold="true" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtlbl7a" runat="server" CssClass="form-control" Width="100%" MaxLength="25" ReadOnly="true" onkeypress="return isDecimalKey(event)"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txt_exp_oblig_imp" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Style="text-align:right"></asp:TextBox>
                                    <div class="col-sm-3" style="display: none;">
                                        <asp:TextBox ID="txt_duty_Saved_usd" runat="server" ReadOnly="true" CssClass="form-control" Width="100%"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f3" HeaderText="Item_code" ItemStyle-Width="80px" />
                                                <asp:BoundField DataField="sg1_f4" HeaderText="Item_name" ItemStyle-Width="80px" Visible="false" />
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Item_name</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' Width="100%" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>CIF_Value(US$)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" MaxLength="22" onkeypress="return isDecimalKey(event)" Style="text-align:right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField ItemStyle-Width="110px">
                                                    <HeaderTemplate>Duty_Saved(INR)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" Width="100%" MaxLength="22" Style="text-align:right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Exchange_Rate</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Duty_Saved(USD)</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' onkeypress="return isDecimalKey(event)" onChange="caltotalvalue()" Width="100%" MaxLength="28" Style="text-align:right"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <script>
        ...
        function caltotalvalue() {
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                ...
                //////////
                min += fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg1_sg1_t5_' + i).value));
                //alert(min);
                document.getElementById('ContentPlaceHolder1_txt_duty_Saved_usd').value = fill_zero(min); //for sum of duty saved_usd field in grid for export obligation as per import
            }
        }
        <%-- function fill_zero(val) { if (isNaN(val)) return 0; if (isFinite(val)) return val; }
