...
public partial class om_stg_tfr : System.Web.UI.Page
{
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "Row_Edit":
                ...
                SQuery = "select trim(a.icode) as fstr,c.iname as item_name,a.icode as item_code,c.cpartno,c.unit,a.btchno as Batch,a.binno as YLB,sum(a.iqtyin)-sum(a.iqtyout) as balance,trim(a.icode)||trim(A.btchno) as bcode from (select trim(icode) as icode,btchno AS btchno,iqtyin,0 as iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='" + svty + "' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno AS btchno,0 as iqtyin,iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,trim(a.icode)||trim(A.btchno) having sum(a.iqtyin)-sum(a.iqtyout)>0 order by a.icode";
                SQuery = "select trim(a.icode)||trim(a.btchno) as fstr,c.iname as item_name,a.icode as item_code,c.cpartno,c.unit,a.btchno as Batch,a.binno as YLB,sum(a.iqtyin)-sum(a.iqtyout) as balance,trim(a.icode)||trim(A.btchno) as bcode from (select trim(icode) as icode,btchno AS btchno,iqtyin,0 as iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type like '%' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno AS btchno,0 as iqtyin,iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type like '%' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,trim(a.icode)||trim(A.btchno) having sum(a.iqtyin)-sum(a.iqtyout)>0 order by a.icode";
                //if (frm_cocd == "SRPF" && txtstgfcode.Text == "62") SQuery = "select trim(a.icode) as fstr,c.iname as item_name,a.icode as item_code,c.cpartno,c.unit,a.btchno as Batch,a.binno as YLB,sum(a.iqtyin)-sum(a.iqtyout) as balance,trim(a.icode)||trim(A.btchno) as bcode from (select trim(icode) as icode,btchno AS btchno,iqtyin,0 as iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno AS btchno,0 as iqtyin,iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,trim(a.icode)||trim(A.btchno) having sum(a.iqtyin)-sum(a.iqtyout)>0 order by a.icode";
                if (frm_cocd == "MANU") SQuery = "select trim(a.btchno)||trim(a.binno) as fstr,c.iname as item_name,a.icode as item_code,c.cpartno,c.unit,a.btchno as Batch,sum(a.iqtyin)-sum(a.iqtyout) as balance from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type IN ('" + svty + "','39') and stage='" + txtstgfcode.Text.Trim() + "'  /*and store='W'*/ union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  /*and store='W'*/) a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,trim(a.binno) having sum(a.iqtyin)-sum(a.iqtyout)>0 and trim(a.btchno)||trim(a.binno) not in " + col2 + " order by a.icode";
                if (frm_cocd == "GTCF") SQuery = "select trim(a.icode)||trim(a.btchno)||trim(a.binno) as fstr,c.iname as item_name,a.icode as item_code,c.cpartno,c.unit,a.btchno as Palletno,trim(a.binno) as YLB,sum(a.iqtyin)-sum(a.iqtyout) as balance from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='" + svty + "' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c,itwstage b,TYPE d where trim(a.icode)=trim(c.icode) and trim(A.icode)=trim(b.icodE) and trim(b.stagec)=trim(d.type1) and b.type='10' and d.id='K' AND trim(d.addr1)='" + txtstgtcode.Text.Trim() + "' group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,trim(a.binno) having sum(a.iqtyin)-sum(a.iqtyout)>0 and trim(a.icode) not in " + col2 + " order by a.icode";
                break;
            default:
        ...
        {
            {
                ...
                switch (btnval)
                {
                    ...
                    case "Edit":
                        ...
                        if (col1 == "") return;
                        popselected.Value = col1;
                        SQuery = "select a.*,b.NAME as aname,c.iname,c.cpartno,c.maker,c.unit from " + frm_tabname + " a,type b,item c where b.id='M' and trim(a.acodE)=trim(B.type1) and trim(a.icode)=trim(c.icode) and a.branchcd||a.type||trim(A.vchnum)||to_char(a.vchdate,'dd/mm/yyyy')='" + col1 + "' and a.iqtyOUT>0 order by a.morder ";
                        dt = new DataTable();
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            if (Convert.ToDouble(dr["IQTYOUT"].ToString().Trim()) > 0)
                            {
                                ...
                                dr1["tfld3"] = dr["invno"].ToString().Trim();
                                dr1["tfld4"] = dr["invdate"].ToString().Trim();
                                dr1["tfld5"] = dr["desc_"].ToString().Trim();
    ...
    void save_fun()
    {
        for (i = 0; i < sg1.Rows.Count; i++)
        {
            if (sg1.Rows[i].Cells[3].Text.Trim().Length > 4)
            {
                ...
                //oporow["no_bdls"] = ((TextBox)sg1.Rows[i].FindControl("txtfld2")).Text.Trim();
                //oporow["mode_tpt"] = txtcarrier.Text.ToUpper().ToString().Trim().Replace("'", " ").Replace("\"", " ");
                //oporow["invno"] = ((TextBox)sg1.Rows[i].FindControl("txtfld3")).Text.Trim();                

                //int dhd = fgen.ChkDate(((TextBox)sg1.Rows[i].FindControl("txtfld4")).Text.Trim());
                //if (dhd == 0)
                //{
                ...
                //else
                //{
                //    oporow["invdate"] = ((TextBox)sg1.Rows[i].FindControl("txtfld4")).Text.Trim();
                //}
    ...
    void add_data_grid(string pop_value)
    {
        ...
        if (ViewState["sg1"] != null)
        {
            ...
            for (i = 0; i < dt.Rows.Count - 1; i++)
            {
                ...
                //dr1["tfld4"] = ((TextBox)sg1.Rows[i].FindControl("txtfld4")).Text.Trim();
                //dr1["tfld5"] = ((TextBox)sg1.Rows[i].FindControl("txtfld5")).Text.Trim();
            ...
            SQuery = "select * from (select a.icode ,c.iname ,c.cpartno,c.unit,a.btchno,a.purpose ,sum(a.iqtyin)-sum(a.iqtyout) as balance,a.binno from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='" + svty + "' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,a.purpose having sum(a.iqtyin)-sum(a.iqtyout)>0 ) where trim(icode) ='" + col1 + "'";
            SQuery = "select * from (select a.icode ,c.iname ,c.cpartno,c.unit,a.btchno,a.purpose ,sum(a.iqtyin)-sum(a.iqtyout) as balance,a.binno from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type like '%' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type like '%' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,a.purpose having sum(a.iqtyin)-sum(a.iqtyout)>0 ) where trim(icode)||trim(btchno) ='" + col1 + "'";
            //if (frm_cocd == "SRPF" && txtstgfcode.Text == "62") SQuery = "select * from (select a.icode ,c.iname ,c.cpartno,c.unit,a.btchno,a.purpose ,sum(a.iqtyin)-sum(a.iqtyout) as balance,a.binno from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,a.purpose having sum(a.iqtyin)-sum(a.iqtyout)>0 ) where trim(icode) ='" + col1 + "'";
            if (frm_cocd == "GTCF") SQuery = "select * from (select a.icode ,c.iname ,c.cpartno,c.maker,c.unit,a.btchno ,sum(a.iqtyin)-sum(a.iqtyout) as balance,a.binno,a.purpose from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type IN ('" + svty + "') and stage='" + txtstgfcode.Text.Trim() + "'  and store='W' union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and stage='" + txtstgfcode.Text.Trim() + "'  and store='W') a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,a.purpose,c.maker having sum(a.iqtyin)-sum(a.iqtyout)>0 ) where trim(icode)||trim(btchno)||trim(binno) ='" + col1 + "'";
            if (frm_cocd == "MANU") SQuery = "select * from (select a.icode ,c.iname ,c.cpartno,c.unit,a.btchno ,sum(a.iqtyin)-sum(a.iqtyout) as balance,a.binno,a.purpose from (select trim(icode) as icode,btchno,iqtyin,0 as iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type in ('" + svty + "','39') and vchdate>to_date('01/01/2010','dd/mm/yyyy') and trim(btchno)||trim(binno) ='" + col1 + "' /*and store='W'*/  and stage='" + txtstgfcode.Text.Trim() + "'  union all select trim(icode) as icode,btchno,0 as iqtyin,iqtyout,binno,purpose from ivoucher where branchcd='" + frm_mbr + "' and type='3A' and vchdate>to_date('01/01/2010','dd/mm/yyyy') and trim(btchno)||trim(binno) ='" + col1 + "' /*and store='W'*/ and stage='" + txtstgfcode.Text.Trim() + "' ) a,item c where trim(a.icode)=trim(c.icode) group by c.iname,a.icode,c.cpartno,c.unit,a.btchno,a.binno,a.purpose having sum(a.iqtyin)-sum(a.iqtyout)>0 ) where trim(btchno)||trim(binno) ='" + col1 + "' " + col3 + "";
            ...
            for (i = 0; i < dt.Rows.Count; i++)
            {
                ...
                dr1["poqty"] = dt.Rows[i]["btchno"].ToString().Trim();
                dr1["tfld1"] = dt.Rows[i]["purpose"].ToString().Trim();
                dr1["tfld2"] = dt.Rows[i]["BALANCE"].ToString().Trim();
                dr1["tfld3"] = dt.Rows[i]["binno"].ToString().Trim();
                dr1["tfld4"] = "-";
                dr1["tfld5"] = "-";
                dt1.Rows.Add(dr1);
                if (frm_cocd == "GTCF")
