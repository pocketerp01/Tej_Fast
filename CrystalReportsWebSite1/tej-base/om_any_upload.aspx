<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_any_upload" CodeFile="om_any_upload.aspx.cs" %>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                               ...
                               <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                    <asp:TextBox ID="txtvchnum" runat="server" Width="80px" ReadOnly="true" Visible="false"></asp:TextBox>
                                </div>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group" style="background-color:beige">
                                <asp:Label ID="lblhelp" runat="server" style="font-size:small;text-align:justify" visible="true" Text="Click Format to download excel file to prepare data.Mandatory fields are assetID,Asset group code,Invoice No.,Invoice & installation date(DD/MM/YYYY format),basic cost,life in years,balance life in days.Duplicate Asset Id not allowed.Qty can be 1 only(all assets to be unique for identification)." ></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <section class="col-lg-12 connectedSortable">
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            ...
                            ToolTip="Export to Excel" Width="120px" Height="45px" OnClick="btnexptoexl_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
