<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_Anex_Cust_Fil" CodeFile="om_Anex_Cust_Fil.aspx.cs" %>
<%--  --%>
                    ...
                    <div>
                        <div class="box-body">
                           ...
                           <div class="form-group" style="display:none;">
                             ...
                             <div class="form-group">
                                 <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Invoice_No</asp:Label>
                                 <div class="col-sm-1">
                               <asp:ImageButton ID="btninv" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btninv_Click" />
                                </div>
                                 <div class="col-sm-4">
                              <asp:TextBox ID="txtlbl3" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" ></asp:TextBox>                                            
                                        </div>
                                 <asp:Label ID="Label4" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Invoice_Date</asp:Label>
                                 <div class="col-sm-3">
                              <asp:TextBox ID="txtbalqty" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" MaxLength="22"></asp:TextBox>                                            
                                        </div>
                             </div>
                            <div class="form-group">
                                <asp:Label ID="Label18" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Item_Description</asp:Label>
                                 <div class="col-sm-9" style="display:none;">
                                     <asp:TextBox ID="txthscode" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" MaxLength="135"></asp:TextBox>
                                     </div>
                                <div class="col-sm-9">
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f1" HeaderText="Item_code"  ItemStyle-Width="80px" />
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Desc Of Goods" ItemStyle-Width="80px" />
                                                ...
                                                <asp:TemplateField ItemStyle-Width="15px">
                                                            <HeaderTemplate>Qty Nos</HeaderTemplate>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" MaxLength="22" ReadOnly="true"></asp:TextBox>
                                                                  </ItemTemplate>
                                                        </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Rate USD</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" MaxLength="22" ReadOnly="true"></asp:TextBox>                                                   
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                               
                                                <asp:TemplateField ItemStyle-Width="110px">
                                                    <HeaderTemplate>Value USD</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" Width="100%" MaxLength="22" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Quantity Kgs</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' onkeypress="return isDecimalKey(event)"  Width="100%" maxlength="27" ReadOnly="true" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField >
                                                    <HeaderTemplate>Item_Rate</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' Width="100%" maxlength="20" ReadOnly="true" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Value_USD</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Width="100%" maxlength="30" ReadOnly="true" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Present_Market_Value</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' Width="100%" maxlength="20" ReadOnly="true" onkeypress="return isDecimalKey(event)"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Scheme_Code</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' Width="100%" onkeypress="return isDecimalKey(event)" maxlength="20" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField >
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t11" runat="server" Width="100%" >
                                                            ...
                                                            <asp:ListItem Text="INDIG" Value="INDIG"></asp:ListItem>
                                                            <asp:ListItem Text="IMPORTED" Value="IMPORTED"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="cmd" runat="server" Value='<%#Eval("sg1_t11") %>' />
                                                ...
                                                <asp:TemplateField >
                                                    <HeaderTemplate>Whether</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="sg1_t13" runat="server" Width="100%" >
                                                            <asp:ListItem Text="PLEASE SELECT" Value="PLEASE SELECT"></asp:ListItem>
                                                            <asp:ListItem Text="INDIG" Value="INDIG"></asp:ListItem>
                                                            <asp:ListItem Text="IMPORTED" Value="IMPORTED"></asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:HiddenField ID="cmd1" runat="server" Value='<%#Eval("sg1_t13") %>' />
