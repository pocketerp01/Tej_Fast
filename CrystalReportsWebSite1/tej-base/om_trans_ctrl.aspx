<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_trans_ctrl" CodeFile="om_trans_ctrl.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">Trans_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="Trans No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">Trans Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="Trans" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Party Code</label>
                                ...
                                <div class="col-sm-8">
                                    <input id="txt_partyc" type="text" class="form-control" runat="server" placeholder="Party Code" maxlength="10" readonly="readonyl" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Party Name</label>
                                <div class="col-sm-8">
                                    <input id="txt_partyn" type="text" class="form-control" runat="server" placeholder="Party Name" maxlength="30" readonly="readonyl" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Current Dues</label>
                                <div class="col-sm-3">
                                    <input id="txt_dues" type="text" class="form-control" runat="server" placeholder="Current Dues" maxlength="30" readonly="readonyl" />
                                </div>

                                  <label id="Label10" runat="server" class="col-sm-2 control-label" title="lbl1">Allow_Amt</label>
                                <div class="col-sm-3">
                                    <input id="txt_allo" type="number" class="form-control" runat="server" placeholder="Allowed Dues" maxlength="20" />
                                </div>
                            </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="div1" runat="server">
                                    <asp:ImageButton ID="btnrsncd" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnrsncd_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txt_rsn" type="text" class="form-control" runat="server" placeholder="Reason" maxlength="10" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lvfromlb" runat="server" class="col-sm-4 control-label" title="lbl1">Applicable Upto</label>
                                <div class="col-sm-8">
                                    <input id="txt_upto" type="date" class="form-control" onkeyup="cal()" runat="server" maxlength="10" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="divPersonName" runat="server">
                                    <asp:ImageButton ID="btnPersonName" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnPersonName_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txt_contn" type="text" class="form-control" runat="server" placeholder="Contact Name" maxlength="30" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Contact No.</label>
                                <div class="col-sm-8">
                                    <input id="txt_contp" type="text" class="form-control" runat="server" placeholder="Contact No." maxlength="10" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Email Id</label>
                                <div class="col-sm-8">
                                    <input id="txt_email" type="text" class="form-control" runat="server" placeholder="Mail ID" maxlength="30" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label11" runat="server" Text="1.Please Mention Reason Code Correctly." CssClass="col-sm-2 control-label"></asp:Label>
