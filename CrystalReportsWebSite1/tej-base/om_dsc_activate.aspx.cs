...
public partial class om_dsc_activate : System.Web.UI.Page
{
        ...
        else
        {
            ...
            if (dscAuthName == "")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    col1 = fgen.seek_iname(frm_qstr, frm_cocd, "SELECT NUM6 AS FSTR FROM TYPEGRP WHERE ID='X1' AND TYPE1='" + 1006 + "' ", "FSTR");
                    if (col1 == "0") col1 = "1";
                }
            }
    ...
    void setColHeadings()
    {
        ...
        txtrmk.Attributes.Add("readonly", "readonly");
    ...
    public void set_Val()
    {
        ...
        Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
        frm_tabname = "fin_Rsys_opt";

        fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "OP");
        typePopup = "N";
        ...
        dt = new DataTable();
        dt = fgen.getdata(frm_qstr, frm_cocd, "Select Opt_ID,Opt_text,Opt_Enable,Opt_Param,Opt_Param2,Opt_Excl,ent_by,to_char(ent_dt,'dd/mm/yyyy') as ent_Dt,EDT_BY,EDT_DT from " + frm_tabname + " where BRANCHCD!='DD' AND Type='OP' order by OPT_ID ");
        ...
        switch (btnval)
        {
            ...
            default:
                if (btnval == "Edit_E" || btnval == "Del_E" || btnval == "Print_E")
                    SQuery = "select distinct trim(A." + doc_nf.Value + ")||to_Char(a." + doc_df.Value + ",'dd/mm/yyyy') as fstr,a." + doc_nf.Value + " as Opt_No,a.Opt_id,to_char(a." + doc_df.Value + ",'dd/mm/yyyy') as Opt_Dt,a.Opt_text ,a.Opt_Enable,a.Opt_param,a.Ent_by,to_char(a.ent_Dt,'dd/mm/yyyy') as Ent_dt,to_Char(a." + doc_df.Value + ",'yyyymmdd') as vdd from " + frm_tabname + " a where  a.branchcd='" + frm_mbr + "' and trim(a.type)='" + lbl1a_Text + "' " + cond + " order by vdd desc,a." + doc_nf.Value + " desc";
                break;
        }
    ...
    protected void btnnew_ServerClick(object sender, EventArgs e)
    {
        ...
        //fgen.msg("-", "AMSG", "Dear " + frm_uname + ", New Option Can be Added by Development Wing");
        //return;
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        //{
        //    fgen.msg("-", "AMSG", " Please Enter You Name !!");
        //    return;
        //}
        //if (txtlbl3.Value.Length < 2)
        //{
        //    fgen.msg("-", "AMSG", " Please Enter You Contact No. !!");
        //    return;
        //}
        //if (txtlbl5.Value.Length < 2)
        //{
        //    fgen.msg("-", "AMSG", " Please Enter You Email ID !!");
        //    return;
        //}
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
                    string mv_col;
                    mv_col = frm_mbr + "OP" + col1;
                    SQuery = "Select a.*,to_Char(a.ent_Dt,'dd/mm/yyyy') As ment_date from " + frm_tabname + " a where a.branchcd||trim(a.type)||trim(a." + doc_nf.Value + ")||to_Char(a." + doc_df.Value + ",'dd/mm/yyyy')='" + mv_col + "' ";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        ddAnalysis.Value = dt.Rows[i]["OPT_ENABLE"].ToString().Trim();
                        txtlbl2.Value = dt.Rows[i]["OPT_PARAM"].ToString().Trim();

                        txtlbl3.Value = dt.Rows[i]["OPT_PARAM2"].ToString().Trim();
                        txtlbl5.Value = dt.Rows[i]["OPT_EXCL"].ToString().Trim();
                        txtrmk.Text = dt.Rows[i]["OPT_TEXT"].ToString().Trim();
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            SQuery = "Select Opt_ID,Opt_text,Opt_Enable,Opt_Param,Opt_Param2,Opt_Excl,ent_by,to_char(ent_dt,'dd/mm/yyyy') as ent_Dt,EDT_BY,EDT_DT from " + frm_tabname + " where BRANCHCD!='DD' AND Type='OP' order by OPT_ID ";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
    ...
    void save_fun()
    {
        ...
        oporow["OPT_ID"] = "W" + frm_vnum.Substring(2, 4);
        oporow[doc_nf.Value] = frm_vnum;
        oporow[doc_df.Value] = txtvchdate.Value.Trim();

        oporow["OPT_ENABLE"] = ddAnalysis.Value;
        oporow["OPT_PARAM"] = txtlbl2.Value.ToUpper().Trim();
        oporow["OPT_PARAM2"] = txtlbl3.Value.ToUpper().Trim();
        oporow["OPT_EXCL"] = txtlbl5.Value.ToUpper().Trim();

        oporow["OPT_TEXT"] = txtrmk.Text;
    ...
    ////{
    ////    string filepath = Server.MapPath("~/tej-base/UPLOAD/");
    ////    Attch.Visible = true;
    ////    if (Attch.HasFile)
    ////    {
    ...
    ////    }
    ////}
    protected void btnStructure_ServerClick(object sender, EventArgs e)
    {
        //Webtel_e_Sign.ESign aa = new Webtel_e_Sign.ESign(ConnInfo.IP, "FIN" + frm_cocd, ConnInfo.nPwd, ConnInfo.srv, "1521", "2");
        //bool r = aa.CreateDBStructure();
        //if (r) fgen.msg("-", "AMSG", "Step 1 has been successfully done");
    }
    protected void btnActivate_ServerClick(object sender, EventArgs e)
    {
        //Webtel_e_Sign.ESign obj = new Webtel_e_Sign.ESign(ConnInfo.IP, "FIN" + frm_cocd, ConnInfo.nPwd, ConnInfo.srv, "1521", "2");
        //string Error = "";
        //bool r = obj.ActivateCompany(dscAuthName, fgen.make_int(col1), dscAuthName, dscPanNo, out Error);
        //if (r) fgen.msg("-", "AMSG", "Step 2 has been successfully done");
        //else fgen.msg("-", "AMSG", "False : " + Error);
    }
    protected void btnImportDSC_ServerClick(object sender, EventArgs e)
    {
        //Webtel_e_Sign.ESign obj = new Webtel_e_Sign.ESign(ConnInfo.IP, "FIN" + frm_cocd, ConnInfo.nPwd, ConnInfo.srv, "1521", "2");
        //string err = "";
        //byte[] BB = new byte[1];
        //// IF DOING FROM TOKEN, THEN PASS ABOVE LINE IN N.SIG, 123 IS KEYS PIN
        //bool r = false;
        //if (fgen.make_int(col1) == 2)
        //    r = obj.ImportAuthorizeSignatory(dscAuthName, BB, "1234567890", dscAuthName, dscAuthName, out err, fgen.make_int(col1), dscPanNo);
        //else
        //{
        //    //r = obj.ImportAuthorizeSignatory("Pocketdriver LIMITED", BB, "123", "vikas", "vikas khare", out err, 1, "AADCM2389N");
        //    if (frm_cocd == "MLGI") r = obj.ImportAuthorizeSignatory(dscAuthName, File.ReadAllBytes(Server.MapPath("\\tej-base\\myFiles\\finsys_client.sig")), "123", dscAuthName, dscAuthName, out err, 1, dscPanNo);
        //    else r = obj.ImportAuthorizeSignatory(dscAuthName, File.ReadAllBytes(Server.MapPath("\\tej-base\\myFiles\\finsys_client.sig")), "123", dscAuthName, dscAuthName, out err, 1, dscPanNo);
        //}        
        //if (r) fgen.msg("-", "AMSG", "Step 3 has been successfully done");
        //else fgen.msg("-", "AMSG", "False : " + err);
    }
}