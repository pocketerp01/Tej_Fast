<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_einv_entry" CodeFile="om_einv_entry.aspx.cs" %>
        ...
        function calculateSum() {
            ...
            for (var i = 0; i < gridCount; i++) {
                ...
                if ((CGST[i].value * 1) > 0) {
                    ...
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t17_' + i).value = fill_zero(tax1).toFixed(2);
                }
                if ((SGST[i].value * 1) > 0) {

                    tax2 = ((AMOUNT + tool_amtz) * (SGST[i].value * 1) / 100);
                    totSGST = totSGST + tax2;
                    document.getElementById('ContentPlaceHolder1_sg1_sg1_t18_' + i).value = fill_zero(tax2).toFixed(2);
