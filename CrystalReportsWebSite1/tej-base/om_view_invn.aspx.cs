            ...
            switch (val)
            {
                ...
                case "F58004":
                    ...
                    else
                    {
                        ...
                        mq0 = "select trim(a.Icode) as FSTR,'-' as GSTR,(case when trim(A.Icode)='Total' then 'Report Total' else b.Iname end) as Item_Name,b.Cpartno,sum(a.opening) as Opening_Bal," +
                            ...
                            "max(b.maker) as Make,trim(a.Icode) as Icode,sum(a.imin) AS Min_lvl,sum(a.imax) As Max_lvl,sum(a.iord) as Re_ord_lvl,substr(trim(a.Icode),1,2) as " +
