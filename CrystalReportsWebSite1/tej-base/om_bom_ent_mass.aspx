<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_bom_ent_mass" CodeFile="om_bom_ent_mass.aspx.cs" %>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_srno" HeaderText="sg1_srno" />
                                                    ...
                                                    <HeaderTemplate>Is_Main</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <div style="margin-left: 6px;">
                                                            <asp:CheckBox ID="chk1" runat="server" CssClass="ChkBoxClass" />
                                                        </div>
                                                    </ItemTemplate>
