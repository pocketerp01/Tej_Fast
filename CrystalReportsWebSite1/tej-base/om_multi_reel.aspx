<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_multi_reel" CodeFile="om_multi_reel.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align:left">
                        ...
                        <button type="submit" id="btnhelp" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnhelp_ServerClick">Dw<u>l</u>exl</button>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lbl1a" runat="server" Text="TC" Style="width: 22px; float: right; visibility:hidden;" CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                 ...
                                 <asp:Label ID="Label2" runat="server" Text="Stockdt" CssClass="col-sm-2 control-label"></asp:Label>
                                  <div class="col-sm-1">
                                    <asp:TextBox ID="txtstkdt" placeholder="Date" runat="server" Width="100px"></asp:TextBox>
                                    <asp:CalendarExtender ID="CalendarExtender1" runat="server"
                                        Enabled="True" TargetControlID="txtstkdt"
                                        Format="dd/MM/yyyy"></asp:CalendarExtender>
                                    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999"
                                        MaskType="Date" TargetControlID="txtstkdt" />
                                </div>
                ...
                <section class="col-lg-12 connectedSortable">
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            ...
                            ToolTip="Download file to see errors" Width="70px" Height="30px" OnClick="btnexptoexl_Click" />
