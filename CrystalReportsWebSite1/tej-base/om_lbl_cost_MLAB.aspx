<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_lbl_cost_MLAB" CodeFile="om_lbl_cost_MLAB.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" style="display: none">
                                    <asp:TextBox ID="txtacode" runat="server" CssClass="form-control" Width="100%" MaxLength="50" Height="28px"></asp:TextBox>
                                </div>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtaname" runat="server" CssClass="form-control" Width="100%" MaxLength="50" Height="28px"></asp:TextBox>
                                </div>

                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" Text="lbl3" CssClass="col-sm-3             control-label" Font-Size="14px" Font-Bold="True">Job_Name</asp:Label>
                                <div class="col-sm-1" style="display: none;">
                                ...
                                <div class="col-sm-1" style="display: none">
                                    <asp:TextBox ID="txticode" runat="server" CssClass="form-control" Width="100%" MaxLength="50" Height="28px"></asp:TextBox>
                                </div>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtiname" runat="server" CssClass="form-control" Width="100%" MaxLength="50" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label13" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Label_Type&nbsp;&nbsp;</asp:Label>
                                <asp:DropDownList ID="ddSel" runat="server" CssClass="col-sm-9 control-label" Font-Size="14px">
                                    <asp:ListItem Text="Single" Value="Single" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="Front and Back" Value="Frond and Back"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Trim_Wastage%</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txttrmwastg" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label12" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Paper_Size(cm)</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtoh_trm" runat="server" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <%--  <asp:Label ID="Label6" runat="server" Text="lbl3" CssClass="col-sm-1 control-label" Font-Size="14px" Font-Bold="True">Step1</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtstep1" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>--%>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label6" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Step1</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstep1" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label7" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Step2</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstep2" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtentby" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtendtdt" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtwidthmm" runat="server" BackColor="LightBlue" autocomplete="off" onkeyup="cal()" onkeypress="return isDecimalKey(event)" CssClass="form-control" Width="100%" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtvarnish_trm" runat="server" BackColor="LightBlue" autocomplete="off" MaxLength="5" onkeyup="cal()" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label17" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Min_Range</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtminrng" runat="server" BackColor="LightBlue" autocomplete="off" onkeyup="cal()" onkeypress="return isDecimalKey(event)" CssClass="form-control" Width="100%" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label24" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Max_Range</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtmaxrng" runat="server" BackColor="LightBlue" autocomplete="off" MaxLength="5" onkeyup="cal()" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label20" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Cylinder(Inchs)</asp:Label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtfoil_trm" ReadOnly="true" runat="server" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label9" runat="server" Text="lbl3" autocomplete="off" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Gap(mm)</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtfoil1_trm" ReadOnly="true" runat="server" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label3" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Around(Labels)</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtinkgsm_trm" runat="server" ReadOnly="true" autocomplete="off" CssClass="form-control" Width="100%" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label8" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Across(Labels)</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtink_trm" runat="server" BackColor="LightBlue" onkeypress="return isDecimalKey(event)" autocomplete="off" onkeyup="cal()" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Label ID="Label21" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Step3</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstep3" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>

                                <asp:Label ID="Label29" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Step4</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstep4" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>

                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label31" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Step5</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstep5" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            ...
                            <table style="width: 100%">
                                <tr style="display: none;">
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl2" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl3" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                ...
                                <tr style="display: none;">
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl5" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl6" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl8" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl9" runat="server" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <%--<div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="Label13" runat="server" Text="lbl3" CssClass="col-sm-12 control-label" Font-Size="16px" Font-Bold="True"><b>(Costing Part)</b></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>--%>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label14" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Material</asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnC" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnC_ServerClick" />
                                </div>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtcode" runat="server" CssClass="form-control" ReadOnly="true" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtmatl" runat="server" CssClass="form-control" ReadOnly="true" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <%-- 
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtpaper_Film" runat="server" ReadOnly="true"  CssClass="form-control" Width="100%"  Height="28px"></asp:TextBox>
                                </div>  --%>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label38" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Ink_GSM</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtinkgsm" runat="server" BackColor="LightBlue" onkeyup="cal()" autocomplete="off" onkeypress="return isDecimalKey(event)" CssClass="form-control" Width="130px" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtink" runat="server"  ReadOnly="true" CssClass="form-control" Width="100%"  Height="28px"></asp:TextBox>
                                </div> --%>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtvarnish" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtvarnishname" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtvarnish_gsm" runat="server" BackColor="LightBlue" autocomplete="off" onkeyup="cal()" onkeypress="return isDecimalKey(event)" CssClass="form-control" Width="130px" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtfoil" ReadOnly="true" runat="server" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <asp:Label ID="Label51" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Process_Wastage%</asp:Label>
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtprocess_wstg" runat="server" BackColor="LightBlue" CssClass="form-control" onkeyup="cal()" autocomplete="off" onkeypress="return isDecimalKey(event)" Width="130px" MaxLength="5" Height="28px"></asp:TextBox>
                                    </div>
                                    <asp:Label ID="Label34" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Overheads_%</asp:Label>
                                    <div class="col-sm-2">
                                        <asp:TextBox ID="txtoverhentry" runat="server" BackColor="LightBlue" CssClass="form-control" onkeyup="cal()" autocomplete="off" onkeypress="return isDecimalKey(event)" Width="80px" MaxLength="5" Height="28px"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-7">
                                        <asp:TextBox ID="txtoverheads" onkeyup="cal()" autocomplete="off" onkeypress="return isDecimalKey(event)" runat="server" MaxLength="5" CssClass="form-control" Width="80px" Height="28px"></asp:TextBox>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label35" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Profit_%</asp:Label>
                                <div class="col-sm-2">
                                    <asp:TextBox ID="txtprofitentry" runat="server" BackColor="LightBlue" CssClass="form-control" onkeyup="cal()" autocomplete="off" onkeypress="return isDecimalKey(event)" Width="80px" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                                <div class="col-sm-7">
                                    <asp:TextBox ID="txtprofit" runat="server" autocomplete="off" onkeyup="cal()" onkeypress="return isDecimalKey(event)" CssClass="form-control" Width="80px" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label11" runat="server" Text="lbl3" CssClass="col-sm-12 control-label" Font-Size="14px" Font-Bold="True">Remarks (max 500 char)</asp:Label>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <asp:TextBox ID="txtRmk" runat="server" autocomplete="off" CssClass="form-control" TextMode="MultiLine" Height="150px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label15" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Paper/Film(Rate/sq.mtr)</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtpaper_Film" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label39" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Ink(Rate/sq.mtr)</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtink" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label42" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Varnish(Rate/Sq.mtr)</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtvarnish1" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label37" runat="server" Text="lbl3" autocomplete="off" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Foil_Value</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtfoil1" ReadOnly="true" runat="server" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label41" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">RM Cost</asp:Label>
                                <%-- Varnish+Papr+Ink+Foil--%>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txttot" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label49" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Wastage</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtwastge" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label40" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">O/H (Rate/Sq.mtr)</asp:Label>
                                <%--  O/H % --%>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtoh" ReadOnly="true" runat="server" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <%-- <div class="form-group">   
                                <asp:Label ID="Label36" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Foil</asp:Label>
                                <div class="col-sm-1">
                               <asp:ImageButton ID="btnFoil" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnFoil_Click" />
                                </div>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtvarnish1" runat="server" ReadOnly="true" CssClass="form-control" Width="100%"  Height="28px"></asp:TextBox>
                                </div>
                                --%>
                                <asp:Label ID="Label43" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Total Cost(Sq.mtr)</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txttotcost" ReadOnly="true" runat="server" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label44" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Profit(tot_cost*profit%)</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtprofit1" runat="server" autocomplete="off" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label45" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">SP/Sq Mtr</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtsp" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label46" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">SP/Sq Inch</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtsqinch" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label47" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Sq. Inch of Label</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtsq_inch_lbl" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label48" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Price_per_thousand</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtprice" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group" id="divLablePrice" runat="server">
                                <asp:Label ID="Label25" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Price_per_thousand_per_set</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtLablePrice" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label50" runat="server" Text="lbl3" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Price_per_Pcs</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtperpc" runat="server" ReadOnly="true" CssClass="form-control" Width="130px" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtwidth" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtheight" runat="server" ReadOnly="true" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6" style="display: none;">
                    <div>
                        <div class="box-body">
                            ...
                            <%--<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtprice" runat="server" ReadOnly="true" BackColor="LightBlue" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>    
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtwastge" runat="server" BackColor="LightBlue" ReadOnly="true"  CssClass="form-control" Width="100%" MaxLength="5" Height="28px"></asp:TextBox>
                                </div>   --%>
                        </div>
                        ...
                        <%--<div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtperpc" runat="server" ReadOnly="true" BackColor="LightBlue" CssClass="form-control" Width="100%" Height="28px"></asp:TextBox>
                                </div>--%>
                    </div>
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-2">
                            <asp:TextBox ID="TextBox14" runat="server" ReadOnly="true" CssClass="form-control" Width="50px" Height="28px"></asp:TextBox>
                        </div>
                        <div class="col-sm-2">
                            <asp:TextBox ID="TextBox15" runat="server" ReadOnly="true" CssClass="form-control" Width="60px" Height="28px"></asp:TextBox>
                        </div>
                    </div>
                                                ...
                                                <div class="box-body">
                                                    <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="col-sm-4">
                                                                    <asp:TextBox ID="txtlbl19" runat="server" Width="350px" Height="28px"></asp:TextBox>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            ...
            paper = fill_zero(document.getElementById("ContentPlaceHolder1_txtoh_trm").value); //paper size     
            width = fill_zero(document.getElementById("ContentPlaceHolder1_txtwidthmm").value);
            height = fill_zero(document.getElementById("ContentPlaceHolder1_txtvarnish_trm").value);
            acros = fill_zero(document.getElementById("ContentPlaceHolder1_txtink_trm").value);
            gap = fill_zero(document.getElementById("ContentPlaceHolder1_txtfoil1_trm").value);

            papaersize = ((height * acros) + ((acros - 1) * 3) + 15) / 10;
            t1 = 1000000 / ((papaersize * 1) * 10); //step 1         
            t2 = t1.toFixed(3) / ((width * 1) + (gap * 1));
            t3 = 1550 / (((width * 1) * (height * 1)) / 645);
            t4 = t3 / (acros * 1);
            t5 = t4 - t2;
            t6 = t5 / t4 * 100;
            document.getElementById('ContentPlaceHolder1_txtstep1').value = t1.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtstep2').value = t2.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtstep3').value = t3.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtstep4').value = t4.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtstep5').value = t5.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txttrmwastg').value = t6.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtoh_trm').value = papaersize.toFixed(3);

            ////////////LABEL COSTING

            var foil = 0; var film = 0; var trim_Wstg = 0; var procss_wstg = 0; wstg = 0; var overhead = 0; var oh = 0; var totcost = 0; var profit = 0; var profit1 = 0;
            var paper = 0; var mm = 0; var inkgsm = 0; var ink = 0; var varnish_gsm = 0; var varnish_used = 0; var varnish = 0; var tot = 0;
            var sp = 0; var sqinch = 0; var sqinch_lbl = 0; var price = 0; var pc = 0;
            //================for ink
            inkgsm = fill_zero(document.getElementById("ContentPlaceHolder1_txtinkgsm").value);
            ink = inkgsm * 1600 / 1000;
            document.getElementById('ContentPlaceHolder1_txtink').value = (ink * 1).toFixed(2);
            ///=================for varnish
            varnish_gsm = fill_zero(document.getElementById("ContentPlaceHolder1_txtvarnish_gsm").value);
            varnish_used = fill_zero(document.getElementById("ContentPlaceHolder1_txtvarnish").value);
            varnish = varnish_gsm * varnish_used / 1000;
            document.getElementById('ContentPlaceHolder1_txtvarnish1').value = (varnish * 1).toFixed(2);
            //====================for total
            foil = fill_zero(document.getElementById("ContentPlaceHolder1_txtfoil1").value);
            film = fill_zero(document.getElementById("ContentPlaceHolder1_txtpaper_Film").value);
            tot = (ink * 1).toFixed(2) + (varnish * 1).toFixed(2) + (foil * 1) + (film * 1);
            document.getElementById('ContentPlaceHolder1_txttot').value = (tot * 1).toFixed(2);

            //=============for wastage
            trim_Wstg = fill_zero(document.getElementById("ContentPlaceHolder1_txttrmwastg").value);
            procss_wstg = fill_zero(document.getElementById("ContentPlaceHolder1_txtprocess_wstg").value);
            wstg = ((tot * 1).toFixed(2) * ((trim_Wstg * 1) / 100) + (((tot * 1).toFixed(2) * ((trim_Wstg * 1) / 100)) + (tot * 1).toFixed(2)) * ((procss_wstg * 1) / 100));
            document.getElementById('ContentPlaceHolder1_txtwastge').value = (wstg * 1).toFixed(2);
            //=========for OH     
            overhead = fill_zero(document.getElementById("ContentPlaceHolder1_txtoverheads").value);
            oh = ((tot * 1).toFixed(2) * (overhead * 1) / 100);

            document.getElementById('ContentPlaceHolder1_txtoh').value = (oh * 1).toFixed(2);
            //for total cost
            totcost = (tot * 1).toFixed(2) + (wstg * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txttotcost').value = ((totcost * 1) + (oh * 1)).toFixed(2);

            var cost = 0, sales = 100;
            var overhead = 0, profit = 0;

            overhead = document.getElementById('ContentPlaceHolder1_txtoverhentry').value;
            profit = document.getElementById('ContentPlaceHolder1_txtprofitentry').value;

            cost = sales - overhead - profit;
            document.getElementById('ContentPlaceHolder1_txtoverheads').value = ((overhead * 100) / cost).toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtprofit').value = ((profit * 100) / cost).toFixed(3);



            //for profit 
            profit = fill_zero(document.getElementById("ContentPlaceHolder1_txtprofit").value);
            profit1 = ((totcost * 1).toFixed(2) * (profit * 1) / 100);
            totcost = (tot * 1).toFixed(2) + (wstg * 1).toFixed(2) + (oh * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtprofit1').value = (profit1 * 1).toFixed(2);

            //for sp
            sp = (totcost * 1).toFixed(2) + (profit1 * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtsp').value = (sp * 1).toFixed(2);
            //for sq inch 
            sqinch = ((sp * 1).toFixed(2) / 1550 * 100).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtsqinch').value = (sqinch * 1).toFixed(2);
            //for sq inch label
            width = fill_zero(document.getElementById("ContentPlaceHolder1_txtwidthmm").value);
            height = fill_zero(document.getElementById("ContentPlaceHolder1_txtvarnish_trm").value);
            sqinch_lbl = (((width * 1) * (height * 1)) / 645).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtsq_inch_lbl').value = (sqinch_lbl * 1).toFixed(2);
            ///for price per hundred
            /////for price        

            price = (sqinch_lbl * 1).toFixed(2) * (sqinch * 1).toFixed(2) * 10;
            document.getElementById('ContentPlaceHolder1_txtprice').value = (price * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtLablePrice').value = (price * 2).toFixed(2);
            //for price per pc
            pc = (price * 1).toFixed(5) / 1000;
            document.getElementById('ContentPlaceHolder1_txtperpc').value = (pc * 1).toFixed(5);
