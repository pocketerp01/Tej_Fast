<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_stl_log" CodeFile="om_stl_log.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">STL_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="STL No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">STL Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="STL Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Customer Code" maxlength="4" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Name/Title </label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Name/Title" maxlength="30" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Industry type</label>
                                <div class="col-sm-8">
                                    <select id="ddvertical" runat="server" class="form-control">
                            ...
                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">Scope/Purpose</label>
                                <div class="col-sm-8">
                                    <select id="ddpurpose" runat="server" class="form-control">
                                        <option value="Common Purpose">Common Purpose</option>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Brief Description " CssClass="col-sm-2 control-label"></asp:Label>

                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,200)" placeholder="Brief Description about this Training Library"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork1" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Pre Requisites :</label>
                            <asp:TextBox ID="txtWrkRmk" runat="server" Width="99%" TextMode="MultiLine" MaxLength="225" placeholder="Pre Requisites Reqd to Utilize this Training Library"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Utilized :</label>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label11" runat="server" Text="1.Please Mention Title of the Software Correctly." CssClass="col-sm-2 control-label"></asp:Label>
