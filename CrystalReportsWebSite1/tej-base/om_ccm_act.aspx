<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_ccm_act" CodeFile="om_ccm_act.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">CCM_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="CCM No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">CCM Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="CCM Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">Customer Name</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Customer Name" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Complaint Type</label>
                                <div class="col-sm-8">
                                    <input id="ddModule" runat="server" class="form-control" type="text" placeholder="Complaint Type" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Product</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Product" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Compl.Category</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl9" runat="server" class="form-control" type="text" placeholder="Compl.Category" readonly="readonly" />

                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">Occurance</label>
                                <div class="col-sm-8">
                                    <input id="ddIssueType" runat="server" class="form-control" placeholder="Occurance" type="text" readonly="readonly" />
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label17" runat="server" Text="Initial Remarks" CssClass="col-sm-2 control-label"></asp:Label>
                            <asp:TextBox ID="Text_cl_rmk" runat="server" Width="99%" TextMode="MultiLine" placeholder="Client Remarks" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-3 control-label" title="lbl1">Action_Status</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnActn" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnActn_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtActn" runat="server" class="form-control" type="text" placeholder="Action Status" />
                                </div>
                            </div>


<%--                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Analysis</label>
                                <div class="col-sm-8">
                                    <select id="ddAnalysis" runat="server" class="form-control">
                                        <option value="Under Analysis">Under Analysis</option>
                                        <option value="CAPA Done">CAPA Done</option>
                                        <option value="CLEAR CCM">Clear CCM</option>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">Next Action By</label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" placeholder="Input Req From" />
                                </div>
                            </div>
...
<%--                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Followup With</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-3 control-label" title="lbl1">Resp_Deptt</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btn_deptt" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btn_deptt_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtdeptt" runat="server" class="form-control" type="text" placeholder="Department Name" />
                                </div>
                            </div>
                            
                            
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Close in </label>
                                <div class="col-sm-8">
