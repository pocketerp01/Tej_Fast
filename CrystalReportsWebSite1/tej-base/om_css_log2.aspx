<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_css_log4" CodeFile="om_css_log2.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-6" id="divWork1" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Work Remarks :</label>
                            <asp:TextBox ID="txtWrkRmk" runat="server" Width="99%" TextMode="MultiLine" MaxLength="225" placeholder="Remarks "></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Work Completed :</label>
