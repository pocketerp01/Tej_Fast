...
public partial class om_dsl_log : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                doc_addl.Value = "1";
                lblheader.Text = "Developed Software Library";
    ...
    public void set_Val()
    {
        ...
        doc_df.Value = "DSLDT";
        Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
        frm_tabname = "WB_DSL_LOG";
        switch (Prg_Id)
        {
            case "F96101":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "SL");
                typePopup = "N";
                break;
        }
                ...
                try
                {
                    ...
                    else
                    {
                        if (save_it == "Y")
                        {
                            ...
                            fgen.msg("-", "AMSG", "DSL No " + frm_vnum + "'13'We appreciate your Entry to Finsys DSL.Aiming for Systematic Working");
                        }
                        else
                        {
    ...
    void Type_Sel_query()
    {
        ...
        {
            case "F96101":
                SQuery = "SELECT 'DS' AS FSTR,'Developed Software Logging' as NAME,'DS' AS CODE FROM dual";
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "SL");
                break;
