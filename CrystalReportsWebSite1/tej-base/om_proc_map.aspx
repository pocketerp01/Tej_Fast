<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_proc_map" CodeFile="om_proc_map.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl2" runat="server" CssClass="form-control" Height="28px" Width="100%"></asp:TextBox>
                                </div>

                                <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl3" runat="server" CssClass="form-control" Height="28px" Width="100%"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl5" runat="server" CssClass="form-control" Height="28px" Width="100%"></asp:TextBox>
                                </div>

                                <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" Height="28px" Width="100%"></asp:TextBox>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl8" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>
                                </div>

                                <asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" Width="150px"></asp:TextBox>
                                </div>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span style="font-size: small; color: orangered;">To Insert new row in between, Press Ctrl + I (when cursor / focused on setup time)
                                    </span>
                                </li>
                            </ul>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab">
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Height="300px" Width="100%" Font-Size="13px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' onkeydown="openBox(this);" onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t2</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' onkeydown="openBox(this);" onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                ...
                <div class="col-md-2">
                    <div>
                        <div class="box-body">
                            <asp:Button ID="btnPendItems" runat="server" Text="Pending Items" OnClick="btnPendItems_Click" CssClass="btn-success" Width="150px" />
                            <asp:Button ID="btnChkStgMap" runat="server" Text="Check Stage Mapping" OnClick="btnChkStgMap_Click" CssClass="btn-success" Width="150px" />
                            <asp:Button ID="btnChkDuplicate" runat="server" Text="Check" OnClick="btnChkDuplicate_Click" CssClass="btn-success" Width="150px" />
                        </div>
                    </div>
                </div>
                <div class="col-md-10">
    ...
    <asp:HiddenField ID="stag_pwise" runat="server" />
    <asp:HiddenField ID="proc_pwise" runat="server" />
