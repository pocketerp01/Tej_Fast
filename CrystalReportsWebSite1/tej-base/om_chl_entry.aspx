<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_chl_entry" CodeFile="om_chl_entry.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtvchdate" placeholder="Date" runat="server" Width="80px" CssClass="form-control" Height="28px"></asp:TextBox>
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddRejn" runat="server" Font-Size="Small" Height="27px" Width="120px">
                                                <asp:ListItem Text="Main" Value="Y"></asp:ListItem>
                                                <asp:ListItem Text="Rejn" Value="R"></asp:ListItem>
                                                <asp:ListItem Text="WIP" Value="W"></asp:ListItem>
                                                <asp:ListItem Text="Cust.Rejn" Value="C"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4" runat="server" Width="80px" ReadOnly="true" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4a" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl7a" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl70" runat="server" Width="80px" ReadOnly="true" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl71" runat="server" Width="350px" ReadOnly="true" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl2" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl3" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl5" runat="server" Text="lbl5" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl5" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl8" runat="server" Text="lbl8" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl8" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl9" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="Label1" runat="server" Text="Our_State" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl72" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="Label2" runat="server" Text="Cust_State" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl73" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <button type="submit" id="btnRead" class="btn-info" style="width: 90px; margin-left: 5px; margin-top: 3px;" runat="server" onserverclick="btnRead_ServerClick">Read Data</button>
                                </li>
                                <li>
                                    <button type="submit" id="btnRcv" class="btn-info" style="width: 90px; margin-left: 60px; margin-top: 3px;" runat="server" onserverclick="btnRcv_ServerClick">Rcv Mat</button>
                                </li>
                                <li>
                                    <button type="submit" id="btnPost" class="btn-success" style="width: 90px; margin-left: 60px; margin-top: 3px;" runat="server" onserverclick="btnPost_ServerClick">Post Reels</button>
                                </li>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab1">
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="100%" Height="200px" Font-Size="12px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnadd" runat="server" CommandName="SG1_ROW_ADD" ImageAlign="Top" ImageUrl="~/tej-base/images/Btn_addn.png" Width="20px" ToolTip="Insert Item" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Del</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnrmv" runat="server" CommandName="SG1_RMV" ImageUrl="~/tej-base/images/Btn_remn.png" Width="20px" ImageAlign="Top" ToolTip="Remove Item" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btndt" runat="server" CommandName="SG1_ROW_DT" ImageAlign="Top" ImageUrl="~/tej-base/images/Btn_addn.png" Width="20px" ToolTip="Rate history" />
                                    ...
                                    <div class="lbBody" id="gridDiv1" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg3" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg3_srno" HeaderText="Srno" HeaderStyle-Width="40px" />
                                                <asp:BoundField DataField="sg3_f1" HeaderText="ERP_Code" ItemStyle-Width="80px" HeaderStyle-Width="80px" />
                                                <asp:BoundField DataField="sg3_f2" HeaderText="Item_Name" ItemStyle-Width="220px" HeaderStyle-Width="220px" />
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl15" runat="server" Width="350px" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl16" runat="server" Width="350px" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl17" runat="server" Width="350px" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl18" runat="server" Width="350px" CssClass="form-control" Height="28px"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl24" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl25" runat="server" Text="lbl25" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl25" runat="server" Style="text-align: right" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl26" runat="server" Text="lbl26" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl26" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl27" runat="server" Text="lbl27" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl27" runat="server" Style="text-align: right" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl28" runat="server" Text="lbl28" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl28" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl29" runat="server" Text="lbl29" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl29" runat="server" Style="text-align: right" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl30" runat="server" Text="lbl30" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl30" runat="server" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                            <asp:Label ID="lbl31" runat="server" Text="lbl31" CssClass="col-sm-2 control-label"></asp:Label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtlbl31" runat="server" Style="text-align: right" CssClass="form-control" Height="28px"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <asp:HiddenField ID="print_type" runat="server" />
    <script type="text/javascript">
        $(function () {
