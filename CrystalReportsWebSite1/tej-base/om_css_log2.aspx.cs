...
public partial class om_css_log4 : System.Web.UI.Page
{
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            SQuery = "SELECT A.CSSNO AS CSS_NO,TO_cHAR(A.CSSDT,'DD/MM/YYYY') AS CSS_dT,A.CCODE AS COMPANY,A.EMODULE,A.CONT_NAME,A.CONT_NO,a.remarks FROM " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type='" + frm_vty + "' and a.cssdt " + PrdRange + " order by a.cssno ";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
