...
public partial class om_prt_hrm : System.Web.UI.Page
{
            ...
            else
            {
                ...
                { //need icon for this on test
                    case "F40145":
                        ...
                        fgenMV.Fn_Set_Mvar(frm_qstr, "REPID", "F40145");
                    ...
                    case "F40140":
                        if (hfval.Value == "")
                        {
                            ...
                            SQuery = "select trim(branchcd)||trim(type)||trim(vchnum)||to_char(vchdate,'DD/MM/YYYY') AS FSTR,VCHNUM AS DOCUMENT,TO_CHAR(vchdate,'dd/mm/yyyy') as dated,ponum,podate  from ivoucher where branchcd='" + mbr + "' and type='" + hfval.Value + "' and vchdate " + xprdrange + " order by vchnum desc";
                            fgenMV.Fn_Set_Mvar(frm_qstr, "U_XID", "Tejaxo");
                            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
                            fgen.Fn_open_sseek(header_n, frm_qstr);
                        }
        ...
        //if (fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL1").Length > 0 || fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL2").Length > 0 || fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL3").Length > 0)
        {
            ...
            switch (val)
            {
                case "F20132":
                    ...
                    fgenMV.Fn_Set_Mvar(frm_qstr, "REPID", "F20132");
                    fgen.fin_gate_reps(frm_qstr);
                    break;

                case "F20133":
                    // Gate Outward Register
                    fgenMV.Fn_Set_Mvar(frm_qstr, "REPID", "F20133");
                    fgen.fin_gate_reps(frm_qstr);
                    break;
