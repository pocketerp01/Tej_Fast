<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_gate_inw" CodeFile="om_gate_inw.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function openBox(tk) {
            if (event.keyCode == 13) {
                if (document.getElementById('ContentPlaceHolder1_txtlbl4').value == "RG") {
        ...
        function jsonSaveFun() {
            ...
            for (var i = 0; i < gridCount; i++) {
                ...
                JCInfo["vchdate"] = $('#ContentPlaceHolder1_txtvchdate').val();

                JCInfo["acode"] = $('#ContentPlaceHolder1_txtlbl7').val();
                JCInfo["sg1_f1"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[13].innerHTML;
                JCInfo["icode"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[13].innerHTML;
                JCInfo["sg1_f2"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[14].innerHTML;
                JCInfo["sg1_f3"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[15].innerHTML;
                JCInfo["sg1_f4"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[16].innerHTML;
                JCInfo["sg1_f5"] = document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[17].innerHTML;

                JCInfo["sg1_t1"] = $('#ContentPlaceHolder1_sg1_sg1_t1_' + i).val();
                JCInfo["sg1_t2"] = $('#ContentPlaceHolder1_sg1_sg1_t2_' + i).val();
                JCInfo["sg1_t3"] = $('#ContentPlaceHolder1_sg1_sg1_t3_' + i).val();
                JCInfo["sg1_t4"] = $('#ContentPlaceHolder1_sg1_sg1_t4_' + i).val();
                JCInfo["sg1_t5"] = $('#ContentPlaceHolder1_sg1_sg1_t5_' + i).val();
                JCInfo["sg1_t6"] = $('#ContentPlaceHolder1_sg1_sg1_t6_' + i).val();
                JCInfo["sg1_t7"] = $('#ContentPlaceHolder1_sg1_sg1_t7_' + i).val();

                jcList[i] = JCInfo;
            }
            //PageMethods.backendSaveFun(jcList, OnSuccess);
            var scUrl = "om_gate_inw.aspx/backendSaveFun";
            scUrl = "../tej-base/jcpSave.asmx/saveGE?STR=" + qstr + "";
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: left">
                        ...
                        <input type="button" id="btncheck" value="CheckJC" onclick="jsonSaveFun();" style="display: none" />                        
                    </td>
                      <td>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Driver_Name" CssClass="col-sm-2 control-label"></asp:Label>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:Button ID="btnConvsheetToWt" runat="server" Text="Nos to Kgs" OnClick="btnConvsheetToWt_Click" />
                                        </div>
                                    </td>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <asp:Button ID="Button1" runat="server" CssClass="bg-green btn-foursquare" Text="Pending PO" Style="margin-left: 30px;" OnClick="Button1_Click" />
                                </li>
                                <li>
                                    <asp:Button ID="Button2" runat="server" CssClass="bg-green btn-foursquare" Text="Pending RGP" Style="margin-left: 5px;" OnClick="Button2_Click" />
                                </li>
                                <li>
                                    <asp:Button ID="Button3" runat="server" CssClass="bg-green btn-foursquare" Text="Pending MRN" Style="margin-left: 5px;" OnClick="Button3_Click" />
                                </li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' onkeypress="return isDecimalKey(event)" Height="100%" Style="text-align: right" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' onkeypress="openBox(this);return isDecimalKey(event); " Height="100%" Style="text-align: right" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" Height="100%" Style="text-align: right" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t4</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' onkeypress="return isDecimalKey(event)" Height="100%" Style="text-align: right" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' onkeypress="return isDecimalKey(event)" Height="100%" Style="text-align: right" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t6</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Height="100%" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t7</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' Height="100%" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t8</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' onkeypress="return isDecimalKey(event)" Height="100%" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onkeypress="return isDecimalKey(event)" Height="100%" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,150)" placeholder="Remarks"></asp:TextBox>
                        </div>
                    </div>
                </div>
