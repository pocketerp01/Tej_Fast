<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_multi_Sch_Upl" CodeFile="om_multi_saleSch_Upl.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align:right;">
                        ...
                        <button type="submit" id="btnhelp" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnhelp_ServerClick">For<u>m</u>at</button>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                 <asp:Label ID="Label2" Font-Size="small" runat="server" Text="Entry No" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtvchnum" placeholder="Vchnum" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>
                                 <asp:Label ID="lbl1" runat="server" Text="EntryDate" CssClass="col-sm-2 control-label"></asp:Label>
                                 <div class="col-sm-4">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:Label ID="Label9" Font-Size="small" runat="server" Text="Customer" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-1" id="divCocd" runat="server">
                                    <asp:ImageButton ID="btnAcode"  runat="server" ToolTip="Select Party Code" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnAcode_Click"  />
                                </div>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtacode" placeholder="Party Code" runat="server" Width="100px" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                    
                                </div>
                                <div class="col-sm-6">

                                    <input id="txtAname" type="text" readonly="true" class="form-control" runat="server"  placeholder="Party Name" maxlength="4" />
                                </div>
                            </div>
                            <div class="form-group">
                                  <div class="col-sm-4">
                                    <asp:TextBox ID="TextBox1" runat="server" Width="80px" Height="32px" ReadOnly="true" Visible="false"></asp:TextBox>
                                </div>
                            </div>
                  ...
                  <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                            <asp:FileUpload ID="FileUpload1" runat="server" Width="250px" onchange="submitFile()" ToolTip="Choose Excel file in(.xls) format" />
                            <asp:Button ID="btnupload" runat="server" Text="Upload" class="myButton" Style="display: none" OnClick="btnupload_Click" />
                ...
                <section class="col-lg-12 connectedSortable">
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="DescTab">
                                    <div class="lbBody" style="box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <%--testing--%>
                                        <div id="datadiv" style="overflow: scroll; width: auto; height: 350px;" runat="server" class="handsontable"
                            ...
                            ToolTip="Export to Excel" Width="50px" Height="30px" OnClick="btnexptoexl_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
