<%@ Page Language="C#" AutoEventWireup="true" Inherits="logoUpload" CodeFile="logoUpload.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div class="mid-signin" style="padding-top: 50px">
            <input id="txtConfirmOtp" runat="server" class="signin-textfield"
                placeholder="Confirm Company Code" autocomplete="off" />

            <div style="padding-top: 10px; padding-bottom: 10px;">
                <asp:Label ID="lblerr" runat="server" Style="font-size: 13px; font-family: Arial; text-decoration: none;" Text="Please Upload Logo File(jpg)!!"></asp:Label>
            </div>
