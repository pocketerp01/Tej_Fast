<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_Web_Rpt_KLAS_QA" Title="Tejaxo" CodeFile="om_Web_Rpt_KLAS_QA.aspx.cs" %>
     ...
     <div class="content-wrapper">
        <section class="content-header">
            <table style="width: 100%">
                <tr>                    
                    <td>
                          <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Size="X-Large">Web Reports (Quality Inspection)</asp:Label>                      
                    </td>
                </tr>
            </table>
        </section>
