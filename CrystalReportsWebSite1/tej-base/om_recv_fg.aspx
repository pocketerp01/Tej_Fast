<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_recv_fg" CodeFile="om_recv_fg.aspx.cs" %>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl4" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl4_Click" Visible="false" /></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4" runat="server" Width="80px" ReadOnly="true" MaxLength="20"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4a" runat="server" Width="350px" ReadOnly="true" MaxLength="150"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl7" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl7_Click" Visible="false" /></td>
                                    <td>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Std.Packing" ItemStyle-Width="80px" />
                                                <asp:BoundField DataField="sg1_f3" HeaderText="Code" />
                                                <asp:BoundField DataField="sg1_f4" HeaderText="JobNo." />


                                                <asp:TemplateField ItemStyle-Width="80px">
                                                    <HeaderTemplate>ItemName</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="80px">
                                                    <HeaderTemplate>ItemCode</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="110px">
                                                    <HeaderTemplate>Produced</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' Width="100%" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Width="110px">
                                                    <HeaderTemplate>IntoStk</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' onkeypress="return isDecimalKey(event)" Width="100%" MaxLength="70"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>-</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Width="100%" MaxLength="7"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Width="80px">
                                                    <HeaderTemplate>-</HeaderTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="150px">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' Width="100%" onkeyup="calrejection()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="150px">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' Width="100%" onkeyup="calrejection()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t10" runat="server" Text='<%#Eval("sg1_t10") %>' Width="100%" onkeyup="calrejection()" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%-- <asp:TemplateField ItemStyle-Width="80px">
                                               ...
                                               <asp:TemplateField ItemStyle-Width="80px">
                                                ...
                                                <%--<asp:TemplateField ItemStyle-Width="80px">
                                                  ...
                                                  <asp:TemplateField ItemStyle-Width="80px">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t20" runat="server" Text='<%#Eval("sg1_t20") %>' Width="100%" onblur="calrejection(this.value);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
