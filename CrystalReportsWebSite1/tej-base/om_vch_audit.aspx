<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_vch_audit" CodeFile="om_vch_audit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function checkMyVal() {
            ...
            var totDrAmt = 0, totCrAmt = 0;
            for (var i = 0; i < gridCount; i++) {
                var rowI = 0;
                if (i == 0) rowI = 0;
                else rowI = i * 2;
                debugger;
                if ((document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value * 1) > 0) document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).readOnly = true;
                else document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).readOnly = false;

                if ((document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value * 1) > 0) document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).readOnly = true;
                else document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).readOnly = false;

                totDrAmt += fill_zero((document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value * 1));
                totCrAmt += fill_zero((document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value * 1));
            }

            document.getElementById('ContentPlaceHolder1_txtTotDr').value = totDrAmt.toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtTotCr').value = totCrAmt.toFixed(2);

            document.getElementById('ContentPlaceHolder1_txtDiff').value = fill_zero(totDrAmt - totCrAmt).toFixed(2);
        }
        function closePopup() {
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl1" runat="server" Text="Doc.No" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl2" runat="server" Text="Entered_By" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl3" runat="server" Text="Entered_Date" CssClass="col-sm-2 control-label"></asp:Label>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Voucher Entries</a></li>
                                ...
                                <li style="float: right">Reverse Code is Required for Account Reference in Reports&nbsp;&nbsp;&nbsp;
                                </li>
                            </ul>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnadd" runat="server" CommandName="SG1_ROW_ADD" ImageAlign="Middle" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ToolTip="Select Account" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="sg1_srno" HeaderText="Srno" HeaderStyle-Width="30px" />
                                                <asp:BoundField DataField="sg1_f1" HeaderText="Voucher Type" HeaderStyle-Width="120px" />
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Voucher Type Name" HeaderStyle-Width="250px" />
                                                <asp:BoundField DataField="sg1_f3" HeaderText="sg1_f3" Visible="false" />
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>Inv</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnrcd" runat="server" CommandName="SG1_ROW_ADD2" ImageAlign="Middle" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ToolTip="Select Rev.Account" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Voucher Audit Start Date</HeaderTemplate>
                                                    <HeaderStyle Width="200px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' TextMode="Date" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Voucher Audit End Date</HeaderTemplate>
                                                    <HeaderStyle Width="200px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' TextMode="Date" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>Inv</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btninv" runat="server" CommandName="SG1_ROW_INV" ImageAlign="Middle" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ToolTip="Select Account" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:CalendarExtender ID="sg1_t4_CalendarExtender" runat="server"
                                                            Enabled="True" TargetControlID="sg1_t4"
                                                            Format="dd/MM/yyyy">
                                                        </asp:CalendarExtender>
                                                        <asp:MaskedEditExtender ID="Maskedit1sg1_t4" runat="server" Mask="99/99/9999"
                                                            MaskType="Date" TargetControlID="sg1_t4" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' Width="100%" onkeydown="openBox(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>sg1_t10</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t10" runat="server" Text='<%#Eval("sg1_t10") %>' Width="100%" onkeydown="openBox(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group" style="display: none">
                                <div class="col-sm-2">
                                    Indenter_Reference
                                <asp:TextBox ID="txtIndRef" runat="server"></asp:TextBox>
                                </div>

                                <asp:Label ID="Label1" runat="server" Text="Total Dr Amt" CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:TextBox ID="txtTotDr" runat="server" placeholder="Total Dr Amt" CssClass="form-control" Style="text-align: right" ReadOnly="true" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label2" runat="server" Text="Total Cr Amt" CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:TextBox ID="txtTotCr" runat="server" placeholder="Total Cr Amt" CssClass="form-control" Style="text-align: right" ReadOnly="true" Height="28px"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label3" runat="server" Text="difference" CssClass="col-sm-1 control-label"></asp:Label>
                                <div class="col-sm-1">
                                    <asp:TextBox ID="txtDiff" runat="server" placeholder="difference" CssClass="form-control" Style="text-align: right" ReadOnly="true" Height="28px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
