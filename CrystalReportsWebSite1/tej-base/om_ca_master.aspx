<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_ca_master" CodeFile="om_ca_master.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Opt_No" runat="server" class="col-sm-4 control-label" title="lbl1">Opt_No</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">Label1</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl1" type="text" class="form-control" runat="server" maxlength="70"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Label2</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control"  runat="server" placeholder=" " maxlength="10" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Label3</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server"  placeholder=" " maxlength="6" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Label4</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="" maxlength="15"/>
                                </div>
                            </div>                            
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">                            
                            <div class="form-group">
                                <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Label5</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="" maxlength="15" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Label6</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl6" type="text" class="form-control" runat="server" placeholder="" />
                                </div>
                            </div>

                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Label7</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl7" type="text" class="form-control" runat="server" placeholder="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">Label8</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">Label9</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl9" type="text" class="form-control" runat="server" placeholder="" maxlength="15"/>
                                </div>
                            </div>
