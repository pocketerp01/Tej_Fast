<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="frmMProd" CodeFile="frmMProd.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function calculateSum($element) {
            ...
            document.getElementById('ContentPlaceHolder1_txtTargetShot').value = fill_zero((shotsperhr * wrkperhr).toFixed());
            ...
            grid1 = document.getElementById("<%= sg1.ClientID%>");
            for (var i = 0; i < grid1.rows.length - 1; i++) {
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <label>Shift</label>
                                        <asp:ImageButton ID="btnshift" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;"
                                            ToolTip="Select Shift" OnClick="btnshift_Click" />
                                    </td>
                                    <td colspan="5">
                                ...
                                <tr>
                                    <td>
                                        <label>Stage</label>
                                        <asp:ImageButton ID="btnstage" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;"
                                            ToolTip="Select Stage" OnClick="btnstage_Click" />
                                    </td>
                                    <td colspan="5">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:ImageButton ID="btnicode" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;"
                                            ToolTip="Select Product" OnClick="btnicode_Click" />
                                    </td>
                                    <td colspan="5">
                                ...
                                <tr>
                                    <td>
                                        <label>Time In/Out (24 hr format)</label>
                                    </td>
                                    <td>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        ...
                                        <asp:ImageButton ID="btnoperator" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;"
                                            ToolTip="Select Operator" OnClick="btnoperator_Click" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtActualCavity" runat="server" Width="50%" placeholder="Acutal Cavity" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false"></asp:TextBox>
                                    </td>
                                    <td>
                                        <label>Run Cavity</label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtRunCavity" runat="server" Width="50%" placeholder="Run Cavity" onkeyup="calculateSum();" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label>Shots/Hrs</label>
                                    </td>
                                    <td>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content no-padding">
                            <div class="chart tab-pane active" id="DescTab" style="position: relative; height: 160px;">
                                <div class="lbBody" style="color: White; max-height: 150px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                    <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                        Style="background-color: #FFFFFF; color: White;" Width="1285px" Font-Size="Smaller"
                                    ...
                                    <asp:GridView ID="sg2" Width="100%" runat="server" ForeColor="#333333"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="tkObsv1" runat="server" Width="250px" Text='<%#Eval("Obsv1") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" MaxLength="3"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                        <EditRowStyle BackColor="#999999" />
