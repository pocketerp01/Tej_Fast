...
public partial class om_pur_budg : System.Web.UI.Page
{
    ...
    public void set_Val()
    {
        ...
        fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "PB");
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (col1 == "") return;
                    clearctrl();
                    SQuery = "Select a.*,b.iname,b.cpartno,b.cdrgno,b.unit,to_chaR(a.ent_dt,'dd/mm/yyyy') as pent_Dt from " + frm_tabname + " a,item b where trim(a.icode)=trim(b.icode) and a.branchcd||a.type||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')='" + frm_mbr + frm_vty + col1 + "' ORDER BY A.SRNO";
                ...
                case "SG1_ROW_ADD":
                    ...
                    if (ViewState["sg1"] != null)
                    {
                        ...
                        for (int d = 0; d < dt.Rows.Count; d++)
                        {
                            ...
                            sg1_dr["sg1_h3"] = dt.Rows[d]["cpartno"].ToString().Trim();
                            sg1_dr["sg1_h4"] = dt.Rows[d]["cdrgno"].ToString().Trim();
                            sg1_dr["sg1_h5"] = dt.Rows[d]["unit"].ToString().Trim();
                            sg1_dr["sg1_h6"] = "-";
                            sg1_dr["sg1_h7"] = "-";
                            sg1_dr["sg1_h8"] = "-";
                            sg1_dr["sg1_h9"] = "-";
