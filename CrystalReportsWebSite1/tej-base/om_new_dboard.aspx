<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_new_dboard" CodeFile="om_new_dboard.aspx.cs" %>
                ...
                <section class="col-lg-6" id="chartDiv1" runat="server">
                    <div class="box box-success rounded_corners">
                        ...
                        <div class="no-padding">
                            <div class="box-body" id="chart1" style="height: 500px; ">
                            </div>
                        </div>
                    </div>
                </section>
