...
public partial class om_forms : System.Web.UI.Page
{
    ...
    public void set_Val()
    {
        ...
        switch (Prg_Id)
        {
            ...
            case "F99116":
                ...
                break;
            case "F99110":
                frm_tabname = "DBD_TV_CONFIG";
                break;
            case "F99112":
                frm_tabname = "DBD_MW_CONFIG";
                break;
            case "F99117":
                frm_tabname = "OPT_CONFIG";
                break;
            case "F99121":
                frm_tabname = "PRT_CONFIG";
                break;
            case "F99122":
                frm_tabname = "DSK_CONFIG";
                break;
        }
        Type_Sel_query();
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "TACODE":
                //pop1
                if (frm_tabname.ToUpper() == "DBD_TV_CONFIG")
                {
                    //''''01:Mldg/02:ShMetal/03:Casting/04:Forging/05:Prt/06:Corr/07:Paint/08:Pharma/09:Food/10:Capg
                    SQuery = "SELECT '01' as fsrt,'Moulding' as BVertical,'01' as Code from dual union all SELECT '02' as fsrt,'Sheet Metal' as BVertical,'02' as Code from dual union all SELECT '03' as fsrt,'Casting' as BVertical,'03' as Code from dual union all SELECT '04' as fsrt,'Forging' as BVertical,'04' as Code from dual union all SELECT '05' as fsrt,'Print/Packaging' as BVertical,'05' as Code from dual union all SELECT '06' as fsrt,'Corrugation' as BVertical,'06' as Code from dual union all SELECT '07' as fsrt,'Paint/Chemical' as BVertical,'07' as Code from dual union all SELECT '08' as fsrt,'Pharma' as BVertical,'08' as Code from dual union all SELECT '09' as fsrt,'Food' as BVertical,'09' as Code from dual union all SELECT '10' as fsrt,'Capital Goods' as BVertical,'10' as Code from dual";
                }
                else
                {
                    SQuery = "SELECT ID,TEXT,ID AS CODE FROM FIN_MSYS WHERE NVL(trim(WEB_ACTION),'-')!='-' and trim(id) not in (select trim(frm_name) from " + frm_tabname + " ) order by id ";
                }
                if (frm_tabname.ToUpper() == "DBD_MW_CONFIG")
                {
                    SQuery = "SELECT ID,TEXT,ID AS CODE FROM FIN_MSYS WHERE mlevel=1 and trim(id) not in (select trim(frm_name) from " + frm_tabname + " ) order by id ";
                }
                break;
            case "TICODE":
            ...
            default:
                ...
                {
                    if (frm_tabname.ToUpper() == "DBD_TV_CONFIG") SQuery = "select distinct trim(A.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy') as fstr,a.vchnum as entry_no,to_char(a.vchdate,'dd/mm/yyyy') as entry_Dt,a.Frm_Title,a.ent_by,to_char(a.ent_Dt,'dd/mm/yyyy') as ent_dt,to_Char(a.vchdate,'yyyymmdd') as vdd,'-' as Frm_id from " + frm_tabname + " a where a.type='" + frm_vty + "' order by vdd desc,a.vchnum desc";
                    else SQuery = "select distinct trim(A.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')||trim(a.frm_name) as fstr,a.vchnum as entry_no,to_char(a.vchdate,'dd/mm/yyyy') as entry_Dt,a.Frm_Title,a.ent_by,to_char(a.ent_Dt,'dd/mm/yyyy') as ent_dt,to_Char(a.vchdate,'yyyymmdd') as vdd,a.frm_name as Frm_id from " + frm_tabname + " a where a.type='" + frm_vty + "' order by vdd desc,a.vchnum desc";
                }
                break;
        }
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "COPY_OLD":
                    ...
                    if (col1 == "") return;
                    clearctrl();
                    SQuery = "Select a.*,b.text from " + frm_tabname + " a left outer join FIN_MSYS b on trim(a.frm_name)=trim(b.id) where a.branchcd||a.type||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')||a.frm_name='" + frm_mbr + frm_vty + col1 + "' ORDER BY A.SRNO";
                    dt = new DataTable();
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Prg_Id == "F99111")
                        {
                            ...
                            txtrmk.Text = dt.Rows[i]["join_cond"].ToString().Trim();
                        }
                        if (Prg_Id == "F99121")
                        {
                        ...
                        for (i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (frm_tabname.ToUpper() == "SYS_CONFIG")
                            {
                                ...
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_fmand"].ToString().Trim();
                                sg1_dr["sg1_t9"] = dt.Rows[i]["OBJ_CAPTION_REG"].ToString().Trim();
                            }

                            if (frm_tabname.ToUpper() == "DBD_CONFIG")
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_SQL"].ToString().Trim().ToUpper();
                            }

                            if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname.ToUpper() == "DBD_MW_CONFIG")
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_SQL"].ToString().Trim().ToUpper();
                            }

                            if (frm_tabname.ToUpper() == "DSK_CONFIG")
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_SQL"].ToString().Trim().ToUpper();
                            }
                ...
                case "Edit_E":
                    ...
                    if (col1 == "") return;
                    clearctrl();
                    if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname.ToUpper() == "DSK_CONFIG")
                    {
                        //''''01:Mldg/02:ShMetal/03:Casting/04:Forging/05:Prt/06:Corr/07:Paint/08:Pharma/09:Food/10:Capg
                        SQuery = "Select a.* from " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')='" + frm_vty + col1 + "' ORDER BY A.SRNO";
                    }
                    else
                    {
                        //SQuery = "Select a.*,b.text from " + frm_tabname + " a,FIN_MSYS b where a.branchcd='" + frm_mbr + "' and trim(a.frm_name)=trim(b.id) and a.type||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')='" + frm_vty + col1 + "' ORDER BY A.SRNO";
                        SQuery = "Select a.* from " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type||trim(a.vchnum)||to_Char(a.vchdate,'dd/mm/yyyy')||trim(a.frm_name)='" + frm_vty + col1 + "' ORDER BY A.SRNO";
                    }
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl4.Text = dt.Rows[i]["frm_name"].ToString().Trim();
                        if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname == "DSK_CONFIG")
                        {
                            txtlbl4a.Text = "-";
                        }
                        else
                        {
                            txtlbl4a.Text = dt.Rows[i]["FRM_title"].ToString().Trim();
                        }
                        txtlbl7a.Text = dt.Rows[0]["ent_by"].ToString().Trim();
                        if (Prg_Id == "F99111")
                        {
                        ...
                        for (i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            {
                                sg1_dr["sg1_h2"] = dt.Rows[i]["frm_name"].ToString().Trim();
                            }
                            ...
                            {
                                sg1_dr["sg1_f2"] = dt.Rows[i]["frm_name"].ToString().Trim();
                            }
                            ...
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_SQL"].ToString().Trim();
                            }
                            if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname.ToUpper() == "DBD_MW_CONFIG")
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                            ...
                            if (frm_tabname.ToUpper() == "DSK_CONFIG")
                            {
                                sg1_dr["sg1_t7"] = dt.Rows[i]["OBJ_READONLY"].ToString().Trim();
                                sg1_dr["sg1_t8"] = dt.Rows[i]["obj_SQL"].ToString().Trim();
                                sg1_dr["sg1_t9"] = dt.Rows[i]["obj_SQL2"].ToString().Trim();
                            }
                ...
                case "REFRESH":
                    if (fgenMV.Fn_Get_Mvar(frm_qstr, "U_CONFIRM") == "2")
                    {
                        ...
                        using (Oracle.ManagedDataAccess.Client.OracleConnection con1 = new Oracle.ManagedDataAccess.Client.OracleConnection(ConnInfo.connStringSys("SYSTEM", "LEADER", cssIP, "XE")))
                        {
                            Oracle.ManagedDataAccess.Client.OracleDataAdapter adp = new Oracle.ManagedDataAccess.Client.OracleDataAdapter("SELECT * FROM FINTEST." + frm_tabname + "", con1);
                            adp.Fill(dtNet4);
                        }
        ...
        else
        {
            ...
            if (col1 == "Y" && Checked_ok == "Y")
            {
                try
                {
                    ...
                    if (edmode.Value == "Y")
                    {
                        cmd_query = "update " + frm_tabname + " set branchcd='DD' where branchcd||type||trim(" + doc_nf.Value + ")||to_char(" + doc_df.Value + ",'dd/mm/yyyy')||frm_name='" + frm_mbr + frm_vty + fgenMV.Fn_Get_Mvar(frm_qstr, "U_FSTR") + "'";
                        if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname.ToUpper() == "DSK_CONFIG")
                    ...
                    if (edmode.Value == "Y")
                    {
                        ...
                        cmd_query = "delete from " + frm_tabname + " where branchcd||type||trim(" + doc_nf.Value + ")||to_char(" + doc_df.Value + ",'dd/mm/yyyy')||frm_name='DD" + frm_vty + fgenMV.Fn_Get_Mvar(frm_qstr, "U_FSTR") + "'";
                        if (frm_tabname.ToUpper() == "DBD_TV_CONFIG" || frm_tabname.ToUpper() == "DSK_CONFIG")
    ...
    void save_fun()
    {
        ...
        for (i = 0; i < sg1.Rows.Count - 0; i++)
        {
            if (sg1.Rows[i].Cells[13].Text.Length >= 2)
            {
                ...
                oporow["FRM_NAME"] = txtlbl4.Text;
                oporow["FRM_title"] = txtlbl4a.Text;
                oporow["FRM_header"] = txtlbl2.Text;
                oporow["OBJ_NAME"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t1")).Text;
                oporow["OBJ_CAPTION"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text;
                oporow["OBJ_WIDTH"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t3")).Text);
                oporow["OBJ_VISIBLE"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t4")).Text;
                oporow["col_no"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t5")).Text);
                oporow["obj_maxlen"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t6")).Text);

                if (frm_tabname.ToUpper() == "SYS_CONFIG")
                {
                    oporow["OBJ_READONLY"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t7")).Text;
                    oporow["obj_fmand"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t8")).Text;
                    oporow["OBJ_CAPTION_REG"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t9")).Text;
                }

                if (frm_tabname.ToUpper() == "DBD_CONFIG")
                {
                    oporow["OBJ_READONLY"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t7")).Text;
                    oporow["obj_SQL"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t8")).Text;
                }
                if (((TextBox)sg1.Rows[i].FindControl("sg1_t7")).Text.ToUpper().Trim() == "Y") oporow["OBJ_READONLY"] = "Y";
                else oporow["OBJ_READONLY"] = "N";
                ...
                if (frm_tabname.ToUpper() == "DSK_CONFIG")
                {
                    oporow["OBJ_READONLY"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t7")).Text;
                    oporow["obj_SQL"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t8")).Text;
                    oporow["obj_SQL2"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t9")).Text;
                }

                oporow["eNt_id"] = txtlbl7.Text;
                if (edmode.Value == "Y")
                {
    ...
    void Type_Sel_query()
    {
        ...
        switch (Prg_Id)
        {
            case "F99101":
                ...
                SQuery = "SELECT '10' AS FSTR,'Forms Configuration' as NAME,'10' AS CODE FROM dual";
                break;
            case "F99106":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "40");
                SQuery = "SELECT '40' AS FSTR,'UDFs Configuration' as NAME,'40' AS CODE FROM dual";
                break;
            case "F99111":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "20");
                SQuery = "SELECT '20' AS FSTR,'Reps Configuration' as NAME,'20' AS CODE FROM dual";
                break;
            case "F99116":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "50");
                SQuery = "SELECT '50' AS FSTR,'Dash Configuration' as NAME,'50' AS CODE FROM dual";
                break;
            case "F99121":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "30");
                SQuery = "SELECT '30' AS FSTR,'Prints Configuration' as NAME,'30' AS CODE FROM dual";
                break;
            case "F99110":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "60");
                SQuery = "SELECT '60' AS FSTR,'Display Dash Configuration' as NAME,'60' AS CODE FROM dual";
                break;
            case "F99112":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "70");
                SQuery = "SELECT '50' AS FSTR,'Module Dbd Configuration' as NAME,'50' AS CODE FROM dual";
                break;
            case "F99122":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "80");
                SQuery = "SELECT '80' AS FSTR,'Desktop Configuration' as NAME,'80' AS CODE FROM dual";
                break;
