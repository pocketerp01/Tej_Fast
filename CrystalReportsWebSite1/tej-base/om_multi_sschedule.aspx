<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_multi_sschedule" CodeFile="om_multi_sschedule.aspx.cs" %>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="divCocd" runat="server">
                                    <asp:ImageButton ID="btnAcode" style="visibility:hidden;" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnAcode_Click" />
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="div2" runat="server">
                                    <asp:ImageButton ID="btnRcode" style="visibility:hidden;" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnRcode_Click" />
                                </div>
                                <div class="col-sm-3">
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Uploaded Items</a></li>
                            </ul>
