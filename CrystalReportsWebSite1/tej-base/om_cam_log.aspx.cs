...
public partial class om_cam_log : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                doc_addl.Value = "1";
                lblheader.Text = "Company Asset Mgmt";
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl4.Value = dt.Rows[i]["tCODE"].ToString().Trim();

                        ddcamtype.Value = dt.Rows[i]["cam_type"].ToString().Trim();
                        txtlbl8.Value = dt.Rows[i]["cam_spec"].ToString().Trim();
                        ddpurpose.Value = dt.Rows[i]["cam_purpose"].ToString().Trim();
                ...
                try
                {
                    ...
                    else
                    {
                        if (save_it == "Y")
                        {
                            ...
                            fgen.msg("-", "AMSG", "CAM No " + frm_vnum + "'13'We appreciate your Entry to Finsys CAM.Aiming for Systematic Working");
                        }
                        else
                        {
    ...
    void save_fun()
    {
        ...
        oporow["cam_type"] = ddcamtype.Value;
        oporow["cam_spec"] = txtlbl8.Value.ToUpper().Trim();

        oporow["cam_purpose"] = ddpurpose.Value;
