<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_prod_sffg8" CodeFile="om_prod_sffgpm.aspx.cs" %>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <button type="submit" id="btnRead" class="btn-success" style="margin-left: 5px; margin-top: 3px;" runat="server" onserverclick="btnRead_ServerClick">Check & Consume BOM</button>
                                </li>
                                <li id="postB">                                    
...
<%--                <div class="col-md-6">
    ...
    <asp:HiddenField ID="doc_ProdFrom" runat="server" />
