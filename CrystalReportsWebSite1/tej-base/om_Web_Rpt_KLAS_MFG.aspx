<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_Web_Rpt_KLAS_MFG" Title="Tejaxo" CodeFile="om_Web_Rpt_KLAS_MFG.aspx.cs" %>
     ...
     <div class="content-wrapper">
        <section class="content-header">
            <table style="width: 100%">
                <tr>                    
                    <td>
                          <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Size="X-Large">Web Reports (Manufacturing)</asp:Label>                      
                    </td>
                </tr>
            </table>
        </section>
