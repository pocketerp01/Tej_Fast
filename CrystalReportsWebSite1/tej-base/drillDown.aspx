<%@ Page Language="C#" AutoEventWireup="true" Inherits="drillDown" CodeFile="drillDown.aspx.cs" %>
                            ...
                            <div class="col-sm-12" style="padding-bottom: 5px;">
                                <table width="100%">
                                    <tr>
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="padding-right: 5px">
                                                        <asp:TextBox ID="txtsearch" runat="server" TabIndex="1" CssClass="txtsrch" AutoPostBack="false" OnTextChanged="txtsearch_TextChanged"
                                                    ...
                                                    <td style="padding-right: 5px">
                                                        <asp:ImageButton ID="srch" runat="server" ImageUrl="~/tej-base/css/images/selectimg1.png"
                                                            Width="120px" Height="27px" ToolTip="Click to Search" OnClick="srch_Click" /></td>
                                                    <td>
                                        ...
                                        <td>
                                            <label id="lbl1" runat="server" class="control-label" title="lbl1" style="font-family: Arial; font-size: smaller; color: #000;">
                                                Showing For</label>
                                            <label id="lblMsgSel" runat="server" class="control-label" style="font-family: Arial; font-size: small; color: #000;"></label>
                                        </td>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="lbBody" id="gridDiv" style="color: White; margin-right: 15px; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                ...
                                <fin:CoolGridView ID="sg1" runat="server" Height="520px"
                                    ...
                                    Style="font-size: 13px" AutoGenerateColumns="false" PageSize="20" AllowSorting="true" OnSorting="sg1_Sorting">
                                    <RowStyle BackColor="GhostWhite" ForeColor="Black" CssClass="GridviewScrollItem2" />
                                    <%--                                    for color change--%>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="gstr" DataField="gstr" />
