<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_opt_mst_pw" CodeFile="om_opt_mst_pw.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Frz-Days|Oth-Parameter</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Freeze Days/Other Parameter" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Freeze_Upto</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="date" class="form-control" runat="server" placeholder="Freeze Upto" />
                                </div>
                            </div>


                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Starting_Date</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="date" class="form-control" runat="server" placeholder="Starting Date" />
                                </div>
                            </div>
