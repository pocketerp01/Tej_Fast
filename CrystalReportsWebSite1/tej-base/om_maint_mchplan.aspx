<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_maint_mchplan" CodeFile="om_maint_mchplan.aspx.cs" %>
                                        ...
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>'  TextMode="Date"  Width="100%" ></asp:TextBox>                                                        
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>Service_Type</HeaderTemplate>
                                                    <ItemTemplate>
