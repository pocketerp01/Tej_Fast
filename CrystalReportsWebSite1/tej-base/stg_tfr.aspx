<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="stg_tfr" CodeFile="stg_tfr.aspx.cs" %>
                        ...
                        <div class="lbBody" style="color: White; height: 250px; max-height: 250px; max-width: 1305px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                            <asp:GridView ID="sg1" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="tfld4" HeaderText="JobNo" ReadOnly="True" />
                                    <asp:BoundField DataField="tfld5" HeaderText="JobDt" ReadOnly="True" />
                                    <asp:BoundField DataField="tfld6" HeaderText="Job_Order_No" ReadOnly="True" />
                                </Columns>
