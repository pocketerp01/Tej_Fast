...
public partial class om_sale_sch : System.Web.UI.Page
{
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "TACODE":
                //pop1
                SQuery = "SELECT DISTINCT a.Acode as FStr,a.Aname as Customer,a.Acode,a.Addr1,a.Addr2,a.GST_No,a.Staten from famst a,SOMAS b where trim(A.acodE)=trim(B.acode) AND A.BRANCHCD='" + frm_mbr + "' AND B.TYPE LIKE '4%'  and length(trim(nvl(a.deac_by,'-'))) <2 AND trim(B.icat)!='Y' AND TRIM(NVL(B.APP_BY,'-'))!='-' order by a.Aname ";
                break;
            case "TICODE":
                //pop2
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        if (ok_for_save == "N")
        {
            fgen.msg("-", "AMSG", "Dear " + frm_uname + ", '13' Schedule Qty is Exceeding Order Qty , Please Check item '13' " + err_item);
            return;
        }
    ...
    protected void btnlbl7_Click(object sender, ImageClickEventArgs e)
    {
        ...
        make_qry_4_popup();
        fgen.Fn_open_sseek("Select SO Type ", frm_qstr);
    }
    //------------------------------------------------------------------------------------
    void save_fun()
    {
        ...
        for (i = 0; i < sg1.Rows.Count - 0; i++)
        {
            if (sg1.Rows[i].Cells[13].Text.Length > 2)
            {
                ...
                oporow["podate"] = sg1.Rows[i].Cells[16].Text.Trim().Substring(6, 10);
