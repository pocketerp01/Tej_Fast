<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="findCr" CodeFile="findCr.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label id="lblVty" runat="server" class="col-sm-1 control-label" title="lbl1">VC</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-2 control-label" title="lbl1">Vendor</label>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group" style="display: none">
                                <button type="submit" id="btnVerify" class="btn btn-info" style="width: 100px;" runat="server" onserverclick="btnVerify_ServerClick">Verify DB</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">Ledger</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnRcode" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btnRcode_Click" Style="width: 22px; float: right;" />
                                </div>
                                <div class="col-sm-2">
                                    <input id="txtRcode" type="text" readonly="true" class="form-control" runat="server" placeholder="Code" maxlength="4" style="height: 28px;" />
                                </div>
                                <div class="col-sm-6">
                                    <input id="txtRname" type="text" readonly="true" class="form-control" runat="server" placeholder="Name" maxlength="4" style="height: 28px;" />
                                </div>
                            </div>
                            <div class="form-group">
    ...
    <asp:Label ID="txtcustPo" runat="server" Style="display:none"></asp:Label>
