<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_einv_entry2" CodeFile="old om_einv_entry.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function gridviewScroll(gridId, gridDiv, headerFreeze, rowFreeze) {
            ...
            function calculateSum() {
                ...
                document.getElementById('ContentPlaceHolder1_txtlbl27').value = fill_zero(0).toFixed(3);
                document.getElementById('ContentPlaceHolder1_txtlbl29').value = fill_zero(0).toFixed(3);
