<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_qa_rpt" CodeFile="om_qa_rpt.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function calculatesum() {
            ...
            for (var i = 0; i < gridCount; i++) {
                ...
                var lowerLimit = (document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[15].innerHTML * 1);
                var upperLimit = (document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[16].innerHTML * 1);


                for (var colNo = 2; colNo < 11; colNo++) {
                    if (upperLimit != 0 && lowerLimit != 0) {
                        if ((document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).value * 1) > 0 || (document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).value * 1) < 0) {
                            if ((document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).value * 1) < lowerLimit || (document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).value * 1) > upperLimit) {
                                document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).style.backgroundColor = "pink";
                                counter++;
                            }
                            else {
                                document.getElementById('ContentPlaceHolder1_sg1_sg1_t' + colNo + '_' + i).style.backgroundColor = "";                                
                            }
                        }
                    }
                }
            }
            document.getElementById('ContentPlaceHolder1_hfCounter').value = counter;
        }
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" onkeyup="calculatesum();"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
