...
public partial class om_eso_entry : System.Web.UI.Page
{
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "SG3_ROW_ADD_E":
                ...
                SQuery = "SELECT a.Icode,a.Iname as product,a.icode as erpcode,a.Cpartno AS Part_no,a.Cdrgno AS Drg_no,a.Unit,a.hscode FROM Item a,typegrp b where trim(a.hscode)=trim(b.acref) and b.id='T1' and length(Trim(a.icode))>4 /*and a.icode like '9%'*/ and trim(a.icode) not in (" + col1 + ") and length(Trim(nvl(a.deac_by,'-')))<=1 and length(Trim(nvl(hscode,'-')))>1  ORDER BY Iname  ";
                break;
            case "SG1_ROW_TAX":
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "Print_E":
                    ...
                    fgenMV.Fn_Set_Mvar(frm_qstr, "REPID", "F49106");
                ...
                case "SG1_ROW_ADD":
                    ...
                    if (ViewState["sg1"] != null)
                    {
                        ...
                        if (col1.Trim().Length == 8) SQuery = "select distinct a.icode,a.iname,a.cpartno,a.cdrgno,a.unit,a.hscode,b.num4,b.num5,b.num6,b.num7 from item a,typegrp b where trim(a.hscode)=trim(b.acref) and b.id='T1' and trim(a.icode) in ('" + col1 + "') order by a.iname";
                        else SQuery = "select distinct a.icode,a.iname,a.cpartno,a.cdrgno,a.unit,a.hscode,b.num4,b.num5,b.num6,b.num7 from item a,typegrp b where trim(a.hscode)=trim(b.acref) and b.id='T1' and trim(a.icode) in (" + col1 + ") order by a.iname";
    ...
    void Type_Sel_query()
    {
        ...
        SQuery = "SELECT type1 AS FSTR,NAME,type1 AS CODE FROM type where id='V' and type1 like '4%' and type1 in ('4F','4T') order by type1";
