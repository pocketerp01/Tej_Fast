<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_inv_entry" CodeFile="om_inv_entry.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function calculateSum() {
            ...
            for (var i = 0; i < gridCount; i++) {
                ...
                if (document.getElementById('ContentPlaceHolder1_lbl1a').innerText != "42") {
                    if ((CGST[i].value * 1) > 0) {
                        ...
                        tax1 = ((AMOUNT + tool_amtz) * (CGST[i].value * 1) / 100).toFixed(2);

                        totCGST = ((totCGST * 1) + (tax1 * 1)).toFixed(2);
                        document.getElementById('ContentPlaceHolder1_sg1_sg1_t17_' + i).value = fill_zero(tax1 * 1).toFixed(2);
                    }
                    if ((SGST[i].value * 1) > 0) {
                        tax2 = ((AMOUNT + tool_amtz) * (SGST[i].value * 1) / 100).toFixed(2);
                        totSGST = ((totSGST * 1) + (tax2 * 1)).toFixed(2);
                        document.getElementById('ContentPlaceHolder1_sg1_sg1_t18_' + i).value = fill_zero(tax2 * 1).toFixed(2);
                    }
                }
                else {
            ...
            document.getElementById('ContentPlaceHolder1_txtlbl25').value = fill_zero(IAMOUNT * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtlbl27').value = fill_zero(totCGST * 1).toFixed(2);
            document.getElementById('ContentPlaceHolder1_txtlbl29').value = fill_zero(totSGST * 1).toFixed(2);

            totCashDisc = 0;
            if (totCashDisc > 0) {
                TOTAMT = (fill_zero(IAMOUNT) - fill_zero(totCashDisc)) + fill_zero(totCGST * 1) + fill_zero(totSGST * 1);
            }
            else {
                TOTAMT = fill_zero(IAMOUNT) + fill_zero(totCGST * 1) + fill_zero(totSGST * 1);
            }
            tcs_val = document.getElementById('ContentPlaceHolder1_txtTCS').value;
            if (tcs_val > 0) {
                tcs_amt = (tcs_val * TOTAMT) / 100;
                document.getElementById('ContentPlaceHolder1_txtTCSA').value = tcs_amt.toFixed(2);
                TOTAMT += tcs_amt;
            }
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CheckBox ID="chkso" runat="server" Text="Without SO"></asp:CheckBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <asp:Button ID="btncheckTax" runat="server" CssClass="bg-green btn-foursquare" Text="Re-Calculate Tax" Style="left: 30px;" OnClick="btncheckTax_Click" ToolTip="If Tax is not corrected, click on this button and correct the tax amount" />
                                </li>
                                <li style="float: right;">Our State/Province
                                    <asp:TextBox ID="txtlbl72" runat="server" placeholder="Our State / Province" Width="180px" Height="25px"></asp:TextBox>
                                    Customer State/Province                                    
                                        <asp:TextBox ID="txtlbl73" runat="server" placeholder="Customer State/Province" Width="180px" Height="25px"></asp:TextBox>
                                </li>
                                <li>
                                    <asp:Button ID="Button1" runat="server" CssClass="bg-green btn-foursquare" Text="Button 1" Style="margin-left: 30px;" OnClick="Button1_Click" />
                                </li>
                                <li>
                                    <asp:Button ID="Button2" runat="server" CssClass="bg-green btn-foursquare" Text="Button 2" Style="margin-left: 5px;" OnClick="Button2_Click" />
                                </li>
                                <li>
                                    <asp:Button ID="Button3" runat="server" CssClass="bg-green btn-foursquare" Text="Button 3" Style="margin-left: 5px;" OnClick="Button3_Click" />
                                </li>
                                <li>
                                    <asp:Button ID="Button4" runat="server" CssClass="bg-green btn-foursquare" Text="Button 4" Style="margin-left: 5px;" OnClick="Button4_Click" />
                                </li>
                            </ul>
                        ...
                        <div class="box-body" id="invDiv" runat="server">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl15" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: left;" OnClick="btnlbl15_Click" />
                                        <asp:TextBox ID="txtlbl15" runat="server" Width="140px" CssClass="form-control" Height="25px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblcashdisc" runat="server" Text="Cash_Discount_%"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCashDisc" runat="server" CssClass="form-control" MaxLength="10" Width="100px" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Style="text-align: right" onkeyup="calculateSum()" Height="25px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl16" runat="server" Text="lbl16"></asp:Label>
                                        
                                    </td>
                                    <td>
                                        <asp:ImageButton ID="btnlbl16" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: left;" OnClick="btnlbl16_Click" />
                                        <asp:TextBox ID="txtlbl16" runat="server" Width="140px" CssClass="form-control" Height="25px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblcashdicval" runat="server" Text="Cash_Disc_Value"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtCashDiscValue" runat="server" CssClass="form-control" Style="text-align: right;" MaxLength="10" Width="100px" Height="25px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl17" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: left;" OnClick="btnlbl17_Click" />
                                        <asp:TextBox ID="txtlbl17" runat="server" Width="140px" CssClass="form-control" Height="25px"></asp:TextBox>
                                    </td>
                                    <td colspan="2" style="border-top: 1px solid; border-left: 1px solid; border-right: 1px solid;">&nbsp;
                                        Truck/Lorry/Good_Rcpt Num | Date</td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="btnlbl18" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: left;" OnClick="btnlbl18_Click" />
                                        <asp:TextBox ID="txtlbl18" runat="server" Width="140px" CssClass="form-control" Height="25px"></asp:TextBox>
                                    </td>
                                    <td colspan="2" style="border-left: 1px solid; border-right: 1px solid;">&nbsp;&nbsp;
                                        <asp:TextBox ID="txtGrno" runat="server" Height="25px" Width="85px" placeholder="G.R. Number"></asp:TextBox>
                                        | 
                                        <asp:TextBox ID="txtGrDt" runat="server" Height="25px" Width="100px" placeholder="G.R. Date"></asp:TextBox>
                                ...
                                <tr>   
                                    <td>
                                        <asp:Label ID="lbl21" runat="server" Text="Payment Terms"></asp:Label>                                        
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtlbl21" runat="server" Width="140px" CssClass="form-control" Height="25px" style="margin-left:22px"></asp:TextBox>
                                    </td>
                                </tr>
                                     <tr>
                                    <td>
                                        <asp:Label ID="lbl20" runat="server" Text="lbl20"></asp:Label>                                                                                
                                    </td>
                                    <td>                                        
                                        <asp:TextBox ID="txtlbl20" runat="server" Width="140px" CssClass="form-control" Height="25px" style="margin-left:22px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-3">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtlbl28" runat="server" Width="90px" Height="25px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtlbl30" runat="server" Width="40px" Height="25px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <asp:Label ID="lblTCS" runat="server" Text="" CssClass="col-sm-1 control-label"></asp:Label>
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtTCSA" runat="server" CssClass="form-control" Height="25px" Style="text-align: right;"></asp:TextBox>
                            </div>
...
<%--                             <asp:Label ID="lbl32" runat="server" Text="Round Off" CssClass="col-sm-offset-6 col-sm-3 control-label"></asp:Label>
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtlbl32" runat="server" Style="text-align: right" CssClass="form-control" Height="25px"></asp:TextBox>
                            </div>--%>
                        </div>
                    </div>
                </div>
    ...
    <asp:HiddenField ID="doc_DAINV" runat="server" />
    ...
    <asp:HiddenField ID="hfA95" runat="server" />
    <asp:HiddenField ID="hfA96" runat="server" />
