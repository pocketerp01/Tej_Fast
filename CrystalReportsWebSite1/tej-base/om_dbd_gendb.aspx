<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_dbd_gendb" CodeFile="om_dbd_gendb.aspx.cs" %>
            ...
            <div class="row">
                ...
                <section class="col-lg-6" id="chartDiv1" runat="server">
                    <div class="box box-success rounded_corners">
                        ...
                        <div class="no-padding">
                            <div class="box-body" id="chart1" style="height: 300px; width: 85%">
                            </div>
                        </div>
                    </div>
                </section>
                <section class="col-lg-6" id="chartDiv2" runat="server">
                    <div class="box box-success rounded_corners">
                        ...
                        <div class="box-body" id="chart2" style="height: 300px; width: 85%">
                        </div>
                    </div>
                </section>
            </div>
            <div class="row">
                ...
                <section class="col-lg-6" id="chartDiv3" runat="server">
                    <div class="box box-success rounded_corners">
                        ...
                        <div class="box-body" id="chart3" style="height: 300px; width: 85%">
                        </div>
                    </div>
                </section>
                <section class="col-lg-6" id="chartDiv4" runat="server">
                    <div class="box box-success rounded_corners">
                        ...
                        <div class="box-body" id="chart4" style="height: 300px; width: 85%">
                        </div>
                    </div>
                </section>
