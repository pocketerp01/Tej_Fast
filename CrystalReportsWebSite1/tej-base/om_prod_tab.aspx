<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_prod_tab" CodeFile="om_prod_tab.aspx.cs" %>
            ...
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                1. Select Job and Press Start Job Button &nbsp;&nbsp;&nbsp;
                                2. Press Finish Job when work done, and enter Qty                                
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="lblInfo" runat="server" class="col-sm-6 control-label" style="font-size:large" title="lblInfo">-</label>
                                <label id="lblTime" class="col-sm-6 control-label" style="float: right; font-size:large">-</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="Prod Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-3 control-label" title="lbl1">Job.No</label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnJobNo" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" OnClick="btnJobNo_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Job No / Date" readonly="readonly" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">ERP_Code</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl50" type="text" class="form-control" runat="server" placeholder="ERP Code" readonly="readonly" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Product</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server" placeholder="Product" readonly="readonly" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <button type="submit" id="btnStart" class="btn btn-block btn-success" style="width: 100px;" runat="server" onserverclick="btnStart_ServerClick">Start Job</button>
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Start Time" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <button type="submit" id="btnStop" class="btn btn-block btn-danger" style="width: 100px;" runat="server" onserverclick="btnStop_ServerClick">Finish Job</button>
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="End Time" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl51" type="text" class="form-control" runat="server" placeholder="Prod Qty" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" />
                                </div>
                            </div>
                        </div>
                    </div>
