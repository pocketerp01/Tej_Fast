...
public partial class om_task_log : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                doc_addl.Value = "1";
                lblheader.Text = "Task Assignment System";
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        {
            fgen.msg("-", "AMSG", " Please Enter Team Member Name !!");
            return;
        }
        if (txtlbl3.Value.Length < 2)
        {
            fgen.msg("-", "AMSG", " Please Enter Client Contact !!");
            return;
        }
        if (txtlbl5.Value.Length != 10)
        {
            fgen.msg("-", "AMSG", " Please Enter Client Phone No. !!");
            return;
        }

        if (txtrmk.Text.Length < 2)
        {
            fgen.msg("-", "AMSG", " Please Enter Client Remarks !!");
            return;
        }

        if (txtWrkRmk.Text.Length < 2)
        {
            fgen.msg("-", "AMSG", " Please Enter Our Remarks !!");
            return;
        }
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Lsubject.Value = dt.Rows[i]["Tsubject"].ToString().Trim();
                        ...
                        ddWorkDone.Value = dt.Rows[i]["Task_mtg"].ToString().Trim();
                        ...
                        if (dt.Rows[i]["Task_mtg"].ToString().Trim() == "N") ddWorkDone.Value = "NO";
                ...
                try
                {
                    ...
                    else
                    {
                        if (save_it == "Y")
                        {
                            ...
                            html_body = html_body + "Client Code : " + txtlbl4.Value.ToUpper().Trim() + "<br>";
                            html_body = html_body + "Client Name : " + txtlbl8.Value.ToUpper().Trim() +"<br>";
                            html_body = html_body + "<br>";
                            html_body = html_body + "Task  Type : " + ddModule.Value + "<br>";
                            html_body = html_body + "Specific Module : " + Lsubject.Value + "<br>";
                            html_body = html_body + "<br>";
                            html_body = html_body + "Client's Remark : " + txtrmk.Text + "<br>";
                            html_body = html_body + "Assignor Remark : " + txtWrkRmk.Text.Trim() + "<br>";
                            html_body = html_body + "<br>";
                            html_body = html_body + "Target Days : " + txtlbl9.Value + "<br>";
                            html_body = html_body + "<br>";
                            ...
                            string mhd = "";
                            mhd = fgen.seek_iname(frm_qstr, frm_cocd, "select emailid from evas where trim(upper(username))='" + txtlbl2.Value.Trim().ToUpper() + "'", "emailid");
                            if (mhd.Length > 1)
                            {
                                fgen.send_mail(frm_cocd, "Tejaxo ERP", mhd, "", "", "Task : has been assigned " + frm_vnum, html_body);
                            }
    ...
    void save_fun()
    {
        ...
        oporow["Tsubject"] = Lsubject.Value;
        ...
        oporow["Task_mtg"] = ddWorkDone.Value.Substring(0, 1);
    ...
    void Type_Sel_query()
    {
        ...
        {
            case "F45101":
                SQuery = "SELECT 'LR' AS FSTR,'Task Logging' as NAME,'LR' AS CODE FROM dual";
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "TR");
                break;
    ...
    protected void btnPersonName_Click(object sender, ImageClickEventArgs e)
    {
        ...
        make_qry_4_popup();
        fgen.Fn_open_sseek("Select Team Member", frm_qstr);
    }
}