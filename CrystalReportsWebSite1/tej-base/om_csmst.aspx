<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_csmst" CodeFile="om_csmst.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-4 control-label" title="lbl1">Consignee Code</label>

                                <div class="col-sm-8">
                                    <input id="txt_ConsigneeCode" type="text" class="form-control" runat="server" placeholder="Consignee Code" maxlength="6" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Consignee Name</label>

                                <div class="col-sm-8">
                                    <input id="txt_consname" type="text" class="form-control" runat="server" placeholder="Consignee Name" maxlength="80" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-4 control-label" title="lbl1">Alias Name</label>

                                <div class="col-sm-8">
                                    <input id="txt_billname" type="text" class="form-control" runat="server" placeholder="Alias Name for Bill" maxlength="50" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label17" runat="server" class="col-sm-3 control-label" title="lbl1">Consignee Type</label>

                                <div class="col-sm-1" id="div1" runat="server">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_type_Click" Style="width: 22px; float: right;"/>
                                </div>

                                <div class="col-sm-8">
                                    <input id="txt_type" type="text" readonly="readonly" class="form-control" runat="server" placeholder="Type of Consignee" maxlength="50" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label20" runat="server" class="col-sm-3 control-label" title="lbl1">Customer</label>
                                <div class="col-sm-1" id="div3" runat="server">
                                    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_customer_Click" Style="width: 22px; float: right;"/>
                                </div>

                                <div class="col-sm-8">
                                    <input id="txt_customer" type="text" readonly="readonly" class="form-control" runat="server" placeholder="Customer" maxlength="50" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">CustomerCode</label>

                                <div class="col-sm-8">
                                    <input id="txt_custcode" type="text" readonly="readonly" class="form-control" runat="server" placeholder="CustomerCode" maxlength="50" />
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label18" runat="server" class="col-sm-3 control-label" title="lbl1">Address(Line1)</label>
                                                        <div class="col-sm-9">
                                                            <input id="txt_addr_1" type="text" class="form-control" runat="server" placeholder="Address (Line1)" maxlength="100" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="Label22" runat="server" class="col-sm-3 control-label" title="lbl1">Address(Line2)</label>
                                                        <div class="col-sm-9">
                                                            <input id="txt_addr_2" type="text" class="form-control" runat="server" placeholder="Address (Line2)" maxlength="70" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Address(Line3)</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label25" runat="server" class="col-sm-3 control-label" title="lbl1">Address(Line4)</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label12" runat="server" class="col-sm-2 control-label" title="lbl1">State_Name</label>
                                                        <div class="col-sm-1" id="div2" runat="server">
                                                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_stat_Click" Style="width: 22px; float: right;"/>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <input id="txt_stat_name" type="text" class="form-control" runat="server" placeholder="State Name" readonly="readonly" maxlength="50" />
                                                        </div>
                                                        <div class="col-sm-1">
                                                            <input id="txt_stat_code" type="text" class="form-control" runat="server" placeholder="State Code" readonly="readonly" maxlength="2" />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label id="Label33" runat="server" class="col-sm-3 control-label" title="lbl1">PAN No.</label>
                                                        <div class="col-sm-9">
                                        ...
                                        <div class="col-md-6">
                                            <div>
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label7" runat="server" class="col-sm-2 control-label" title="lbl1">Telphone_No.</label>
                                                        <div class="col-sm-4">
                                                            <input id="txt_telephonenno" type="text" class="form-control" runat="server" placeholder="Telephone Number" maxlength="38" />
                                                        </div>
                                                          <label id="Label3" runat="server" class="col-sm-2 control-label" title="lbl1">Mobile_No.</label>
                                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label16" runat="server" class="col-sm-2 control-label" title="lbl1">Email_Id</label>
                                                        <div class="col-sm-4">
                                                            <input id="txt_email" type="email" class="form-control" runat="server" placeholder="Email Id" maxlength="50" />
                                                        </div>
                                                         <label id="Label1" runat="server" class="col-sm-2 control-label" title="lbl1">Contact_Person</label>
                                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">                                                       
                                                          <label id="Label37" runat="server" class="col-sm-2 control-label" title="lbl1">GST_no.</label>
                                                        <div class="col-sm-4">
                                                            <input id="txt_gst" type="text" class="form-control" runat="server" placeholder="GST  Number" maxlength="20" />
                                                        </div>
                                                         <label id="Label21" runat="server" class="col-sm-2 control-label" title="lbl1">Pincode</label>
                                                        <div class="col-sm-4">
                                                            <input id="txtpincode" type="text" class="form-control" runat="server" placeholder="PIN CODE" maxlength="10" />
                                                        </div>
                                                    </div>

                                                     <div class="form-group">
                                                              <label id="Label2" runat="server" class="col-sm-2 control-label" title="lbl1">Fax_No.</label>
                                                        <div class="col-sm-10">
                                                            <input id="txt_faxno" type="text" class="form-control" runat="server" placeholder="fax no." maxlength="38" />
                                                        </div>  </div>
                                                                                        
                                                     <div class="form-group">
                                                        <label id="Label10" runat="server" class="col-sm-2 control-label" title="lbl1">Bank</label>
                                                        <div class="col-sm-10">
                                                            <input id="txtbank" type="text" class="form-control" runat="server" placeholder="BANK" maxlength="20" />
                                                        </div>                                                       
                                                    </div>

                                                     <div class="form-group">                                                       
                                                          <label id="Lbl23" runat="server" class="col-sm-2 control-label" title="lbl1">IFSC</label>
                                                        <div class="col-sm-4">
                                                            <input id="txtifsc" type="text" class="form-control" runat="server" placeholder="IFSC" maxlength="30" />
                                                        </div>
                                                         <label id="Lbl27" runat="server" class="col-sm-2 control-label" title="lbl1">Distance</label>
                                                        <div class="col-sm-4">
                                                            <input id="txtdistance" type="text" class="form-control" runat="server" placeholder="DISTANCE" maxlength="20" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-1" id="div7" runat="server">
                                                            <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_ivl_Click" Style="width: 22px; float: right;"/>
                                                        </div>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-1" id="div4" runat="server">
                                                            <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_bnkacct_Click" Style="width: 22px; float: right;"/>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <%--   <div class="col-sm-1" id="div6" runat="server">
                                                            <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_costcent_Click" Style="width: 22px; float: right;"/>
                                                        </div>--%>
                                                        <div class="col-sm-8">
