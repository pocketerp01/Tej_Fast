<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_Cylind_Cost" CodeFile="om_Cylind_Cost.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label19" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Width</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtweight" runat="server" BackColor="LightBlue" CssClass="form-control" Width="100%" onkeyup="cal()" autocomplete=”off” MaxLength="5"></asp:TextBox>
                                </div>
                                <div class="col-sm-3">
                    ...
                    <div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtminrng" runat="server"  BackColor="LightBlue" CssClass="form-control" Width="100%" Text="1.7" MaxLength="5"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtmaxrng" runat="server"  BackColor="LightBlue" CssClass="form-control" Text="5" Width="100%" MaxLength="5"></asp:TextBox>
                                </div>
                            </div>
                            <table style="width: 100%">
                                <tr style="display: none;">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td style="float:right;">
                                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Highlights Values are between Min and Max Range.</b> 
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Cylinder Details</a></li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t30" runat="server" Text='<%#Eval("sg1_t30") %>' Width="100%" MaxLength="30"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around1</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around2</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around3</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around4</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around5</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around6</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around7</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around8</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around9</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around10</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around11</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around12</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around13</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around14</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Around15</HeaderTemplate>
                                                    <ItemTemplate>
