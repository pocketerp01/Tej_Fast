<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_vehi_log" CodeFile="om_vehi_log.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">VEH_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="CAM No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">VEH Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="CAM Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
