<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="drawissue" Title="Drawing Issue Entry" CodeFile="drawissue.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        //$("#ctl00_ContentPlaceHolder1_txtrdate").datepicker({
        //            showOn: "button",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h3 class="lbHeader" align="center" >
     ...
     <button id="btnprint"  accesskey="p" class="frmbtn"  runat="server"  onserverclick="btnprint_Click"  ><u>P</u>rint</button>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <asp:Label ID="lbl1" runat="server" Text="lbl1" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">EDN</asp:Label>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label19" runat="server" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Drawing_Type</asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btndno" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btndno_Click" />
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" style="display: none;">
                                    <asp:ImageButton ID="btnrno" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnrno_Click" />
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Revision No.</asp:Label>
                                <div class="col-sm-9">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label3" runat="server" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Issue_To</asp:Label>
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnito" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnito_Click" />
                                </div>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtito" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                </div>
                                <asp:Label ID="Label4" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Issue_By</asp:Label>
                                <div class="col-sm-1" style="display: none;">
                                    <asp:ImageButton ID="btniby" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btniby_Click" />
                                </div>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtiby" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                               <%-- Issue_Date AND RETURN TARGET DATE IS REAONLY TRUE--%>
                                <asp:Label ID="Label5" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Issue_Date</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtidate"   runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                    <asp:CalendarExtender ID="txtidate_CalendarExtender" runat="server" Enabled="True" TargetControlID="txtidate" Format="dd/MM/yyyy">
                                    </asp:CalendarExtender>
                                    <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="99/99/9999" MaskType="Date" TargetControlID="txtidate" />
                                </div>
                                <asp:Label ID="Label6" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Return_Target_Date</asp:Label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtrdate" runat="server"  CssClass="form-control" Width="100%"></asp:TextBox>
                                   <%-- <asp:CalendarExtender ID="txtrdate_CalendarExtender" runat="server" Enabled="True" TargetControlID="txtrdate" Format="dd/MM/yyyy">
                                    </asp:CalendarExtender>
                                    <asp:MaskedEditExtender ID="MaskedEditExtender2" runat="server" Mask="99/99/9999" MaskType="Date" TargetControlID="txtrdate" />--%>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label7" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Created_By</asp:Label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtpre" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label8" runat="server" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Modified_By</asp:Label>
                                <div class="col-sm-9">
     ...
     <img src="css/images/icon.jpg"/> Create  
       ...
       <img src="css/images/mandatory.gif"/>&nbsp;&nbsp;&nbsp; Mandatory Fields</span>    
            ...
            <%--   <tr >
                        ...
                        <tr style="background-color: #CDE8F0">
                                                       <td >
                                                           EDN</td>
                            <td >
                                <asp:TextBox ID="txtdocno" runat="server" placeholder="EDN" 
            ...
            <%--	<tr style="background-color: #CDE8F0">
                            ...
                            <td colspan="3">
                                ...
                                <asp:TextBox ID="txtdtype" runat="server"  
									...
									<asp:ImageButton ID="btndno" runat="server" Height="22px" 
                                    ImageUrl="~/css/images/bdsearch5.png" ToolTip="Drawing No." Width="24px" 
                                    onclick="btnctye_Click" ImageAlign="Middle" />
            ...
            <%--<tr >
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtdno" runat="server"  
                                    ...
                                    <asp:ImageButton ID="btnrno" runat="server" Height="22px" 
                                    ImageUrl="~/css/images/bdsearch5.png" ToolTip="Drawing No." Width="24px" 
                                    onclick="btnctye_Click" ImageAlign="Middle" />
                            </td>
                        </tr>--%>
            ...
            <%--<tr >
						<tr style="background-color: #CDE8F0">
                            <td >
                                Issue To<span style="color:red">*</span></td>
                            <td colspan="3">
                                <asp:TextBox ID="txtito" runat="server"  
                                    placeholder="Issue To" onfocus="Change(this, event)" 
                                    onblur ="Change(this, event)" ReadOnly="true"   ></asp:TextBox>
									
									<asp:ImageButton ID="btnito" runat="server" Height="22px" 
                                    ImageUrl="~/css/images/bdsearch5.png" ToolTip="Issue To" Width="24px" 
                                    onclick="btnctye_Click" ImageAlign="Middle" />
            ...
            <%--<tr >
                            <td >
                                Issue By<span style="color:red">*</span></td>
                            <td colspan="3">
                                <asp:TextBox ID="txtiby" runat="server"  
                                    placeholder="Issue By" onfocus="Change(this, event)" 
                                    onblur ="Change(this, event)" ReadOnly="true"   ></asp:TextBox>
									
									<asp:ImageButton ID="btniby" runat="server" Height="22px" 
                                    ImageUrl="~/css/images/bdsearch5.png" ToolTip="Issue By" Width="24px" 
            ...
            <%--	<tr style="background-color: #CDE8F0">
                            <td >
                                Issue Date<span style="color:red">*</span></td>
                            <td colspan="3">
							<input name="txtidate" type="text" id="txtidate"  placeholder="dd/mm/yyyy" runat="server" readonly="readonly" tabindex="-1"/>
            ...
            <%--<tr >
                            <td >
                                Return Target Date<span style="color:red">*</span></td>
                            <td colspan="3">
							<input name="txtrdate" type="text" id="txtrdate"  placeholder="dd/mm/yyyy" runat="server" readonly="readonly" tabindex="-1"/>
                            </td>
                        </tr>--%>
