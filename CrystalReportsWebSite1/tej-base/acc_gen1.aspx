<%@ Page Title="" Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="fin_acct_web_acc_gen1" CodeFile="acc_gen1.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function UpperCase1(ctrlID) {

            var GSTNo = document.getElementById(ctrlID).value;
            if (GSTNo != "") {
                document.getElementById(ctrlID).value = GSTNo.toUpperCase();
            }
        }

        function ValidateGST(ctrlID) {
            debugger;

            var GSTNo = document.getElementById(ctrlID).value;
            if (GSTNo.value != "") {
                var ObjVal = GSTNo;
                var panPattern = /^([0-9]{2}[a-zA-Z]{4}([a-zA-Z]{1}|[0-9]{1})[0-9]{4}[a-zA-Z]{1}([a-zA-Z]|[0-9]){3}){0,15}$/;
                ;
                var matchArray = ObjVal.match(panPattern);

                if (matchArray == null) {
                    alert('Hello User! You have inputted  a wrong GST number . Please check it once. ');
                    return false;
                }
    ...
    <script>
        ...
        function call() {
            debugger;
            alert('please check your whstapp message');
            var http = require('http');

            var instanceId = "13"; // TODO: Replace it with your gateway instance ID here
            var clientId = "twinkle.gupta033@gmail.com";     // TODO: Replace it with your Forever Green client ID here
            var clientSecret = "83a03775e6ed42d9a7f9c58aac09ff71";  // TODO: Replace it with your Forever Green client secret here

            var jsonPayload = JSON.stringify({
                number: "919958177242",  // TODO: Specify the recipient's number here. NOT the gateway number
                message: "hello,you have open a new branch"
            });
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-3 control-label" title="lbl1">Plant Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="div3" runat="server">
                                   <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_mgr_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txt_brnchcd" type="text" class="form-control" runat="server" placeholder="Branch Code"  maxlength="50" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">A/c Code</label>
                                 <div class="col-sm-1" id="div9" runat="server">
                                   <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_mgr_Click" />
                                </div>
                                <div class="col-sm-8">
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li><a href="#DescTab2" id="tab2" runat="server" aria-controls="DescTab2" role="tab" data-toggle="tab">Contact,GST Details</a></li>
                                        ...
                                        <div>
                                            <div class="box-body">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_addr_2" type="text" class="form-control" runat="server" placeholder="Address (Line1)" maxlength="150" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-1" id="div2" runat="server">
                                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_stat_Click" />
                                                    </div>
                                                    <div class="col-sm-8">
                                             ...
                                             <div class="form-group">
                                                    ...
                                                    <div class="col-sm-1" id="div10" runat="server">
                                                       <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_ctry_Click" />
                                                    </div>
                                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                        <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">RegdOffice</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_regd_office" type="text" class="form-control" runat="server" placeholder="RegdOffice" maxlength="75" />
                                                        </div>
                                                    </div>

                                               <div class="form-group">
                                                        <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">RegdOffice2</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_regd_office1" type="text" class="form-control" runat="server" placeholder="RegdOffice" maxlength="75" />
                                                        </div>
                                                    </div>

                                                 <div class="form-group">
                                                    <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Zip code</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Email Id(For Finance)</label>
                                                    <div class="col-sm-8">
                                                        <input id="txt_email1" type="text" class="form-control" runat="server" placeholder="Email Id(For Finance)" maxlength="50" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    <label id="Label26" runat="server" class="col-sm-3 control-label" title="lbl1">Email-ID</label>
                                                ...
                                                <div class="form-group">
                                                    <label id="Label8" runat="server" class="col-sm-3 control-label" title="lbl1">FAX No.</label>
                                                ...
                                                <div class="form-group">
                                                    <label id="Label14" runat="server" class="col-sm-3 control-label" title="lbl1">GST No.</label>

                                                    <div class="col-sm-8">
                                                        <input id="txt_gst_no" type="text" class="form-control" runat="server" placeholder="GST No."  clientidmode="static" maxlength="15" onkeypress="UpperCase1('txt_gst_no');" onkeyup="UpperCase1('txt_gst_no');" onchange="return ValidateGST('txt_gst_no');" />
                                                    </div>
                                                </div>

                                                 <div class="form-group">
                                                    <label id="Label37" runat="server" class="col-sm-3 control-label" title="lbl1">Email Id(stores)</label>
                                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-md-6">
                                            <div>
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label31" runat="server" class="col-sm-4 control-label" title="lbl1">Head-Office</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_head_off" type="text" class="form-control" runat="server" placeholder="Head-Office" maxlength="50" />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label id="Label32" runat="server" class="col-sm-4 control-label" title="lbl1">Phone NO.</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_phone_no" type="text" class="form-control" runat="server" placeholder="Phone NO." maxlength="20" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">CINNO. </label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_cin" type="text" class="form-control" runat="server" placeholder="CINNO." maxlength="30" />
                                                        </div>
                                                   <div class="form-group">
                                                        <label id="Label33" runat="server" class="col-sm-4 control-label" title="lbl1">MSMENO. </label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_msme_no" type="text" class="form-control" runat="server" placeholder="MSMENO." maxlength="30" />
                                                        </div>
                                                    </div>
                                                   
                                                 <div class="form-group">
                                                    <label id="Label65" runat="server" class="col-sm-4 control-label" title="lbl1">Email Id(For Sales)</label>
                                                    <div class="col-sm-8">
                                                        <input id="txt_email3" type="text" class="form-control" runat="server" placeholder="Email Id(For Stores)" maxlength="50" />
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_range" type="text" class="form-control" runat="server" placeholder="Range" maxlength="30" />
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_pf_no" type="text" class="form-control" runat="server" placeholder="PF RegnNo."  maxlength="30" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_esi_regn" type="text" class="form-control" runat="server" placeholder="ESI Regn No."   maxlength="5" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="txt_pan_no" type="text" class="form-control" runat="server" placeholder="PAN NO." clientidmode="static" maxlength="20" onkeypress="UpperCase('txt_pan_no');" onkeyup="UpperCase('txt_pan_no');" onchange="return ValidatePAN('txt_pan_no');"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="Txt_tin_dt" type="text" class="form-control" runat="server" placeholder="DT." maxlength="1" />
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                            <div>
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label id="Label85" runat="server" class="col-sm-4 control-label" title="lbl1">Dt</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_cst_dt" type="text" class="form-control" runat="server" placeholder="Dt" maxlength="10" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label id="Label86" runat="server" class="col-sm-4 control-label" title="lbl1">Prefix for P.O.</label>
                                                        <div class="col-sm-8">
                                                            <input id="txt_prefix_po" type="text" class="form-control" runat="server" placeholder="Prefix for P.O." maxlength="80" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="Txt_invoice" type="text" class="form-control" runat="server" placeholder="For Invoice" maxlength="20" />
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="form-group">
                                                       ...
                                                       <asp:ImageButton ID="ImageButton6" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_ivl_Click" />
                                                    </div>
                                                         <div class="col-sm-8">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_bnkacct_Click" />
                                                    </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input id="txt_brnch" type="text" class="form-control" runat="server"  readonly="readonly"  placeholder="Prefix for Branch" maxlength="50" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/tej-base/css/images/bdsearch5.png" OnClick="btn_costcent_Click" />
                                                    </div>
                                                         <div class="col-sm-8">
                                        ...
                                        <div>
                                            <div class="box-body">
                                               ...
                                               <%-- <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label id="Label28" runat="server" class="col-sm-4 control-label" title="lbl1">Bank IEC Code</label>
                                                    <div class="col-sm-8">
                                                        <input id="txt_bank_iec" type="text" class="form-control" runat="server" placeholder="Bank IEC Code" maxlength="30" />
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_wip_srtdate" type="text" class="form-control" runat="server" placeholder="WIP StartDate" maxlength="50" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label id="Label55" runat="server" class="col-sm-4 control-label" title="lbl1">CotWise StkDt </label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_tax_add1" type="text" class="form-control" runat="server" placeholder="Tax Schg(1)/Add1tax" maxlength="1" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_plant_capacity" type="text" class="form-control" runat="server" placeholder="Plant Capacity" maxlength="1" />
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_wtm_purch" type="text" class="form-control" runat="server" placeholder="WTM:Purch" maxlength="1" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="txt_wtm_cons" type="text" class="form-control" runat="server" placeholder="Wtm:Cons" maxlength="1" />
                                                    </div>
                                                </div>
