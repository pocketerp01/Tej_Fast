<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_BT_BD_BF" CodeFile="om_BT_BD_BF.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Label ID="Label17" runat="server" Text="PO_Item_No" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl102" runat="server" Text="lbl7" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">WO_Item_No</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtwoLno" runat="server" CssClass="form-control" MaxLength="5" ReadOnly="false"></asp:TextBox>
                                </div>
                                <div class="col-sm-8" style="display: none;">
                                    <asp:TextBox ID="txtWoLine" runat="server" CssClass="form-control" MaxLength="20" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl104" runat="server" Text="lbl7" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Drawing_No And Rev_No</asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtDrawing" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <asp:Label ID="Label3" runat="server" Text="lbl7" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Material / Stock Code</asp:Label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txtMaterial" runat="server" CssClass="form-control" MaxLength="30"></asp:TextBox>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <%--<asp:Label ID="Label4" runat="server" Text="lbl7" CssClass="col-sm-4 control-label" Font-Size="14px" Font-Bold="True">Client_Tag_No</asp:Label>--%>
                                <div class="col-sm-4">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtlbl2" runat="server" CssClass="form-control" Width="100%" MaxLength="100"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Project</asp:Label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Design_Std</asp:Label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Labl8" runat="server" Text="lbl7" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Flange_Std</asp:Label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtFlange" runat="server" CssClass="form-control" Width="100%" MaxLength="30"></asp:TextBox>
                                </div>
                            </div>


                            <div class="form-group">
                                <asp:Label ID="Label6" runat="server" Text="lbl7" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Product</asp:Label>
                                <div class="col-sm-10">
                                    <asp:TextBox ID="txtItem" runat="server" Width="100%" CssClass="form-control" MaxLength="30" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Valve_Model</asp:Label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl11" runat="server" Text="lbl7" CssClass="col-sm-2 control-label" Font-Size="14px" Font-Bold="True">Valve_Rating</asp:Label>
                                <div class="col-sm-10">
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>Client_Tag_No</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>ØD</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>No_Of_Tapped_Holes_Marked$</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' Width="100%" MaxLength="30"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Size_X_Depth_Of_Tapping_Marked$</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" runat="server" Text='<%#Eval("sg1_t15") %>' Width="100%" MaxLength="35"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>No_Of_Thru_Holes/No_Of_Tapped_Holes</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t16" runat="server" Text='<%#Eval("sg1_t16") %>' Width="100%" MaxLength="40"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Dia_Of_Thru/Tapped_Holes</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Facing/Finish</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t19" runat="server" Text='<%#Eval("sg1_t19") %>' Width="100%" MaxLength="60"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Open_Field</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t20" runat="server" Text='<%#Eval("sg1_t20") %>' Width="100%" MaxLength="60"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Remarks</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t21" runat="server" Text='<%#Eval("sg1_t21") %>' Width="100%" MaxLength="60"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
