<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_terms_cond" CodeFile="om_terms_cond.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="lbl1" runat="server" class="col-sm-2 control-label" title="lbl1">Entry No.</label>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-2 control-label" title="lbl1">Type</label>
                                <div class="col-sm-2">
                                    <asp:ImageButton ID="btnType" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" />                                    
                                </div>
                                <div class="col-sm-4">
                                    <input id="txtType" type="text" class="form-control" runat="server" readonly="true" style="height: 28px;" />
                                </div>                                
                            </div>
                        </div>
                    </div>
                                        ...
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" oncontextmenu="return false;" MaxLength="100"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
