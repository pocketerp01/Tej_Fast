<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" CodeFile="om_einv.aspx.cs" Inherits="om_einv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <section class="content-header">
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Size="X-Large">E-Invoice Generation/Updation</asp:Label></td>
                    <td style="text-align: right">
                        ...
                        <button type="submit" id="btnlist" class="btn btn-info" style="width: 100px;" runat="server" accesskey="t" onserverclick="btnlist_ServerClick">IRN Doc Lis<u>t</u></button>
                        <button type="submit" id="command3" class="btn btn-info" style="width: 100px;" runat="server" accesskey="t" onserverclick="command3_ServerClick">Doc List(IRN)</button>
                        <button type="submit" id="command7" class="btn btn-info" style="width: 100px;" runat="server" accesskey="c" onserverclick="command7_ServerClick">Get QR Code</button>
                        <button type="submit" id="btncancel" class="btn btn-info" style="width: 100px;" runat="server" accesskey="c" onserverclick="btncancel_ServerClick"><u>C</u>ancel</button>
                        <button type="submit" id="btnexit" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnexit_ServerClick">E<u>x</u>it</button>


                        <%--<button type="submit" id="btnwebtel" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnwebtel_ServerClick">Auto<u>ma</u>tic</button>--%>
            ...
            <div class="row">
                    ...
                    <div class="">
                        ...
                        <div class="box-body" style="">
                            <div class="form-group">
                                ...
                                <asp:Label ID="lbl1a" runat="server" Text="TC" CssClass="col-sm-1 control-label"></asp:Label>
                            ...
                            <div class="form-group">
                                <asp:Label ID="lbl4" runat="server" Text="lbl4" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtlbl4" runat="server" Width="250px" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="lbl7" runat="server" Text="lbl7" CssClass="col-sm-3 control-label"></asp:Label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtlbl7" runat="server" Width="150px" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="box-body" style="justify-content: center; align-items: center;">
                            <div class="col-sm-12">
                                <button type="submit" id="btnshow" class="btn btn-success" style="width: 300px; text-align: center" runat="server" accesskey="X" onserverclick="btnshow_ServerClick">1) Show Invoice To create E-Invoice</button>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" id="btnjson" class="btn btn-success" style="width: 300px;" runat="server" accesskey="X" onserverclick="btnjson_ServerClick">2) Automatically Generate E-invoice No.</button>
                            </div>

                            <div class="col-sm-12">
                                <button type="submit" id="command6" class="btn btn-success" style="width: 300px; height: 30px;" visible="false" runat="server" accesskey="X" onserverclick="command6_ServerClick">3) Generate Demo E-Invoice No</button>
                            </div>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl8" runat="server" Visible="false" Text="lbl8" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl8" runat="server" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl9" runat="server" Text="lbl9" Visible="false" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl9" runat="server" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl102" runat="server" Visible="false" Text="lbl102" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl102" runat="server" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <asp:Label ID="lbl103" runat="server" Text="lbl103" Visible="false" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl103" runat="server" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab">
                                    <div class="lbBody" id="gridDiv" style="color: White; height: 300px; overflow: hidden; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="1150px" Font-Size="13px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <%--                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' Width="100%" AutoPostBack="true"  OnTextChanged="txt_TextChanged"></asp:TextBox>--%>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Width="100%" MaxLength="15"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t11" runat="server" Text='<%#Eval("sg1_t11") %>' onkeyup="openBox(this);" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' oncontextmenu="return false;" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t15</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" runat="server" Text='<%#Eval("sg1_t15") %>' oncontextmenu="return false;" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                ...
                <div class="col-md-12">
                    <div class="">
                        <div class="box-body">
                            <asp:TextBox ID="txtrmk" runat="server" MaxLength="150" Width="99%" TextMode="MultiLine" placeholder="Remarks" Visible="false"></asp:TextBox>
                        </div>
                    </div>
                </div>
    ...
    <asp:HiddenField ID="hfdemo" runat="server" />
    <asp:HiddenField ID="hf_einv_ok" runat="server" />
    <asp:HiddenField ID="hfGridView1SV" runat="server" />
    <asp:HiddenField ID="hfGridView1SH" runat="server" />
    <asp:HiddenField ID="hfmake_EwayBill" runat="server" />
