...
public partial class om_lgl_log : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                doc_addl.Value = "1";
                lblheader.Text = "Legal Master Mgmt";
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        ddcamtype.Value = dt.Rows[i]["CASE_type"].ToString().Trim();
                        txtlbl8.Value = dt.Rows[i]["CASE_spec"].ToString().Trim();
                        ddpurpose.Value = dt.Rows[i]["CASE_purpose"].ToString().Trim();
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            SQuery = "SELECT a.LEGNO as LEG_NO,to_char(A.LEGDT,'dd/mm/yyyy') as LEG_Dt,a.case_type,a.case_spec,a.ACODE as Team_member,a.case_Purpose,a.Ent_by,a.Ent_Dt,a.app_by,a.app_Dt,to_chaR(a.LEGDT,'YYYYMMDD') as LEGDTD FROM " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type='" + frm_vty + "' and a.LEGdt " + PrdRange + " order by a.LEGno ";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
    ...
    void save_fun()
    {
        ...
        oporow["CASE_type"] = ddcamtype.Value;
        oporow["CASE_spec"] = txtlbl8.Value.ToUpper().Trim();

        oporow["CASE_purpose"] = ddpurpose.Value;
