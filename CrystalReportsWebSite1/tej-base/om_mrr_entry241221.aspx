<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_mrr_entry241221" CodeFile="om_mrr_entry241221.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function openBox(tk) {
            if (event.keyCode == 13) {
                ...
                if (tk.id.includes("sg1_t5")) {
                    if (document.getElementById('ContentPlaceHolder1_lbl1a').innerText == "09") {
        ...
        function calculateSum() {
            ...
            var exchRate = document.getElementById('ContentPlaceHolder1_txtlbl24').value;
            var gridCount = $("[id*=sg1].GridviewScrollItem2").length;

            if (document.getElementById('ContentPlaceHolder1_hfcocd').value == "SAIA") decimalPoint = 2;

            for (var i = 0; i < gridCount; i++) {
                var CHLQTY = $("input[id*=sg1_t1]");
                var Qty = $("input[id*=sg1_t3]");
                var Rate = $("input[id*=sg1_t5]");

                var CGST = $("input[id*=sg1_t7]");
                var SGST = $("input[id*=sg1_t8]");
                var WT = $("input[id*=sg1_t22]");
                var mpotype = $("input[id*=sg1_t23]");

                var AMOUNT = 0;
                var mqty = 0;
                var tax1 = 0;
                var tax2 = 0;
                var itemRate = Rate[i].value;
                if (fill_zero(exchRate) > 0) {
                    itemRate *= exchRate;
                }
                var rowI = 0;
                if (i == 0) rowI = 0;
                ...
                //if (document.getElementById("ContentPlaceHolder1_sg1").rows[rowI].cells[3].innerText == "55") {
                //    AMOUNT = (document.getElementById('ContentPlaceHolder1_sg1_sg1_t4_' + i).value * 1) * (itemRate * 1);
                //}
                //else
                //{
                //    AMOUNT = (Qty[i].value * 1) * (itemRate * 1);
                //}

                if (mpotype[i].value == "55") {
                    AMOUNT = (document.getElementById('ContentPlaceHolder1_sg1_sg1_t4_' + i).value * 1) * (itemRate * 1);
                }
                else {
                    AMOUNT = (Qty[i].value * 1) * (itemRate * 1);
                ...
                totqty += fill_zero(mqty);

                //if (document.getElementById('ContentPlaceHolder1_lbl1a').innerText == "02") {
                //document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value = fill_zero((CHLQTY[i].value * 1) * (WT[i].value * 1));
                //document.getElementById('ContentPlaceHolder1_sg1_sg1_t4_' + i).value = fill_zero((mqty * 1) * (WT[i].value * 1));
                //}

                document.getElementById('ContentPlaceHolder1_sg1_sg1_t6_' + i).value = fill_zero(AMOUNT).toFixed(decimalPoint);
                ...
                if (TaxYN == "Y") {
                    if ((CGST[i].value * 1) > 0) {
                        ...
                        document.getElementById('ContentPlaceHolder1_sg1_sg1_t17_' + i).value = fill_zero(tax1).toFixed(decimalPoint);

                    }
                    if ((SGST[i].value * 1) > 0) {
                        totSGST += (AMOUNT * (SGST[i].value * 1) / 100);
                        tax2 = (AMOUNT * (SGST[i].value * 1) / 100);
                        document.getElementById('ContentPlaceHolder1_sg1_sg1_t18_' + i).value = fill_zero(tax2).toFixed(decimalPoint);

                    }
                }
            }

            document.getElementById('ContentPlaceHolder1_txtlbl25').value = fill_zero(IAMOUNT).toFixed(decimalPoint);
            document.getElementById('ContentPlaceHolder1_txtlbl27').value = fill_zero(totCGST).toFixed(decimalPoint);
            document.getElementById('ContentPlaceHolder1_txtlbl29').value = fill_zero(totSGST).toFixed(decimalPoint);
            document.getElementById('ContentPlaceHolder1_doc_qty').value = fill_zero(totqty).toFixed(decimalPoint);


            var packCharg = fill_zero(document.getElementById('ContentPlaceHolder1_txtlbl10').value);
            var insurCharg = fill_zero(document.getElementById('ContentPlaceHolder1_txtlbl11').value);
            var freightCharg = fill_zero(document.getElementById('ContentPlaceHolder1_txtlbl12').value);

            TOTAMT = fill_zero(IAMOUNT) + fill_zero(totCGST) + fill_zero(totSGST) + (packCharg * 1) + (insurCharg * 1) + (freightCharg * 1);
            document.getElementById('ContentPlaceHolder1_txtlbl31').value = fill_zero(TOTAMT).toFixed(decimalPoint);
            if (document.getElementById('ContentPlaceHolder1_hfcocd').value == "SAIA")
                document.getElementById('ContentPlaceHolder1_txtlbl31').value = fill_zero(TOTAMT).toFixed(0);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table style="width: 100%">
                <tr>
                  <td style="text-align: left">
                        ...
                        <button type="submit" id="btnSticker" class="btn btn-info" style="width: 100px;" runat="server" accesskey="k" onserverclick="btnSticker_ServerClick">Ide<u>n</u>Tags</button>
                    ...
                    <div>
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl2" runat="server" Text="lbl2" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl5" runat="server" Text="lbl5" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl8" runat="server" Text="lbl8" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl9" runat="server" Text="lbl9" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Our_State" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Cust_State" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <input id="txtBarCode" runat="server" placeholder="Scan BarCode" type="text" class="form-control" style="width: 300px; margin-top: 3px;" />
                                </li>
                                <li>
                                    <button id="btnRead" type="submit" class="btn btn-block btn-success" style="width: 100px; margin-left: 5px; margin-top: 3px;" runat="server" onserverclick="btnRead_ServerClick">Read Data</button>
                                </li>
                            </ul>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t5" runat="server" Text='<%#Eval("sg1_t5") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" Style="text-align: right" onkeyup="calculateSum(); openBox(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t6</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' oncontextmenu="return false;" onpaste="return false" Width="100%" Style="text-align: right" onkeyup="calculateSum()"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onkeypress="openBox(this)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Wt</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t22" runat="server" Text='<%#Eval("sg1_t22") %>' Width="100%" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField>
                                                    <HeaderTemplate>POTYPE</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t23" runat="server" Text='<%#Eval("sg1_t23") %>' Width="100%" ReadOnly="true"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            ...
                                            <div>
                                                <div class="box-body">
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl10" runat="server" Text="Packing_Chrg." CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                                <asp:ImageButton ID="btnlbl10" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl10_Click" /></td>
                                                            <td>
                                                                <div class="col-sm-4">
                                                                    <asp:TextBox ID="txtlbl10" runat="server" Width="350px" MaxLength="10" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Style="text-align: right" onkeyup="calculateSum()"></asp:TextBox>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl11" runat="server" Text="Insurance_Chrg." CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                                <asp:ImageButton ID="btnlbl11" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl11_Click" /></td>
                                                            <td>
                                                                <div class="col-sm-4">
                                                                    <asp:TextBox ID="txtlbl11" runat="server" Width="350px" MaxLength="10" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Style="text-align: right" onkeyup="calculateSum()"></asp:TextBox>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl12" runat="server" Text="Freight_Chrg." CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                                <asp:ImageButton ID="btnlbl12" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl12_Click" /></td>
                                                            <td>
                                                                <div class="col-sm-4">
                                                                    <asp:TextBox ID="txtlbl12" runat="server" Width="350px" MaxLength="10" onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Style="text-align: right" onkeyup="calculateSum()"></asp:TextBox>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl13" runat="server" Text="Port" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                                <asp:ImageButton ID="btnlbl13" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl13_Click" /></td>
                                                            <td>
                                                                <div class="col-sm-4">
                                                        ...
                                                        <tr style="display: none">
                                                            <td>
                                                                <asp:Label ID="lbl14" runat="server" Text="Bill_of_Entry_Dt" CssClass="col-sm-2 control-label"></asp:Label></td>
                                                            <td>
                                                                <asp:ImageButton ID="btnlbl14" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right; display: none" OnClick="btnlbl14_Click" /></td>
                                                            <td>
                                                                <div class="col-sm-4">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab3">
                                    <div class="lbBody" style="height: 200px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <asp:GridView ID="sg2" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="1500px" Font-Size="12px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg2_f2" HeaderText="Product" ItemStyle-Width="250" HeaderStyle-Width="250" />
                                                <asp:BoundField DataField="sg2_f3" HeaderText="Part No." ItemStyle-Width="100" HeaderStyle-Width="100" />
                                                <asp:BoundField DataField="sg2_f4" HeaderText="Drg No." ItemStyle-Width="100" HeaderStyle-Width="100" />
                                                <asp:BoundField DataField="sg2_f5" HeaderText="UOM" ItemStyle-Width="50" HeaderStyle-Width="50" />

                                                <asp:TemplateField>
                                                    <HeaderTemplate>Our Reel No</HeaderTemplate>
                                                    <HeaderStyle Width="120px" />
                                                    <ItemStyle Width="120px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t1" runat="server" Text='<%#Eval("sg2_t1") %>' ReadOnly="true" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle Width="80px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t3" runat="server" Text='<%#Eval("sg2_t3") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemStyle Width="80px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t5" runat="server" Text='<%#Eval("sg2_t5") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Mill Reel</HeaderTemplate>
                                                    <HeaderStyle Width="80px" />
                                                    <ItemStyle Width="80px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t6" runat="server" Text='<%#Eval("sg2_t6") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Moist Cut</HeaderTemplate>
                                                    <HeaderStyle Width="80px" />
                                                    <ItemStyle Width="80px" />
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t7" runat="server" Text='<%#Eval("sg2_t7") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg2_t9" runat="server" Text='<%#Eval("sg2_t9") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <div>
                        <div class="box-body">
                            <table style="width: 100%">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl24" runat="server" Text="lbl24" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl25" runat="server" Text="lbl25" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtlbl25" runat="server" Width="120px" Style="text-align: right"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl26" runat="server" Text="lbl26" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl27" runat="server" Text="lbl27" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtlbl27" runat="server" Width="120px" Style="text-align: right"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl28" runat="server" Text="lbl28" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl29" runat="server" Text="lbl29" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtlbl29" runat="server" Width="120px" Style="text-align: right"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl30" runat="server" Text="lbl30" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                    ...
                                    <td>
                                        <asp:Label ID="lbl31" runat="server" Text="lbl31" CssClass="col-sm-3 control-label"></asp:Label></td>
                                    <td>
                                        <div class="col-sm-3">
                                            <asp:TextBox ID="txtlbl31" runat="server" Width="120px" Style="text-align: right"></asp:TextBox>
    ...
    <asp:HiddenField ID="doc_qty" runat="server" />
