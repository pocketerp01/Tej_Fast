<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_type_new" CodeFile="om_type_new.aspx.cs" %>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtlbl7a" runat="server" Width="350px"></asp:TextBox>

                                    </td>
                                </tr>
                                <tr id="tdDD" runat="server">
                                    <td>
                                        <asp:Label ID="Label1" runat="server" Text="Description" CssClass="col-sm-2 control-label"></asp:Label></td>
                                    <td></td>
                                    <td colspan="2">
                                        <div class="col-sm-6">
                                            <asp:DropDownList ID="dd1" runat="server">
                                                ...
                                                <asp:ListItem Text="Foam" Value="2"></asp:ListItem>
                                                <asp:ListItem Text="Plastic" Value="3"></asp:ListItem>
                                                <asp:ListItem Text="FEA" Value="4"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            ...
                            <asp:TextBox ID="TextName" runat="server" Width="99%" placeholder="Name/Title of this Master "></asp:TextBox>
                        </div>
                    </div>
                </div>
