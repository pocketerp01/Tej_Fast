<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="mat_rcv_prd" CodeFile="mat_rcv_prd.aspx.cs" %>
    ...
    <script type="text/javascript">
        ...
        function gridviewScroll(gridId, gridDiv, headerFreeze, rowFreeze) {
            ...
            function calculateSum() {
                ...
                var gridCount = $("[id*=sg1].GridviewScrollItem2").length - 0; for (var i = 0; i < gridCount; i++) {
                    var Qty = $("input[id*=sg1_t3]");
                    var QtyWt = $("input[id*=sg1_t2]");
                    ...
                    if (document.getElementById('ContentPlaceHolder1_hf1').value == "XXX") {
                        AMOUNT = (QtyWt[i].value * 1) * (Rate[i].value * 1);
                    }
                    mqty = (Qty[i].value * 1)
            ...
            <table style="width: 100%">
                <tr>
                    <td>
                        ...
                        <button type="submit" id="btnSticker" class="btn btn-info" style="width: 100px;" runat="server" accesskey="k" onserverclick="btnSticker_ServerClick">Stic<u>k</u>er</button>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <asp:Button ID="btnCal" runat="server" Text="Cal(wt)" OnClick="btnCal_Click" />
                                </li>
                                <li>
