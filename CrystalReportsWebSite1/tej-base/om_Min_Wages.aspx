<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_Min_Wages" CodeFile="om_Min_Wages.aspx.cs" %>
<%--  --%>
                 ...
                 <div class="col-md-6" >
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label20" runat="server" Text="Eff_From" Font-Bold="true" CssClass="col-sm-3 control-label"></asp:Label>
                                ...
                                <asp:Label ID="Label21" runat="server" Text="Eff_upto" Font-Bold="true" CssClass="col-sm-2 control-label"></asp:Label>
                                <div class="col-sm-4">
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f5" HeaderText="Code" ItemStyle-Width="80px" />
                                                <asp:BoundField DataField="sg1_f6" HeaderText="Category" />
                                                 
                                                <asp:TemplateField ItemStyle-Width="15px" Visible="false">
                                                            <HeaderTemplate>Min_Wage</HeaderTemplate>
                                                            <ItemTemplate>
