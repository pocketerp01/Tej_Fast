<%@ Page Language="C#" AutoEventWireup="true" Inherits="prdemp1" CodeFile="prdemp1.aspx.cs" %>
...
<body>
    <form id="form1" runat="server" style="margin-top: 40px;">
        <section class="content">
            <div class="row">
                <div class="col-md-6" id="partyBox" runat="server" style="display: none">
                    <div>
                ...
                <div class="col-md-6" id="itemBox" runat="server" style="display: none">
                    <div>
                        <div class="box-header with-border">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtMcode" type="text" class="form-control clearable" runat="server" placeholder="Main Group" style="height: 28px" />
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <table>
                                        <tr style="vertical-align: top" class="col-lg-6">
                                            <td>
                                                <table class="nav-justified" style="vertical-align: top">
                                                    <tr style="vertical-align: top">
                                                        <td>
                                                            <span class="font_css">Date From &nbsp;&nbsp;</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr style="vertical-align: top">
                                                        <td>
                                                            <span class="font_css">Date To &nbsp;</span>
                                                            <td>
                                            ...
                                            <td style="vertical-align: top" class="col-lg-6">
                                                <table>
                                                    <tr style="vertical-align: top">
                                                        <td rowspan="2">
