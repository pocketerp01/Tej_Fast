<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_imp_reg" CodeFile="om_imp_reg.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        //        for (var k = 1; k < 32; k++) {
        //            var tn = 'ContentPlaceHolder1_sg1_sg1_t' + (k + 2) + '_' + i;
        //            var value1 = document.getElementById(tn).value;
        //            colTot += fill_zero(document.getElementById(tn).value) * 1;
        //        }

        //        // row total is total of total_qty field row wise
        //        rowTot += colTot;
        //        var tn2 = 'ContentPlaceHolder1_sg1_sg1_t2_' + i;
        //        document.getElementById(tn2).value = fill_zero(colTot);
        //    }
        //}
                                            ...
                                            <Columns>
                                               ...
                                               <asp:BoundField DataField="sg1_f11" HeaderText="sg1_f11" />
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_f13" runat="server" Text='<%#Eval("sg1_f13") %>'  Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                             ...
                                             <%--<asp:BoundField DataField="sg1_f13" HeaderText="sg1_f13"  />--%>
                                                ...
                                                <asp:TemplateField >
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t17" runat="server" ReadOnly="true" Text='<%#Eval("sg1_t17") %>'  Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t1</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' onkeypress="return isDecimalKey(event)" Width="100%" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t2</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' onkeypress="return isDecimalKey(event)" Width="100%" MaxLength="15" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                            ...
                                            <asp:MaskedEditExtender ID="Maskedit3" runat="server" Mask="99/99/9999"
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:CalendarExtender ID="sg1_t12_CalendarExtender" runat="server"
                                                Enabled="True" TargetControlID="sg1_t12"
                                                Format="dd/MM/yyyy">
                                            </asp:CalendarExtender>
                                            <asp:MaskedEditExtender ID="Maskedit4" runat="server" Mask="99/99/9999"
                                                MaskType="Date" TargetControlID="sg1_t12" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="sg3" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg3_t1" runat="server" Text='<%#Eval("sg3_t1") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg3_t2" runat="server" Text='<%#Eval("sg3_t2") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
