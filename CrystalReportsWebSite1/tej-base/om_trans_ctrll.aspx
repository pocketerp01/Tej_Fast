<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_trans_ctrll" CodeFile="om_trans_ctrll.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Team Code</label>
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Team Code" maxlength="10" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Asset Type</label>
                                <div class="col-sm-8">
                                    <select id="ddcamtype" runat="server" class="form-control">
                            ...
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Brand & Specs </label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Brand & Specs" maxlength="30" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Purpose</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">Duration</label>
                                <div class="col-sm-8">
                                    <select id="dddurn" runat="server" class="form-control">
...
<%--                <div class="col-md-6" id="divWork1" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Reasons :</label>
                            <asp:TextBox ID="txtWrkRmk" runat="server" Width="99%" TextMode="MultiLine" MaxLength="225" placeholder="Reasons"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Assigned :</label>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label11" runat="server" Text="1.Please Mention Brand,Sr.No. of the Equipment Correctly." CssClass="col-sm-2 control-label"></asp:Label>
