...
public partial class om_opt_mst : System.Web.UI.Page
{
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        {
            SQuery = "Select Opt_text,Opt_ID,Opt_Enable,Opt_Param,Opt_Param2,Opt_Excl,ent_by,to_char(ent_dt,'dd/mm/yyyy') as ent_Dt,EDT_BY,EDT_DT from " + frm_tabname + " where BRANCHCD!='DD' AND Type='OP' order by OPT_ID ";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
    ...
    {
        SQuery = "SELECT ACODE AS FSTR,ANAME,ACODE FROM FAMST ORDER BY ACODE";
    }
