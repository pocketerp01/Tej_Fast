<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_SOP" CodeFile="om_SOP.aspx.cs" %>
<%--  --%>
                    ...
                    <div>
                        <div class="box-body">
                             <div class="form-group">
                               <asp:Label ID="lbl7" runat="server" Text="lbl7" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Sub Group</asp:Label>
                                <div class="col-sm-1" >
                               <asp:ImageButton ID="btnlbl7" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl7_Click" />
                                ...
                                <div class="col-sm-3">
                                 <asp:TextBox ID="txtSubGrpCode" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                        </div>                                 
                                        <div class="col-sm-5">
                                        <asp:TextBox ID="txtSubGrpName" runat="server"  ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                        </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-sm-8">
                                        <asp:TextBox ID="txtwoline" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                        </div>
                            </div>

                            <div class="form-group">
                                <asp:Label ID="lbl4" runat="server" Text="lbl4" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Item_Name</asp:Label>
                                 <div class="col-sm-1">
                 ...
                 <div class="col-md-6">
                    <div>
                        <div class="box-body">
                           ...
                           <div class="form-group">                                
                               <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True">Ent_By</asp:Label>
                                <div class="col-sm-1">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab">
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="100%" Height="320px" Font-Size="13px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="5px">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnadd" runat="server" CommandName="SG1_ROW_ADD" ImageAlign="Middle" ImageUrl="../tej-base/images/Btn_addn.png" Width="20px" ToolTip="Insert a Row" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Del</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnrmv" runat="server" CommandName="SG1_RMV" ImageUrl="../tej-base/images/Btn_remn.png" Width="20px" ImageAlign="Middle" ToolTip="Remove a Row" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:BoundField DataField="sg1_srno" HeaderText="SrNo" ItemStyle-Width="80px" Visible="false"/>
                                                <asp:BoundField DataField="sg1_f1" HeaderText="Erp_Code"  ItemStyle-Width="80px" Visible="false"/>
                                                <asp:BoundField DataField="sg1_f2" HeaderText="Item Name" ItemStyle-Width="80px" Visible="false"/>
                                                <asp:BoundField DataField="sg1_f3" HeaderText="Part_Code" ItemStyle-Width="180px" Visible="false"/>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="550px" HeaderStyle-Width="90px">
                                                            <HeaderTemplate>SrNo</HeaderTemplate>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' Width="100%" MaxLength="5"></asp:TextBox>
                                                                  </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="1000px">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="100%" MaxLength="100" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" ReadOnly="true" onkeypress="return isDecimalKey(event)" onChange="calqty()" Text='<%#Eval("sg1_t3") %>' Width="100%" MaxLength="10"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-Width="80px" Visible="false">
                                                    <HeaderTemplate>WK3 Tgt</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' ReadOnly="true" Width="100%" maxlength="10" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
    ...
    <script>
        function calqty() {
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                gsm1 = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value));
                
                gsm2 = fill_zero(Number(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value));
                gsm3 = gsm1 * gsm2;
                TotalOutput += gsm3;
