...
public partial class om_vehi_log : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                doc_addl.Value = "1";
                lblheader.Text = "Vehicle Master Mgmt";
    ...
    public void set_Val()
    {
        ...
        switch (Prg_Id)
        {
            case "F97101":
                ...
                break;
            case "F75227":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "VH");
                typePopup = "N";
                break;
        }
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl4.Value = dt.Rows[i]["DCODE"].ToString().Trim();

                        ddcamtype.Value = dt.Rows[i]["vehi_type"].ToString().Trim();
                        txtlbl8.Value = dt.Rows[i]["vehi_spec"].ToString().Trim();
                        ddpurpose.Value = dt.Rows[i]["vehi_purpose"].ToString().Trim();
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            SQuery = "SELECT a.VEHNO as VEH_NO,to_char(A.VEHDT,'dd/mm/yyyy') as VEH_Dt,a.VEHI_type,a.VEHI_spec,a.DCODE as Team_member,a.VEHI_Purpose,a.Ent_by,a.Ent_Dt,a.app_by,a.app_Dt,to_chaR(a.VEHDT,'YYYYMMDD') as CAMDTD FROM " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type='" + frm_vty + "' and a.vehdt " + PrdRange + " order by a.vehno ";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
                ...
                try
                {
                    ...
                    else
                    {
                        if (save_it == "Y")
                        {
                            ...
                            fgen.msg("-", "AMSG", lblheader.Text + " " + frm_vnum + "'13'We appreciate your Entry to Tejaxo. Aiming for Systematic Working");
                        }
                        else
                        {
    ...
    void save_fun()
    {
        ...
        oporow["SRNO"] = i;
        oporow["DCODE"] = txtlbl4.Value.ToUpper().Trim();

        oporow["VEHI_type"] = ddcamtype.Value;
        oporow["VEHI_spec"] = txtlbl8.Value.ToUpper().Trim();

        oporow["VEHI_purpose"] = ddpurpose.Value;
