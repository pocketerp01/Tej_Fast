...
public partial class om_EPCG_Advlic_mast : System.Web.UI.Page
{
    ...
    public void set_Val()
    {
        ...
        typePopup = "N";
        tbl_id = "11";
        lblheader.Text = "EPCG Licence Master";
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "BTN_23":
                break;
            case "CURR":
                SQuery = "select trim(TYPE1) AS FSTR,TRIM(NAME) AS NAME ,TYPE1 as code from type WHERE ID='A' ORDER BY code";
                break;
            case "TACODE":
                //pop1
                col1 = "";
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Enter Validity Till !!"); return;
        }
        if (txtlbl4a.Text.Trim().Length < 2)
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Enter Last Date !!"); return;
        }

        if (txtlbl7.Text.Trim().Length < 2)
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Fill Export Obligation !!"); return;
        }
        if (txtlbl7a.Text.Trim().Length < 1)
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Fill No Of Times !!"); return;
        }
        ...
        if (txtlbl3a.Text.Trim().Length < 1)
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Fill Average_Export !!"); return;
        }
        if (txtlbl31.Text.Trim().Length < 2)
        {
            Checked_ok = "N";
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Please Fill Date Of Clearance!!"); return;
        }
        z = 0;
        for (int i = 0; i < sg1.Rows.Count; i++)
        {
            mq0 = ((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text.Trim();
            if (mq0.Length > 1)
            {
                z = 0;
                break;
        ...
        if (z > 0)
        {
            fgen.msg("-", "AMSG", "Please Fill Atleast One Item In The Grid");
            return;
        }
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl4.Text = Convert.ToDateTime(dt.Rows[i]["IMPVALID"].ToString().Trim()).ToString("dd/MM/yyyy");
                        txtlbl4a.Text = Convert.ToDateTime(dt.Rows[i]["EXPVALID"].ToString().Trim()).ToString("dd/MM/yyyy");
                        txtlbl7.Text = dt.Rows[i]["num1"].ToString().Trim();
                        txtlbl7a.Text = dt.Rows[i]["num2"].ToString().Trim();
                        txtlbl31.Text = Convert.ToDateTime(dt.Rows[i]["INVDATE"].ToString().Trim()).ToString("dd/MM/yyyy");
                        txtlbl3a.Text = dt.Rows[i]["num3"].ToString().Trim();
                        txtlbl2.Text = dt.Rows[i]["LICNO"].ToString().Trim();
                        txtlbl3.Text = dt.Rows[i]["LICDT"].ToString().Trim();
                        txtlbl5.Text = dt.Rows[i]["DESC_"].ToString().Trim();
                        ...
                        for (i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            sg1_dr["sg1_t5"] = dt.Rows[i]["CIF_VAL"].ToString().Trim();
                            sg1_dr["sg1_t6"] = dt.Rows[i]["WAST_PERC"].ToString().Trim();
                            sg1_dr["sg1_t8"] = dt.Rows[i]["WAST_PERC2"].ToString().Trim();
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            SQuery = "SELECT trim(a.vchnum) as doc_no,to_char(a.vchdate,'dd/mm/yyyy') as doc_dt,a.srno,a.licno as licence_no,to_char(a.licdt,'dd/mm/yyyy') as licence_dt, to_char(a.invdate,'dd/mm/yyyy') as date_of_clearance , to_char(a.impvalid,'dd/mm/yyyy') as validity_till, to_char(a.expvalid,'dd/mm/yyyy') as last_date ,A.CINAME as item_description,a.qtyin as qty,a.cif_val as cif_val_inr ,a.val_usd as cif_val_usd,a.num1 as export_obligation,a.num2 as no_of_times,a.num3 as average_exp,a.wast_perc as duty_saved_USD,a.wast_perc2 as duty_saved_inr,to_char(a.vchdate,'yyyymmdd') as vdd FROM " + frm_tabname + " a where a.branchcd='" + frm_mbr + "' and a.type='" + frm_vty + "' and vchdate " + PrdRange + " order by vdd desc,trim(a.vchnum) desc,a.srno";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
            fgen.Fn_open_rptlevel("Licence Master Entry for the Period " + fromdt + " to " + todt, frm_qstr);
        }
        else
        {
            Checked_ok = "Y";
    ...
    protected void sg1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            sg1.Columns[14].HeaderStyle.Width = 400;
            sg1.Columns[15].HeaderStyle.Width = 150;
            sg1.Columns[16].HeaderStyle.Width = 180;
            sg1.Columns[17].HeaderStyle.Width = 180;
            sg1.Columns[18].HeaderStyle.Width = 130;
            sg1.Columns[19].HeaderStyle.Width = 400;
            ...
            sg1.Columns[26].HeaderStyle.Width = 160;
            sg1.Columns[27].HeaderStyle.Width = 160;
        }
    }
    //------------------------------------------------------------------------------------
    ...
    protected void sg3_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            sg3.Columns[3].HeaderStyle.Width = 130;
            sg3.Columns[4].HeaderStyle.Width = 200;
            sg3.Columns[5].HeaderStyle.Width = 160;
            sg3.Columns[6].HeaderStyle.Width = 160;
            sg3.Columns[7].HeaderStyle.Width = 160;
            sg3.Columns[8].HeaderStyle.Width = 160;
            sg3.Columns[9].HeaderStyle.Width = 160;
            sg3.Columns[10].HeaderStyle.Width = 160;
            sg3.Columns[11].HeaderStyle.Width = 160;
            sg3.Columns[12].HeaderStyle.Width = 160;
            sg3.Columns[13].HeaderStyle.Width = 160;
        }
    }
    //------------------------------------------------------------------------------------
    ...
    void save_fun()
    {
        ...
        for (i = 0; i < sg1.Rows.Count - 1; i++)
        {
            if (((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text.Trim().Length > 1)
            {
                ...
                oporow["num1"] = fgen.make_double(txtlbl7.Text.Trim().ToUpper());//export obligation
                oporow["num2"] = fgen.make_double(txtlbl7a.Text.Trim().ToUpper()); //no of times
                oporow["LICNO"] = txtlbl2.Text.Trim().ToUpper();
                oporow["LICDT"] = txtlbl3.Text.Trim().ToUpper();
                oporow["INVDATE"] = txtlbl31.Text.Trim().ToUpper();//date of clearance
                oporow["num3"] = fgen.make_double(txtlbl3a.Text.Trim().ToUpper());//AVG EXP
                oporow["DESC_"] = txtlbl5.Text.Trim().ToUpper();
                ...
                oporow["SRNO"] = i + 1;
                oporow["ICODE"] = "-";
                oporow["CINAME"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text.Trim().ToUpper().Replace("&", "AND").Replace("'", " ").Replace("\"", " ");
                ...
                oporow["CIF_VAL"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t5")).Text.Trim().ToUpper());
                oporow["WAST_PERC"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t6")).Text.Trim().ToUpper());
                oporow["WAST_PERC2"] = fgen.make_double(((TextBox)sg1.Rows[i].FindControl("sg1_t8")).Text.Trim().ToUpper());
                oporow["ACODE"] = "-";
                oporow["BALQTY"] = 0;
    ...
    //------------------------------------------------------------------------------------
    protected void btncurr_Click(object sender, ImageClickEventArgs e)
    {
        hffield.Value = "CURR";
        make_qry_4_popup();
