<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_multi_empmas" CodeFile="om_multi_empmas.aspx.cs" %>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="div2" runat="server">
                                    <asp:ImageButton ID="btnRcode" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" style="visibility:hidden;width: 22px; float: right;" OnClick="btnRcode_Click" />
                                </div>
                                <div class="col-sm-3">
