<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_oms_folo" CodeFile="om_oms_folo.aspx.cs" %>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <button type="submit" id="btnTraExc" class="btn-success" style="width: 150px; float: right" runat="server" onserverclick="btnTraExc_ServerClick">OMS Plan</button></li>
                                <li>
                                    <button type="submit" id="btnCss" class="btn-danger" style="width: 100px; margin-left: 15px;" runat="server" onserverclick="btnCss_ServerClick">CSS Detail</button></li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' Width="100%" TextMode="MultiLine"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnInfo" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" CommandName="INFO" />
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' Width="100%" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t7</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnInfo2" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" CommandName="INFO2" />
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' Width="100%" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t8</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnInfo3" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" CommandName="INFO3" />
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' Width="100%" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnInfo4" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" CommandName="INFO4" />
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' Width="100%" Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="sg1_btnInfo5" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px;" CommandName="INFO5" />
                                                        <asp:TextBox ID="sg1_t10" runat="server" Text='<%#Eval("sg1_t10") %>' Width="100%" Visible="FALSE"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
