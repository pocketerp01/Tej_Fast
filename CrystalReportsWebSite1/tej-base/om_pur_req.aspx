<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_pur_req" CodeFile="om_pur_req.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function keyUpDownInTextBox() {
            $("input[type='text'], select").keydown(
function (event) {
    if ((event.keyCode == 40)) {
        if ($(this).parents("tr:visible").next() != null) {
            var nextTr = $(this).parents('tr:not([style*="display:none"])').next();
            var inputs = $(this).parents("tr:visible").eq(0).find("input[type='text'], select");
    ...
    if ((event.keyCode == 38)) {
        if ($(this).parents("tr:visible").next() != null) {
            var nextTr = $(this).parents("tr:visible").prev();
            var inputs = $(this).parents("tr:visible").eq(0).find("input[type='text'], select");
            var idx = inputs.index(this);
            nextTrinputs = nextTr.find("input[type='text'], select");
            if (nextTrinputs[idx] != null) {
        ...
        //    document.getElementsByName('text').style.color = 'red'
        //});
  ...
  padding-left: 10px;
  border-radius:0px;
  border-bottom-color:rgba(34, 148, 91);
  outline:none;
...
<%--                                <li>
                                ...
                                <li style="float: right">First Delivery Date will be copied in all line items if empty!! &nbsp;&nbsp;&nbsp;
                                </li>
                            </ul>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' onkeydown="openBox(this);" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
