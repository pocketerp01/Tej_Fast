<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_maint_Act" CodeFile="om_maint_Act.aspx.cs" %>
            ...
            <div class="row">
                         ...
                         <div class="box-body">
                             <div class="form-group">
                                ...
                                <div class="form-group"">
                                 ...
                                 <div class="col-sm-3">
                                     <asp:TextBox ID="txtlbl7" runat="server" Width="100%"  CssClass="form-control" Placeholder="DD/MM/YYYY" TextMode="Date" Font-Size="Small"></asp:TextBox>
                                 </div>
                                 <div class="col-sm-5">
                                     <asp:TextBox ID="txtlbl7a" runat="server" Width="100%" ReadOnly="False" CssClass="form-control" Placeholder="HH:MM:SS" ToolTip="Date is in 24 Hr Format" TextMode="Time"></asp:TextBox>
                                 </div>
                             </div>
                             <div class="form-group">
                ...
                <div class="col-md-6">
                    <div>
                         ...
                         <div class="box-body">
                             <div class="form-group">
                                 <asp:Label ID="lbl2" runat="server" Text="lbl2" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl2" Placeholder="DD/MM/YYYY" ReadOnly="true" runat="server" CssClass="form-control" Width="100%" Font-Size="Small"></asp:TextBox>
                                 </div>

                                  <asp:Label ID="lbl3" runat="server" Text="lbl3" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl3" ReadOnly="true" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                 </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl5" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                 </div>    
                                 
                                 <asp:Label ID="lbl6" runat="server" Text="lbl6" CssClass="col-sm-3 control-label" Font-Size="14px" Font-Bold="True"></asp:Label>
                                 <div class="col-sm-3">
                                 <asp:TextBox ID="txtlbl6" runat="server" CssClass="form-control" Width="100%"></asp:TextBox>
                                 </div>                            
                             </div>
                               <div class="form-group">
                                 <asp:Label ID="Label1" runat="server" Text="Plan Date" CssClass="col-sm-3 control-label"  Font-Size="14px" Font-Bold="True"></asp:Label>
                                 
                                 <div class="col-sm-9">
                                 <asp:TextBox ID="txtPlanDate" runat="server" CssClass="form-control" Width="100%" ReadOnly="true"></asp:TextBox>
                                 </div>                               
                             </div>
                           <asp:Label ID="lbl20" runat="server" Text="" ForeColor="Black" CssClass="col-sm-12 control-label" Visible="false" Font-Size="20px" Font-Bold="True"></asp:Label>                            
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                <li><a href="#DescTab" id="tab1" runat="server" aria-controls="DescTab" role="tab" data-toggle="tab">Items Consumed</a></li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>Add M/C</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t3" runat="server" Text='<%#Eval("sg1_t3") %>' onkeypress="return isDecimalKey(event)" Width="100%" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t6" runat="server" Text='<%#Eval("sg1_t6") %>' onkeypress="return isDecimalKey(event)" Width="100%" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t7" runat="server" Text='<%#Eval("sg1_t7") %>' onkeypress="return isDecimalKey(event)" Width="100%" ></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField Visible="false">
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:TextBox ID="txtrmk" runat="server"  MaxLength="300"  Width="99%" TextMode="MultiLine" placeholder="Remarks"></asp:TextBox>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                ...
                amt = qty * rate;
                tot += amt;
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t3_' + i).value = fill_zero(amt);
