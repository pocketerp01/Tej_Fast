<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_exp_reg" CodeFile="om_exp_reg.aspx.cs" %>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; box-shadow: 0 2px 4px rgba(127,127,127,.3);">
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f16" HeaderText="sg1_f16" />
                                                <asp:BoundField DataField="sg1_f17" HeaderText="sg1_f17" />
                                                <asp:BoundField DataField="sg1_f3" HeaderText="sg1_f3" />
                                                <asp:BoundField DataField="sg1_f4" HeaderText="sg1_f4" />
                                                <asp:BoundField DataField="sg1_f19" HeaderText="sg1_f19" />
                                                <asp:BoundField DataField="sg1_f20" HeaderText="sg1_f20" />
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_f8</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_f8" runat="server" Text='<%#Eval("sg1_f8") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_f9</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_f9" runat="server" Text='<%#Eval("sg1_f9") %>' Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="sg1_f18" HeaderText="sg1_f18" />
                                                  <asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="sg1_f11" HeaderText="sg1_f11" />
                                                <asp:BoundField DataField="sg1_f12" HeaderText="sg1_f12" />
                                              <%--  <asp:BoundField DataField="sg1_f13" HeaderText="sg1_f13" />--%>
                                                ...
                                                <asp:BoundField DataField="sg1_f14" HeaderText="sg1_f14" />
                                                <asp:BoundField DataField="sg1_f15" HeaderText="sg1_f15" />
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t1" runat="server" Text='<%#Eval("sg1_t1") %>' onkeypress="return isDecimalKey(event)" onkeyup="cal()" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t8" runat="server" Text='<%#Eval("sg1_t8") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t9</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                        <asp:CalendarExtender ID="sg1_t9_CalendarExtender" runat="server"
                                                            Enabled="True" TargetControlID="sg1_t9"
                                                            Format="dd/MM/yyyy">
                                                        </asp:CalendarExtender>
                                                        <asp:MaskedEditExtender ID="Maskedit4" runat="server" Mask="99/99/9999"
                                                            MaskType="Date" TargetControlID="sg1_t9" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t10</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t10" runat="server" Text='<%#Eval("sg1_t10") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                        <asp:CalendarExtender ID="sg1_t10_CalendarExtender" runat="server"
                                                            Enabled="True" TargetControlID="sg1_t10"
                                                            Format="dd/MM/yyyy">
                                                        </asp:CalendarExtender>
                                                        <asp:MaskedEditExtender ID="Maskedit5" runat="server" Mask="99/99/9999"
                                                            MaskType="Date" TargetControlID="sg1_t10" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>sg1_t15</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t15" runat="server" Text='<%#Eval("sg1_t15") %>' onkeypress="return isDecimalKey(event)" Width="100%"></asp:TextBox>
                                                        <asp:CalendarExtender ID="sg1_t15_CalendarExtender" runat="server"
                                                            Enabled="True" TargetControlID="sg1_t15"
                                                            Format="dd/MM/yyyy">
                                                        </asp:CalendarExtender>
                                                        <asp:MaskedEditExtender ID="Maskedit6" runat="server" Mask="99/99/9999"
                                                            MaskType="Date" TargetControlID="sg1_t15" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            ...
            for (var i = 0; i < grid - 1; i++) {
                ...
                amt_inr = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_f9_' + i).value) * 1 * fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t6_' + i).value) * 1;

                fob_sb = amt_inr - fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t1_' + i).value) * 1 - fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t2_' + i).value) * 1;

                fob_foreign = fill_zero(fob_sb) * 1 / fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t6_' + i).value) * 1;

                fob_inr = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t19_' + i).value) * 1 - fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t20_' + i).value) * 1 - fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t21_' + i).value) * 1 - fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t22_' + i).value) * 1;

                //    fob_brc = fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t19_' + i).value) * 1 / fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t18_' + i).value) * 1;
                fob_brc = fob_inr / fill_zero(document.getElementById('ContentPlaceHolder1_sg1_sg1_t18_' + i).value) * 1;

                document.getElementById('ContentPlaceHolder1_sg1_sg1_f8_' + i).value = amt_inr.toFixed(2);
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t7_' + i).value = fob_sb.toFixed(2);
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t27_' + i).value = fob_foreign.toFixed(2);
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t23_' + i).value = fob_inr.toFixed(2);
                document.getElementById('ContentPlaceHolder1_sg1_sg1_t24_' + i).value = fob_brc.toFixed(2);
            }
        }
