<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_attn_upl" CodeFile="om_attn_upl.aspx.cs" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-2 control-label" title="lbl1">Date</label>
                                <div class="col-sm-4">
                                    <input id="txtDate" type="date" class="form-control" runat="server" placeholder="Date" />
                                </div>
                                <div class="col-sm-4">
                                    <input id="txtMnth" class="form-control" runat="server" placeholder="Month" maxlength="4" />
                                </div>
                            </div>
                        </div>
                    </div>
