<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_task_act" CodeFile="om_task_act.aspx.cs" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">Client Code</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Client Code" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Client Name</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Name of Client" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Task Nature</label>
                                <div class="col-sm-8">
                                    <input id="ddModule" runat="server" class="form-control" type="text" placeholder="Task Nature" readonly="readonly" />
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl9" runat="server" class="form-control" type="text" placeholder="Importance" readonly="readonly" />

                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">Specific Module</label>
                                <div class="col-sm-8">
                                    <input id="ddIssueType" runat="server" class="form-control" placeholder="Specific Module" type="text" readonly="readonly" />

                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Assigned To</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" placeholder="Assigned To" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Client Person</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control" runat="server" placeholder="Client Person" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Client Phone</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Client Phone" readonly="readonly" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">Action No</label>
                                <div class="col-sm-8">
                                    <input id="txtDFno" runat="server" class="form-control" type="text" placeholder="Act No" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label12" runat="server" class="col-sm-4 control-label" title="lbl1">Action Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtDFdt" runat="server" class="form-control" type="text" placeholder="Act Dt" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Status</label>
                                <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-4 control-label" title="lbl1">Time (Minutes)</label>

                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" maxlength="3" placeholder="Time (Minutes)" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Action Mode</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Target_Days(If Pending)</label>
                                <div class="col-sm-8">
