<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_dsl_log" CodeFile="om_dsl_log.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">DSL_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="DSL No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">DSL Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="DSL Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Purpose Achieved" CssClass="col-sm-2 control-label"></asp:Label>                            
                            
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,200)" placeholder="Purpose Achieved by Client on Using This Software"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork1" runat="server">
                    <div>
                        <div class="box-body">
                            ...
                            <asp:TextBox ID="txtWrkRmk" runat="server" Width="99%" TextMode="MultiLine" MaxLength="225" placeholder="Pre Requisites Reqd to Run this Software"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Put to Use :</label>
