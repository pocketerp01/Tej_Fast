<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_multi_account_upt" CodeFile="om_multi_account_upt.aspx.cs" %>
                ...
                <tr>
                    ...
                    <td style="text-align:right">
                        ...
                        <button type="submit" id="btnvalidate" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnvalidate_ServerClick">Va<u>li</u>date</button>
                         <button type="submit" id="btnexport" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnexport_ServerClick">E<u>x</u>port</button>
