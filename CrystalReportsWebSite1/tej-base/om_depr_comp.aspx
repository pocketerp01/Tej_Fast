<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_depr_comp" CodeFile="om_depr_comp.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align:right">
                        ...
                        <button type="submit" id="btnprint" class="btn btn-info" style="width: 100px;" runat="server" accesskey="P" title="Please check control W1076" onserverclick="btnprint_ServerClick"><u>P</u>rint </button>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="lbl4" runat="server" class="col-sm-4 control-label" title="lbl1">Total Cost b/f</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label id="lbl7" runat="server" class="col-sm-4 control-label" title="lbl1">Total Addition</label>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtvchdate" placeholder="Date" CssClass="form-control" runat="server" ToolTip="Please enter Current depreciation date"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <asp:Button ID="btncal" runat="server" Height="30px" CssClass="bg-green-gradient" BackColor="Olive" style="width: 625px;" OnClick="btncal_Click" ToolTip="Assets existing before last dep dt will be classified as b/f,assets acquired between two dep dates will be addition.Depreciation will not be calculated for assets sold/consumed.Check data, if the desired asset is not reflected in the grid & match the data with depreciation chart." Text="Click Here to Auto Calculate Depreciation." />
                            </div>
                                    ...
                                    <div class="lbBody" id="gridDiv" style="color: White; height: 400px; overflow: auto; box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg1_f1" ControlStyle-Width="20px" HeaderText="DAYS" />
                                                <asp:BoundField DataField="sg1_f2" ControlStyle-Width="100px" HeaderText="DEPR/DAY" />
                                                <asp:BoundField DataField="sg1_f3" HeaderText="GRPCODE" />
                                                <asp:BoundField DataField="sg1_f4" ControlStyle-Width="500px" HeaderText="ASSET_NAME" />
                                                <asp:BoundField DataField="sg1_f5" ControlStyle-Width="50px" HeaderText="ASSET_CODE" />

                                                <asp:TemplateField>
                                                    <HeaderTemplate>TOTAL_COST(B/F)</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>CURRENT_ADDITION</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField Visible="false">
                                                    <HeaderTemplate>TOTAL_COST</HeaderTemplate>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField ItemStyle-Width="100px" Visible="false">
                                                    <HeaderTemplate>DELETION_YEAR</HeaderTemplate>
                                                    <ItemTemplate>
