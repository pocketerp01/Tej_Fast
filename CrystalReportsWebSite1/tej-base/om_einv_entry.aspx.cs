...
public partial class om_einv_entry : System.Web.UI.Page
{
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "TACODE":
                //pop1
                SQuery = "SELECT distinct a.ACODE AS FSTR,b.ANAME AS PARTY,a.ACODE AS CODE,b.ADDR1,b.ADDR2,b.staten as state,b.Pay_num,b.GST_no FROM somas a, FAMST b where a.branchcd='" + frm_mbr + "' and a.type='" + frm_vty + "' and trim(nvl(a.ICAT,'-'))!='Y'  and trim(nvl(a.app_by,'-'))!='-' and trim(A.acode)=trim(B.acode) and length(Trim(nvl(b.deac_by,'-')))<=1 ORDER BY aname ";
            ...
            switch (btnval)
            {
                ...
                case "SG1_ROW_ADD_E":
                    ...
                    for (int d = 0; d < dt.Rows.Count; d++)
                    {
                        ...
                        //sg1.Rows[Convert.ToInt32(hf1.Value)].Cells[1].Text = dt.Rows[d]["icode"].ToString().Trim();
