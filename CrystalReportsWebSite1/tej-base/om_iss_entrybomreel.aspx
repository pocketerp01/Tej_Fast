<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_iss_entrybomreel" CodeFile="om_iss_entrybomreel.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                   <td style="text-align: left">
                        ...
                        <button type="submit" id="btn_req" class="btn btn-info" style="width: 100px;" runat="server" accesskey="R" onserverclick="btn_req_ServerClick"><u>I</u>ssue ag. Req</button>                      
                        ...
                        <div class="box-body">
                            <table style="width: 100%">
                                ...
                                <tr>
                                 ...
                                 <td>
                                        <asp:ImageButton ID="ImageButtonb1" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlblbd7_Click" /></td>
                                 ...
                                 <td>
                                    ...
                                    <td>
                                        <div class="col-sm-6">
                                            <asp:TextBox ID="txtlblbd7a" runat="server" Width="350px" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:ImageButton ID="btnReqBy" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right" OnClick="btnReqBy_Click" Visible="false" />
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl8B" runat="server"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="panel panel-default">
                        <div id="Tabs" role="tabpanel">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li>
                                    <button type="submit" id="btnRead" class="btn-info" style="width: 100px; margin-left: 5px; margin-top: 3px;" runat="server" onserverclick="btnRead_ServerClick">Read Data</button>
                                </li>
                                <li id="postB">
                                    <button type="submit" id="btnPost" class="btn-info" style="width: 100px; margin-left: 60px; margin-top: 3px;" runat="server" onserverclick="btnPost_ServerClick">Post Reels</button>
                                </li>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t4" runat="server" Text='<%#Eval("sg1_t4") %>' Width="100%" onkeypress="openBox(this)"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="DescTab3">
                                    <div class="lbBody" style="box-shadow: 0 2px 4px rgba(127,127,127,.3); box-shadow: inset 0 0 3px #387bbe,0 0 9px #387bbe;">
                                        <fin:CoolGridView ID="sg2" runat="server" ForeColor="#333333"
                                            Style="background-color: #FFFFFF; color: White;" Width="100%" Height="250px" Font-Size="Smaller"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sg2_f1" HeaderText="ERPCode" HeaderStyle-Width="80px" />
                                                <asp:BoundField DataField="sg2_f2" HeaderText="Product" ItemStyle-Width="230" HeaderStyle-Width="230" />
                                                <asp:BoundField DataField="sg2_f3" HeaderText="Part No" HeaderStyle-Width="100px" />
                                                ...
                                                <asp:TemplateField>
                                                    <HeaderTemplate>Supplier_Reel</HeaderTemplate>
                                                    <ItemTemplate>
