<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_css_log" CodeFile="om_css_log.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right">
                        ...
                        <button type="submit" id="btnNewList" class="btn btn-info" style="width: 100px;" runat="server" accesskey="t" onserverclick="btnNewList_ServerClick">List<u>2</u></button>
                        <button type="submit" id="btncancel" class="btn btn-info" style="width: 100px;" runat="server" accesskey="c" onserverclick="btncancel_ServerClick"><u>C</u>ancel</button>
                        <button type="submit" id="btnMonthlyList" class="btn btn-info" style="width: 100px;" runat="server" accesskey="m" onserverclick="btnMonthlyList_ServerClick"><u>M</u>onthlyList</button>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">CSS_No</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="CSS No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">CSS Date</label>
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="date" class="form-control" runat="server" placeholder="CSS Date" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Customer Code</label>
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Client Code" maxlength="4" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="ddModule" runat="server" class="form-control">
                                        ...
                                        <option value="Itrain">Training_Internal</option>
                                        <option value="SYSTEM AUDIT(BACKUP)">SYSTEM AUDIT(BACKUP)</option>
                                        <option value="IMPROVEMENT MATRIX">IMPROVEMENT MATRIX</option>
                                        <option value="ACCOUNT DEPT. CHECKLIST">ACCOUNT DEPT. CHECKLIST</option>
                                        <option value="STORE DEPT. CHECKLIST">STORE DEPT. CHECKLIST</option>
                                        <option value="MD – TRAINING, HOD TRAINING">MD – TRAINING, HOD TRAINING</option>
                                        <option value="CLOUD BACKUP CHECKING">CLOUD BACKUP CHECKING</option>
                                        <option value="DATABASE TROUBLE SHOOTING">DATABASE TROUBLE SHOOTING</option>
                                        <option value="FINSYS INSTALLATIONS">FINSYS INSTALLATIONS</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Icon Name/Path</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Icon Name/Path" maxlength="30" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-4 control-label" title="lbl1">Request type</label>
                                <div class="col-sm-8">
                                    <select id="txtlbl9" runat="server" class="form-control">
                                        ...
                                        <option value="Implementation Customer">Implementation Customer</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label10" runat="server" class="col-sm-4 control-label" title="lbl1">First Time/Repeat Issue</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control" runat="server" placeholder="Mail ID" maxlength="40" />
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Client_Query" CssClass="col-sm-2 control-label"></asp:Label>
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,200)" placeholder="Query"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-6" id="divWork1" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label15" runat="server" class="col-sm-4 control-label" title="lbl1">Agent_Solution :</label>
                            <asp:TextBox ID="txtWrkRmk" runat="server" Width="100%" Height="75px" TextMode="MultiLine" MaxLength="225" placeholder="FIL_Agent_Remarks "></asp:TextBox>
                        </div>
                ...
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label25" runat="server" class="col-sm-4 control-label" title="lbl1">Start_Time</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtstarttime" runat="server" Width="100%" MaxLength="10" placeholder="Start Time" CssClass="form-control"></asp:TextBox>
                                    <cc1:MaskedEditExtender ID="Maskededitextender" runat="server" Mask="99:99" MaskType="Time"
                                        TargetControlID="txtstarttime" />
                                </div>

                                <label id="Label26" runat="server" class="col-sm-2 control-label" title="lbl1">End_Time</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtendtime" runat="server" Width="100%" MaxLength="10" placeholder="End Time" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtendtime_TextChanged"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Work_Done</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-2 control-label" title="lbl1">Time(min)</label>
                                <div class="col-sm-3">
                                    <input id="time_taken" type="text" class="form-control" runat="server" placeholder="Minutes" maxlength="3" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label23" runat="server" class="col-sm-4 control-label" title="lbl1">Ent_By</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="Txtent_by" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>

                                <label id="Label24" runat="server" class="col-sm-2 control-label" title="lbl1">Ent_Dt</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="Txtent_dt" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6" id="RootCause" runat="server">
                    <div>
                        <div class="box-body">

                            <div class="form-group">
                                <label id="Label21" runat="server" class="col-sm-4 control-label" title="lbl1">Root Cause</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtRoot" runat="server" Width="100%" MaxLength="250" placeholder="Root Cause" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label22" runat="server" class="col-sm-4 control-label" title="lbl1">Solved By</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtSolvedBy" runat="server" Width="100%" MaxLength="20" placeholder="Solved By" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                ...
                <div class="col-md-6" id="Action" runat="server">
                    <div>
                        <div class="box-body">

                            <div class="form-group">
                                <label id="Label18" runat="server" class="col-sm-4 control-label" title="lbl1">Corrective Action</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtCorrective" runat="server" Width="100%" MaxLength="250" placeholder="Corrective Action" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label19" runat="server" class="col-sm-4 control-label" title="lbl1">Preventive Action Suggestion</label>
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtPreventive" runat="server" Width="100%" MaxLength="250" placeholder="Preventive Action Suggestion" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                ...
                <div class="col-md-6" runat="server">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label17" runat="server" class="col-sm-4 control-label" title="lbl1">App_By</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtClrBy" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>

                                <label id="Label20" runat="server" class="col-sm-2 control-label" title="lbl1">App_Dt</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtClrDt" runat="server" Width="100%" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
