...
public partial class om_sale_schtg : System.Web.UI.Page
{
                ...
                case "SG1_ROW_ADD":
                    ...
                    if (ViewState["sg1"] != null)
                    {
                        ...
                        for (int d = 0; d < dt.Rows.Count; d++)
                        {
                            ...
                            // filling value in sg1_h1
                            // saving icode in this field
                            sg1_dr["sg1_h1"] = dt.Rows[d]["irate"].ToString().Trim();
    ...
    protected void btnlbl7_Click(object sender, ImageClickEventArgs e)
    {
        ...
        make_qry_4_popup();
        fgen.Fn_open_sseek("Select Sales Order type ", frm_qstr);
    }
    //------------------------------------------------------------------------------------
    void save_fun()
    {
        ...
        for (i = 0; i < sg1.Rows.Count - 0; i++)
        {
            if (sg1.Rows[i].Cells[13].Text.Length > 2)
            {
                ...
                oporow["irate"] = sg1.Rows[i].Cells[0].Text.Trim().toDouble();
                ...
                oporow["sodate"] = sg1.Rows[i].Cells[16].Text.Trim().Substring(7, 10);
