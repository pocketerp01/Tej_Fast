<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="so_ent" CodeFile="so_ent.aspx.cs" %>
            ...
            <table style="width: 100%">
                <tr>
                    <td>
                        ...
                        <button type="submit" id="btnquotation" class="btn btn-info" style="width: 100px;" runat="server" onserverclick="btnquotation_ServerClick">Quotation</button>
                        <button type="submit" id="btnEnq" class="btn btn-info" style="width: 100px;" runat="server" onserverclick="btnEnq_ServerClick">Enquiry</button>
                        <button type="submit" id="btnProp" class="btn btn-info" style="width: 100px;" runat="server" onserverclick="btnProp_ServerClick">Proposal</button>
                                        ...
                                        <fin:CoolGridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t2" runat="server" Text='<%#Eval("sg1_t2") %>' Width="120px" TextMode="Date" CssClass="form-control" Height="25px"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t9" runat="server" Text='<%#Eval("sg1_t9") %>' onkeypress="return isDecimalKey(event)" oncontextmenu="return false;" onpaste="return false" Width="100%" onkeyup="calculateSum()" CssClass="form-control" Height="25px"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t14" runat="server" Text='<%#Eval("sg1_t14") %>' Width="100%" CssClass="form-control" Height="25px"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
