<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="om_Samp_Req" CodeFile="om_Samp_Req.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Raw_Matl_Name</label>
                                ...
                                <div class="col-sm-3" style="display:none;">
                                    ...
                                    <input id="txtunit" type="text" class="form-control" runat="server" readonly="readonly"  />
                                </div>
                                <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                              <label id="Label32" runat="server" class="col-sm-4  control-label" title="lbl1">Total_Quantity_Recieved</label>
                                <div class="col-sm-8">
                                    <input id="txt_qty_rcv"  class="form-control" runat="server" readonly="true" maxlength="15" />
                                 </div>
                            ...
                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4  control-label" title="lbl1">Sample_Taken</label>
                                 <div class="col-sm-8">
                                    <input id="txt_sample_tak"  class="form-control" runat="server"  maxlength="15" />
                                 </div>
                            </div>
