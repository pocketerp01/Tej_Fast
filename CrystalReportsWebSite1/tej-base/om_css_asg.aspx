<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_css_asg" CodeFile="om_css_asg.aspx.cs" %>
        ...
        <section class="content">
            <div class="row">
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtvchdate" type="text" class="form-control" runat="server" placeholder="CSS Date" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-4 control-label" title="lbl1">Customer Code</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Client Code" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-4 control-label" title="lbl1">Module Name</label>
                                <div class="col-sm-8">
                                    <input id="ddModule" runat="server" class="form-control" type="text" placeholder="Module Name" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-4 control-label" title="lbl1">Icon Name/Path</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Icon Name/Path" readonly="readonly" />
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl9" runat="server" class="form-control" type="text" placeholder="Request type" readonly="readonly" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input id="ddIssueType" runat="server" class="form-control" placeholder="First Time/Repeat Issue" type="text" readonly="readonly" />
                ...
                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="Label17" runat="server" Text="Client Remarks" CssClass="col-sm-2 control-label"></asp:Label>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label11" runat="server" class="col-sm-4 control-label" title="lbl1">Asg No</label>
                                <div class="col-sm-8">
                                    <input id="txtDFno" runat="server" class="form-control" type="text" placeholder="Assign No" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label12" runat="server" class="col-sm-4 control-label" title="lbl1">Asg Dt</label>
                                <div class="col-sm-8">
                                    <input id="txtDFdt" runat="server" class="form-control" type="text" placeholder="Assign Dt" readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="ddAnalysis" runat="server" class="form-control">
                                        ...
                                        <option value="Mktg Support">Mktg Support</option>
                                        <option value="CRM Support">CRM Support</option>
                                        <option value="Impl Support">Impl Support</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label13" runat="server" class="col-sm-3 control-label" title="lbl1">Assign To</label>
                                <div class="col-sm-1">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtAssgn" runat="server" class="form-control" type="text" placeholder="Assign to" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">CSS Status</label>
                                <div class="col-sm-8">
                                    <select id="ddStatus" runat="server" class="form-control">
                                        <option value="Assigned/ Under Processing">Assigned/ Under Processing</option>
                                        <option value="Further explanation required">Further explanation required</option>
                                        <option value="Confirmation Required">Confirmation Required</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label16" runat="server" class="col-sm-4 control-label" title="lbl1">Resolution Reqd</label>
                                <div class="col-sm-8">
                                    <select id="ddresolution" runat="server" class="form-control">
                                        <option value="4">4 WrkHrs</option>
                                        <option value="8">8 WrkHrs</option>
                                        <option value="16">16 WrkHrs</option>
                                        <option value="24">24 WrkHrs</option>
                                        <option value="24">32 WrkHrs</option>
                                        <option value="24">40 WrkHrs</option>
                                    </select>
                                </div>
                            </div>
