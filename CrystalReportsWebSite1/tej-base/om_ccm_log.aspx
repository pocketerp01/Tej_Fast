<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_ccm_log" CodeFile="om_ccm_log.aspx.cs" %>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label9" runat="server" class="col-sm-3 control-label" title="lbl1">Customer_Name</label>
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl4" type="text" class="form-control" runat="server" placeholder="Customer Name" maxlength="40" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label5" runat="server" class="col-sm-3 control-label" title="lbl1">Complaint_Type</label>
                                <div class="col-sm-1" id="divctype" runat="server">
                                   <asp:ImageButton ID="btnctype" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnCtyp_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlblctyp" type="text" class="form-control" runat="server" placeholder="Complaint Type" maxlength="40" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label6" runat="server" class="col-sm-3 control-label" title="lbl1">Item Details</label>
                                <div class="col-sm-1" id="div2" runat="server">
                                   <asp:ImageButton ID="btnitmc" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnitmc_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Item Details" maxlength="60" />
                                </div>
                            </div>
...
<%--                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl8" type="text" class="form-control" runat="server" placeholder="Product" maxlength="30" />
                                </div>
                            </div>--%>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label7" runat="server" class="col-sm-3 control-label" title="lbl1">Complaint_Category</label>
                                <div class="col-sm-1" id="div1" runat="server">
                                   <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnCatg_Click" />
                                </div>
                                <div class="col-sm-8">
                                    <input id="txtlbl9" type="text" class="form-control" runat="server" placeholder="Complaint Category" maxlength="40" />
                                </div>
                            </div>
...
<%--                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="txtlbl9" runat="server" class="form-control">
                                        <option value="CATG A">Catg A</option>
                                        <option value="CATG B">Catg B</option>
                                    </select>
                                </div>
                            </div>--%>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="Lsubject" runat="server" class="form-control">
...
<%--                <div class="col-md-12">
                    <div>
                        <div class="box-body">
                            <asp:Label ID="lbltxtrmk" runat="server" Text="Client Remarks" CssClass="col-sm-2 control-label"></asp:Label>                            
                            <asp:TextBox ID="txtrmk" runat="server" Width="99%" TextMode="MultiLine" onkeyup="max_length(this,200)" placeholder="Customer Remarks"></asp:TextBox>
                        </div>
                    </div>
                </div>
--%>
                ...
                <div class="col-md-6" id="div4" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="lbltxtinv" runat="server" class="col-sm-4 control-label" title="lbl1">Invoice Ref :</label>
                            <asp:TextBox ID="txtinv" runat="server" Width="99%"  MaxLength="30" placeholder="Invoice Ref "></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6" id="divWork" runat="server">
                    <div>
                        <div class="box-body">
                            <label id="Label14" runat="server" class="col-sm-4 control-label" title="lbl1">Visit Reqd?</label>
    ...
    <asp:HiddenField ID="doc_acode" runat="server" />
    <asp:HiddenField ID="doc_icode" runat="server" />
