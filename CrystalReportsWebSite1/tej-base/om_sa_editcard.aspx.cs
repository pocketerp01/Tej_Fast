...
public partial class om_sa_editcard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                lbl4.Visible = false; btnlbl4.Visible = false; txtlbl4.Visible = false; txtlbl4a.Visible = false;
    ...
    public void set_Val()
    {
        ...
        if (frm_formID == "F20214")
        {
            frm_tabname = "WB_SA_CARD";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "10");
        }
        if (frm_formID == "F20215")
        {
            frm_tabname = "WB_SA_ROUTE";
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            default:
                ...
                {
                    if (frm_formID == "F20214")
                        SQuery = "select trim(vchnum)||to_char(vchdate,'dd/mm/yyyy') as fstr,type,vchnum,to_char(vchdate,'dd/mm/yyyy') as vchdate,location,card_no,remarks,ent_by,ent_dt,to_char(vchdate,'yyyymmdd') as vdd from " + frm_tabname + " where branchcd='" + frm_mbr + "' and type='" + frm_vty + "' and vchdate " + DateRange + " order by vdd desc, vchnum desc";
                    if (frm_formID == "F20215")
                        SQuery = "select trim(vchnum)||to_char(vchdate,'dd/mm/yyyy') as fstr,type,vchnum,to_char(vchdate,'dd/mm/yyyy') as vchdate,ROUTE_NAME,card_no,ent_by,ent_dt,to_char(vchdate,'yyyymmdd') as vdd from " + frm_tabname + " where branchcd='" + frm_mbr + "' and type='" + frm_vty + "' and vchdate " + DateRange + " order by vdd desc, vchnum desc";
                }
                break;
        }
    ...
    protected void btnhideF_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "D")
        {
            ...
            if (col1 == "Y")
            {
                ...
                fgen.save_info(frm_qstr, frm_cocd, frm_mbr, fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL3"), fgenMV.Fn_Get_Mvar(frm_qstr, "U_COL4"), frm_uname, frm_vty, lblheader.Text.Trim() + " Deleted");
        ...
        else
        {
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    clearctrl();
                    string cond = "";
                    cond = frm_formID == "F20215" ? "order by srno" : "";
                    SQuery = "select * from " + frm_tabname + " where branchcd='" + frm_mbr + "' and type='" + frm_vty + "' and trim(vchnum)||to_char(vchdate,'dd/mm/yyyy')='" + col1 + "' " + cond + " ";
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        for (i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            sg1_dr["sg1_h9"] = "-";
                            sg1_dr["sg1_h10"] = "-";
                            sg1_dr["sg1_f1"] = dt.Rows[i]["vchnum"].ToString().Trim();
                            sg1_dr["sg1_f2"] = dt.Rows[i]["vchdate"].ToString().Trim();
                            sg1_dr["sg1_f3"] = dt.Rows[i]["type"].ToString().Trim();
                            sg1_dr["sg1_f4"] = dt.Rows[i]["ent_by"].ToString().Trim();
                            sg1_dr["sg1_f5"] = dt.Rows[i]["ent_dt"].ToString().Trim();

                            if (frm_formID == "F20214")
                            {
                                sg1_dr["sg1_t1"] = dt.Rows[i]["location"].ToString().Trim();
                                sg1_dr["sg1_t2"] = dt.Rows[i]["card_no"].ToString().Trim();
                            ...
                            {
                                sg1_dr["sg1_t1"] = dt.Rows[i]["location"].ToString().Trim();
                                sg1_dr["sg1_t2"] = dt.Rows[i]["ROUTE_NAME"].ToString().Trim();
                                sg1_dr["sg1_t3"] = dt.Rows[i]["CARD_NO"].ToString().Trim();
                                sg1_dr["sg1_t4"] = dt.Rows[i]["TIME"].ToString().Trim();
                            }
                            sg1_dr["sg1_t5"] = "-";
                            sg1_dr["sg1_t6"] = "-";
                            sg1_dr["sg1_t7"] = "-";
                ...
                case "SG1_ROW_ADD":
                    ...
                    if (ViewState["sg1"] != null)
                    {
                        ...
                        dt = new DataTable();
                        //if (col1.Length > 2)
                        SQuery = "SELECT DISTINCT MCHNAME,MCHCODE,spec5 as Inst_No,MAINTDT,maintmth FROM PMAINT where branchcd='" + frm_mbr + "' and type='10' and trim(mchcode)=" + col1 + " order by MCHNAME";
    ...
    protected void btnhideF_s_Click(object sender, EventArgs e)
    {
        ...
        if (hffield.Value == "List")
        {
            ...
            Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
            SQuery = "select trim(branchcd) as branch_code,type,location,route_name,card_no,time as tgt_time,ent_by as entry_by,to_char(ent_dt,'dd/mm/yyyy') as entry_date from " + frm_tabname + " where branchcd='" + frm_mbr + "' and type='" + frm_vty + "' and vchdate " + PrdRange + " order by IS_NUMBER(REPLACE(LOCATION,'CH','')),route_name";
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
        ...
        else if (hffield.Value == "Print_E")
        {
            ...
            fgen.drillQuery(0, "select Equipment_Code||Equipment_Name as fstr,'-' as gstr,Equipment_Name,Equipment_Code,sum(target) as Target,sum(achvd) as Acvd,decode(sum(target)-sum(achvd),0,'OK','Not OK') as Status  from (select Mchname as Equipment_Name,Mchcode as Equipment_Code,1 as target,0 as achvd from pmaint where branchcd='" + frm_mbr + "' and substr(type,1,2)='66' and vchdate " + PrdRange + " union all select Mchname as Equipment_Name,Mchcode as Equipment_Code,0 as target,1 as achvd from pmaint where branchcd='" + frm_mbr + "' and substr(type,1,2)='20' and vchdate " + PrdRange + ") group by  Equipment_Name,Equipment_Code order by Equipment_Name", frm_qstr);
            fgen.drillQuery(1, "Select '-' as fstr,mchcode||mchname as gstr,Mchname as Equipment_Name,Mchcode as Equipment_Code,Maintdt as Plan_On,Maintby as Done_By,Maintamt as Amount from Pmaint where branchcd='" + frm_mbr + "'  and type='66' order by vchdate,vchnum", frm_qstr);
            fgenMV.Fn_Set_Mvar(frm_qstr, "U_SEEKSQL", SQuery);
            string header_n = "Equipment/ Machines Whose Maintenance Plan";
        ...
        else
        {
            ...
            string last_entdt;
            last_entdt = fgen.seek_iname(frm_qstr, frm_cocd, "select vchnum as Doc_no from " + frm_tabname + " where branchcd='" + frm_mbr + "' and type='" + lbl1a.Text + "' and trim(vchnum)!='" + txtvchnum.Text.Trim() + "'", "Doc_no");
    ...
    protected void sg1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //sg1.HeaderRow.Cells[10].Style["display"] = "none"; e.Row.Cells[10].Style["display"] = "none";
            //sg1.HeaderRow.Cells[11].Style["display"] = "none"; e.Row.Cells[11].Style["display"] = "none";
    ...
    void save_fun()
    {
        ...
        for (i = 0; i < sg1.Rows.Count - 1; i++)
        {
            if (((TextBox)sg1.Rows[i].FindControl("sg1_t1")).Text.Trim().Length > 1)
            {
                ...
                if (frm_formID == "F20214")
                {
                    oporow["location"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t1")).Text.Trim().ToUpper();
                    oporow["card_no"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text.Trim().ToUpper();
                    oporow["Remarks"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t3")).Text.Trim();
                }
                if (frm_formID == "F20215")
                {
                    oporow["location"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t1")).Text.Trim().ToUpper();
                    oporow["ROUTE_NAME"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t2")).Text.Trim().ToUpper();
                    oporow["card_no"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t3")).Text.Trim().ToUpper();
                    oporow["TIME"] = ((TextBox)sg1.Rows[i].FindControl("sg1_t4")).Text.Trim();
                    oporow["srno"] = (i + 1);
                }
