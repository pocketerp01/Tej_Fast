...
public partial class om_multi_item : System.Web.UI.Page
{
    ...
    void save_fun()
    {
        ...
        if (dtW != null)
        {
            ...
            {
                string chkname1 = "";
                string tcode = gr1["ERP_CODE"].ToString().Trim();
                try
                {
                    if (tcode.Length < 8)
                    {
                        tcode = fgen.padlc(Convert.ToInt64(gr1["ERP_CODE"].ToString().Trim()), 8);
                    }
                }
                catch (Exception err)
                {
                    tcode = gr1["ERP_CODE"].ToString().Trim();
                }
                chkname1 = fgen.seek_iname(frm_qstr, frm_cocd, "select icode from item where TRIM(icode)='" + tcode + "'", "icode");
                if (chkname1 != "0")
                {
                    fgen.execute_cmd(frm_qstr, frm_cocd, "update ITEM set hscode='" + gr1["HSCODE"].ToString().Trim().ToUpper() + "'" +
                        ",cpartno='" + gr1["PART_NO"].ToString().Trim().ToUpper() + "',cdrgno='" + gr1["DRG_NO"].ToString().Trim().ToUpper() + "'," +
                        "iname='" + gr1["ITEM_NAME"].ToString().Trim().ToUpper() + "',ciname='" + gr1["ITEM_NAME_CUST"].ToString().Trim().ToUpper() + "'," +
                        "unit='" + gr1["PRIMARY_UNIT"].ToString().Trim().ToUpper() + "',no_proc='" + gr1["SECONDARY_UNIT"].ToString().Trim().ToUpper() + "'" +
                        ",servicable='" + gr1["CRITICAL_ITEM"].ToString().Trim().ToUpper() + "',irate='" + gr1["std_rate"].ToString().Trim().ToUpper() + "'" +
                        ",packsize='" + gr1["STANDARD_PACKING"].ToString().Trim().ToUpper() + "',default_us='" + gr1["SHELF_LIFE_DAYS"].ToString().Trim().ToUpper() + "'" +
                        ",abc_class='" + gr1["A_B_CCLASS"].ToString().Trim().ToUpper() + "',binno='" + gr1["LOCN"].ToString().Trim().ToUpper() + "'," +
                        "icat='" + gr1["CAT"].ToString().Trim().ToUpper() + "',maker='" + gr1["BRAND_OR_REF"].ToString().Trim().ToUpper() + "'," +
                        "jwq_ctrl='-',iweight='" + gr1["GROSS_WT"].ToString().Trim().ToUpper() + "',wt_net='" + gr1["NET_WT"].ToString().Trim().ToUpper() + "'," +
                        "iqd='0',labrchg='" + gr1["LABR_CHG"].ToString().Trim().ToUpper() + "',edt_by='" + frm_uname + "',edt_dt=to_date('" + vardate + "','dd/mm/yyyy')" +
                        ",imagef='" + gr1["IMAGE"].ToString().Trim().ToUpper() + "' " +
                        "where icode='" + chkname1.Trim().ToUpper() + "'");
                }
                else
                {
                    string icode = "";
                    if (Prg_Id == "F99155")
                    {
                        icode = gr1["subgp"].ToString().Trim();
                        var chk_code = fgen.seek_iname(frm_qstr, frm_cocd, "select max(icode) as existcd from item where " +
                          "branchcd!='DD' and substr(icode,1,4)='" + icode + "'  ", "existcd");
                        if (chk_code == icode)
                        {
                        ...
                        else
                        {
                            ...
                            fgen.execute_cmd(frm_qstr, frm_cocd, "insert into ITEM (branchcd,icode,hscode,cpartno,cdrgno,iname,ciname,unit," +
                            "no_proc,servicable,irate,packsize,default_us,abc_class,binno,icat,maker,jwq_ctrl,iweight,wt_net,iqd,labrchg,eNt_by,eNt_dt,edt_by,edt_dt,IMAGEF,no_proc) values " +
                            "('00','" + icode + "','" + gr1["HSCODE"].ToString().Trim().ToUpper() + "','" + gr1["PART_NO"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["DRG_NO"].ToString().Trim().ToUpper() + "','" + gr1["ITEM_NAME"].ToString().Trim().ToUpper() + "','" + gr1["ITEM_NAME_CUST"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["PRIMARY_UNIT"].ToString().Trim().ToUpper() + "','" + gr1["SECONDARY_UNIT"].ToString().Trim().ToUpper() + "','" + gr1["CRITICAL_ITEM"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["std_rate"].ToString().Trim().ToUpper() + "','" + gr1["STANDARD_PACKING"].ToString().Trim().ToUpper() + "','" + gr1["SHELF_LIFE_DAYS"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["A_B_CCLASS"].ToString().Trim().ToUpper() + "','" + gr1["LOCN"].ToString().Trim().ToUpper() + "','" + gr1["CAT"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["BRAND_OR_REF"].ToString().Trim().ToUpper() + "','-','" + gr1["GROSS_WT"].ToString().Trim().ToUpper() + "','" + gr1["NET_WT"].ToString().Trim().ToUpper() + "','0'" +
                            ",'" + gr1["LABR_CHG"].ToString().Trim().ToUpper() + "','" + frm_uname + "',to_date('" + vardate + "','dd/mm/yyyy'),'-',to_date('" + vardate + "','dd/mm/yyyy')" +
                            ",'" + gr1["IMAGE"].ToString().Trim().ToUpper() + "','" + gr1["AC_ACODE"].ToString().Trim().ToUpper() + "')");
                    ...
                    {
                        string chk_code = "";
                        string scode = gr1["subgp"].ToString().Trim();
                        try
                        {
                            if (scode.Length < 4)
                            {
                                tcode = fgen.padlc(Convert.ToInt64(gr1["subgp"].ToString().Trim()), 8);
                            }
                        }
                        catch (Exception err)
                        {
                            scode = gr1["subgp"].ToString().Trim();
                        }
                        chk_code = fgen.seek_iname(frm_qstr, frm_cocd, "select max(icode) as existcd from item where " +
                            "branchcd!='DD' and substr(icode,1,4)='" + scode + "' and length(Trim(icode))>4  ", "existcd");
                        if (chk_code == "0")
                        {
                            icode = scode.ToString().Trim() + "0001";
                        }
                        else
                        {
                            icode = fgen.seek_iname(frm_qstr, frm_cocd, "select lpad(trim(max(icode)+1),8,'0') as existcd from item where " +
                                "branchcd!='DD' and substr(icode,1,4)='" + scode + "' and length(Trim(icode))>4  ", "existcd");
                        }


                        string cpcheck = fgen.seek_iname(frm_qstr, frm_cocd, "select icode from item where TRIM(cpartno)='" + gr1["PART_NO"].ToString().Trim() + "'", "icode");
                        if (cpcheck == "0")
                        {
                            fgen.execute_cmd(frm_qstr, frm_cocd, "insert into ITEM (branchcd,icode,hscode,cpartno,cdrgno,iname,ciname,unit," +
                            "no_proc,servicable,irate,packsize,default_us,abc_class,binno,icat,maker,jwq_ctrl,iweight,wt_net,iqd,labrchg,eNt_by,eNt_dt,edt_by,edt_dt,IMAGEF) values " +
                            "('00','" + icode + "','" + gr1["HSCODE"].ToString().Trim().ToUpper() + "','" + gr1["PART_NO"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["DRG_NO"].ToString().Trim().ToUpper() + "','" + gr1["ITEM_NAME"].ToString().Trim().ToUpper() + "','" + gr1["ITEM_NAME_CUST"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["PRIMARY_UNIT"].ToString().Trim().ToUpper() + "','" + gr1["SECONDARY_UNIT"].ToString().Trim().ToUpper() + "','" + gr1["CRITICAL_ITEM"].ToString().Trim().ToUpper() + "'" +
                            ",'" + gr1["std_rate"].ToString().Trim().ToUpper() + "','" + gr1["STANDARD_PACKING"].ToString().Trim().ToUpper() + "','" + gr1["SHELF_LIFE_DAYS"].ToString().Trim().ToUpper() + "'" +
                            ...
                            ",'" + gr1["BRAND_OR_REF"].ToString().Trim().ToUpper() + "','-','" + gr1["GROSS_WT"].ToString().Trim().ToUpper() + "','" + gr1["NET_WT"].ToString().Trim().ToUpper() + "','0'" +
                            ",'" + gr1["LABR_CHG"].ToString().Trim().ToUpper() + "','" + frm_uname + "',to_date('" + vardate + "','dd/mm/yyyy'),'-',to_date('" + vardate + "','dd/mm/yyyy')" +
                            ",'" + gr1["IMAGE"].ToString().Trim().ToUpper() + "')");

                            SQuery = "insert into itembal(branchcd,icode,br_icode) values('00','" + icode + "','00" + icode + "')";
    ...
    */
    ...
    protected void btnupload_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            if (ext == ".xls")
            {
                ...
                //excelConString = @"Provider=Microsoft.ACE.OLEDB.16.0;Data Source=" + filesavepath + ";Extended Properties=\"Excel 16.0 Xml;HDR=YES;";
            ...
            try
            {
                ...
                dtn.Columns.Add("ERP_CODE", typeof(string));
                dtn.Columns.Add("IMAGE", typeof(string));
                dtn.Columns.Add("AC_ACODE", typeof(string));
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    if ("1" == "1")
                    {
                        ...
                        drn["ERP_CODE"] = dr["ERP_CODE"].ToString().Trim();
                        drn["IMAGE"] = dr["IMAGE"].ToString().Trim();
                        drn["AC_ACODE"] = dr["AC_ACODE"].ToString().Trim();
                        drn["dtsrno"] = count1;
    ...
    protected void btnhelp_ServerClick(object sender, EventArgs e)
    {
        ...
        dt1 = fgen.getdata(frm_qstr, frm_cocd, "SELECT 'SRNO' AS SRNO,'MAINGP' AS MAINGP,'SUBGP' AS SUBGP," +
            ...
            "AS  STANDARD_PACKING,'SHELF_LIFE_DAYS' AS SHELF_LIFE_DAYS, 'LABR_CHG' AS LABR_CHG, 'ERP_CODE' AS ERP_CODE,'IMAGE' AS IMAGE,'AC_ACODE' AS AC_ACODE FROM DUAL");
