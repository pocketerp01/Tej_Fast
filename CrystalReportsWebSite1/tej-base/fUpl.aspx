<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" Inherits="fUpl" CodeFile="fUpl.aspx.cs" %>
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnAcode" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;width: 22px; float: right;" OnClick="btnAcode_Click" />
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1" id="div2" runat="server">
                                    <asp:ImageButton ID="btnRcode" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;width: 22px; float: right;" OnClick="btnRcode_Click"  />
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <asp:ImageButton ID="btnDNCN" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;width: 22px; float: right;" OnClick="btnDNCN_Click" />
                                </div>
                                <div class="col-sm-2">
