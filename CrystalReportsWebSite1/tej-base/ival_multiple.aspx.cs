...
public partial class ival_multiple : System.Web.UI.Page
{
            ...
            if (Request.QueryString["STR"].Length > 0)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (Filled == "Y")
                    {
                        ...
                        tk10.Text = fgenMV.Fn_Get_Mvar(frm_qstr, "M_COL10").ToString().Trim();
                    }
                }
                ...
                tk10.Attributes.Add("autocomplete", "off");
                tk1.Focus();               
            }
        }
    }
    protected void btnok_ServerClick(object sender, EventArgs e)
    {
        ...
        IGST = fgen.make_double(tk3.Text);
        CGST = fgen.make_double(tk1.Text);

        if (IGST > 0 && CGST > 0)
        {
            lblerr.Text = "Please Fill Value Either For CGST/SGST Or IGST";
            return;
        }
        ...
        fgenMV.Fn_Set_Mvar(frm_qstr, "M_COL10", tk10.Text.Trim());
