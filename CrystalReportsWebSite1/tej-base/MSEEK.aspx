<%@ Page Language="C#" AutoEventWireup="True" Inherits="MSEEK" CodeFile="MSEEK.aspx.cs" %>
                            ...
                            <table style="width: 100%">
                                <tr style="vertical-align: central">
                                    <td style="width: 200px">
                                        <asp:TextBox ID="txtsearch" runat="server" TabIndex="1" Width="100%" CssClass="txtsrch" AutoCompleteType="Disabled" EnableViewState="false"
                                    ...
                                    <td style="float: left">
                                        <asp:ImageButton ID="imgproc" runat="server" ImageUrl="~/tej-base/css/images/submitimg1.png"
                                            Width="140px" ToolTip="Click here to proceed"
                                            OnClick="imgproc_Click" />
                                    </td>
                                    <td>
                                        <span class="font_css" style="margin-left: 30%">Show Rows</span>
                            ...
                            <asp:UpdatePanel ID="upd1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="GridView1" runat="server"
                                        ...
                                        Style="font-family: Arial, Helvetica, sans-serif; font-size: small" AllowPaging="true" OnPageIndexChanging="GridView1_PageIndexChanging1" PageSize="30"
                                        ...
                                        <EmptyDataTemplate>
                                            <asp:Image ID="imgdata" runat="server" ImageUrl="../images/norecords.png" Style="float: left" AlternateText="No Data Exist" />
                                        </EmptyDataTemplate>
                                    </asp:GridView>
                                </ContentTemplate>
                            </asp:UpdatePanel>
