<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master.master" AutoEventWireup="true" Inherits="om_wbtgpop_mst" CodeFile="om_wbtgpop_mst.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div>
                        <div class="box-body">
                            <div class="form-group">
                                <label id="Label1" runat="server" class="col-sm-4 control-label" title="lbl1">Vchnum</label>
                                <div class="col-sm-8">
                                    <input id="txtvchnum" type="text" class="form-control" runat="server" placeholder="Opt No." readonly="readonly" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label id="Label8" runat="server" class="col-sm-4 control-label" title="lbl1">Vchdate</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl2" type="text" class="form-control" runat="server" maxlength="70"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="lbl3" runat="server" class="col-sm-3 control-label" title="lbl1">Grp Code</label>
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl3" type="text" class="form-control"  runat="server" placeholder=" " maxlength="10" />
                                </div>
                            </div>
                ...
                <div class="col-md-6">
                    <div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label id="Label2" runat="server" class="col-sm-4 control-label" title="lbl1">Parameter_1</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl5" type="text" class="form-control"  onkeyup="cal()" runat="server" placeholder="" onkeypress="return isDecimalKey(event)" maxlength="15"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label3" runat="server" class="col-sm-4 control-label" title="lbl1">Parameter_2</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl6" type="text" readonly="true" class="form-control" runat="server" placeholder="" maxlength="15" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label id="Label4" runat="server" class="col-sm-4 control-label" title="lbl1">Parameter_3</label>
                                <div class="col-sm-8">
                                    <input id="txtlbl7" type="text" readonly="true" class="form-control" runat="server" placeholder="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="txtlbl9" type="text" class="form-control" runat="server" placeholder="" />
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function cal() {
            var HEIGHT = 0; var width = 0; var length = 0;          
            HEIGHT = fill_zero(document.getElementById("ContentPlaceHolder1_txtlbl5").value);
            width = HEIGHT * 25.4;
            length = HEIGHT * 8;
            document.getElementById('ContentPlaceHolder1_txtlbl6').value = width.toFixed(3);
            document.getElementById('ContentPlaceHolder1_txtlbl7').value = length.toFixed(3);
        }
        function fill_zero(val) { if (isNaN(val)) return 0; if (isFinite(val)) return val; }
