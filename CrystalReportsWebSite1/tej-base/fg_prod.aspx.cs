...
public partial class fg_prod : System.Web.UI.Page
{
    ...
    public void make_qry_4_popup()
    {
        ...
        switch (btnval)
        {
            ...
            case "TICODE":
                //pop2
                SQuery = "SELECT TYPE1,NAME AS STATE ,TYPE1 AS CODE FROM TYPE WHERE ID='1' AND TYPE1 LIKE '6%' and type1 not in ('6R') ORDER BY TYPE1";
            ...
            switch (btnval)
            {
                ...
                case "SG1_ROW_ADD":
                    ...
                    if (ViewState["sg1"] != null)
                    {
                        ...
                        if (col1.Trim().Length < 8) SQuery = "select '-' as po_no,'-' as fstr,a.Icode,a.iname,a.cpartno,a.cdrgno,a.irate,a.unit,'0' as Stock_Qty,a.hscode,b.num4,b.num5,b.num6,b.num7 from item a,typegrp b where trim(a.hscode)=trim(b.acref) and b.id='T1' and trim(a.icode) in (" + col1 + ")";
                        //else SQuery = "select '-' as po_no,'-' as fstr,a.Icode,a.iname,a.cpartno,a.cdrgno,a.irate,a.unit,a.hscode,b.num4,b.num5,b.num6,b.num7  from item a,typegrp b where trim(a.hscode)=trim(b.acref) and b.id='T1' and trim(a.icode) in (" + col1 + ")";
                            ...
                            SQuery = "select distinct '-' as po_no,'-' as fstr,c.revis_no as trackno,a.Icode,a.iname,a.cpartno,a.cdrgno,c.Stock_Qty,a.irate,a.unit,a.hscode,b.num4,b.num5,b.num6,b.num7 " +
                             "from item a,typegrp b,(" + pop_qry + ") c where trim(a.hscode)=trim(b.acref)  " +
                        ...
                        for (int d = 0; d < dt.Rows.Count; d++)
                        {
                            ...
                            sg1_dr["sg1_t1"] = dt.Rows[d]["Stock_Qty"].ToString().Trim();
                            sg1_dr["sg1_t2"] = dt.Rows[d]["Stock_Qty"].ToString().Trim();
                            sg1_dr["sg1_t3"] = "";
                            sg1_dr["sg1_t4"] = "";
                            sg1_dr["sg1_t5"] = "";
    ...
    void Type_Sel_query()
    {
        ...
        SQuery = "SELECT type1 AS FSTR,NAME,type1 AS CODE FROM type where id='M' and type1 like '1%' and type1 in ('15','17') order by type1";
    }
    //------------------------------------------------------------------------------------
    void setGST()
    {
