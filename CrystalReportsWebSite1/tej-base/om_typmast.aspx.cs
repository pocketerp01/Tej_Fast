...
public partial class om_typmast : System.Web.UI.Page
{
    ...
    void setColHeadings()
    {
        ...
        if (Prg_Id == "P13003B") tdDD.Visible = true;
        else { }
        tdDD.Visible = false;
    ...
    public void set_Val()
    {
        ...
        switch (Prg_Id)
        {
            ...
            case "P13003M":
                ...
                break;
            case "P13003M1":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "A7");
                break;
            case "P13003O":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "P8");
                break;
            case "P13003Q":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "P9");
                break;
            case "P13003D":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "D1");
                break;
            case "P13003N":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "M1");
                break;
            case "P13003N1":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "MS");
                break;
            case "P13003B":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "A1");
                break;
            case "P13003F":
                fgenMV.Fn_Set_Mvar(frm_qstr, "U_VTY", "PD");
                break;
            case "P13003F1":
        ...
        switch (btnval)
        {
            ...
            default:
                if (btnval == "Edit_E" || btnval == "Del_E" || btnval == "Print_E")
                    SQuery = "select distinct trim(A." + doc_nf.Value + ")||to_Char(a." + doc_df.Value + ",'dd/mm/yyyy') as fstr,a." + doc_nf.Value + " as entry_no,to_char(a." + doc_df.Value + ",'dd/mm/yyyy') as entry_Dt,a.Name,a.req_name as col1,a.req_by as col2,a.MEnt_by,to_char(a.Ment_Dt,'dd/mm/yyyy') as Ent_dt,to_Char(a." + doc_df.Value + ",'yyyymmdd') as vdd from " + frm_tabname + " a where  a.branchcd='" + frm_mbr + "' and a.type='" + lbl1a.Text + "' order by vdd desc,a." + doc_nf.Value + " desc";
                break;
        }
    ...
    protected void btnsave_ServerClick(object sender, EventArgs e)
    {
        ...
        {
            if (Prg_Id == "P13003O" || Prg_Id == "P13003D1") fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Dept. Type Not Filled Correctly !!");
            else fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Requested by Not Filled Correctly !!");
            return;
        }
        if (TextName.Text.Trim().Length < 2)
        {
            fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Master Name Not Filled Correctly !!");
            return;
        }
        Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
        if (Prg_Id == "P13003K" || Prg_Id == "P13003M")
        {
            if (txtlbl7.Text.Trim().Length < 2)
            {
                fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Login Ref Not Linked Correctly !!");
                return;
            }
            if (fgen.make_double(txtlbl9.Text.Trim()) <= 0)
            {
                fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Hrly Cost Not Entered Correctly !!");
                return;
            }
        }
        if (Prg_Id == "P13003A")
        {
            if (txtlbl7.Text.Trim().Length < 2)
            {
                fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Department Not Linked Correctly !!");
                return;
            }
        }
        ...
        //    {
        //        fgen.msg("-", "AMSG", "Dear " + frm_uname + " , Description Not Linked Correctly !!");
        //        return;
        //    }
        //}
            ...
            switch (btnval)
            {
                ...
                case "Edit_E":
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtlbl3.Text = dt.Rows[i]["ment_Date"].ToString().Trim();

                        txtlbl5.Text = dt.Rows[i]["mapp_by"].ToString().Trim();
                        txtlbl6.Text = dt.Rows[i]["mapp_Date"].ToString().Trim();

                        txtlbl4.Text = dt.Rows[i]["req_by"].ToString().Trim();
                        txtlbl4a.Text = dt.Rows[i]["req_name"].ToString().Trim();


                        txtlbl7.Text = dt.Rows[i]["log_Ref"].ToString().Trim();
                        if (Prg_Id == "P13003A") { txtlbl7a.Text = fgen.seek_iname(frm_qstr,frm_cocd, "select name from proj_mast where branchcd!='DD' and type='P8' and trim(acode)='" + txtlbl7.Text.Trim() + "' ", "name"); }
                        else txtlbl7a.Text = fgen.seek_iname(frm_qstr,frm_cocd, "select username from evas where branchcd!='DD' and trim(userid)='" + txtlbl7.Text.Trim() + "'", "username");

                        txtlbl8.Text = dt.Rows[i]["desig"].ToString().Trim();
                        if(frm_formID== "P13003B")
                        {
                            txtlbl8.Text = "";
                            txtlbl7a.Text = dt.Rows[i]["desig"].ToString().Trim();
                        }
                        txtlbl9.Text = dt.Rows[i]["hrcost"].ToString().Trim();
                        ...
                        if (Prg_Id == "P13003B")
                        {
                            try
                            {
                                dd1.SelectedItem.Text = dt.Rows[i]["log_ref"].ToString().Trim();
                            }
                            catch { }
                        }
    ...
    protected void btnlbl4_Click(object sender, ImageClickEventArgs e)
    {
        ...
        make_qry_4_popup();
        fgen.Fn_open_sseek("Select", frm_qstr);
    }
    //------------------------------------------------------------------------------------
    ...
    void save_fun()
    {
        ...
        oporow["ACODE"] = frm_vnum;

        oporow["REQ_BY"] = txtlbl4.Text;
        oporow["REQ_Name"] = txtlbl4a.Text;

        oporow["log_rEf"] = txtlbl7.Text;
        if (Prg_Id == "P13003K" || Prg_Id == "P13003M")
        {
            oporow["log_ref"] = txtlbl7.Text;
            oporow["desig"] = txtlbl8.Text;
            oporow["hrcost"] = fgen.make_double(txtlbl9.Text);
        }
        if (Prg_Id == "P13003B")
        {
    ...
    void Acode_Sel_query()
    {
        ...
        if (Prg_Id == "P13003O") SQuery = "SELECT '1' as fstr,'Support' as name,'-' as s from dual union all SELECT '2' as fstr,'Offshore' as name,'-' as s from dual union all SELECT '3' as fstr,'Regular' as name,'-' as s from dual";
        if (Prg_Id == "P13003D1" || Prg_Id == "P13003B") SQuery = "select acode,name as dept,acode as code from proj_mast where type='P8' order by acode";
    }
    void Icode_Sel_query()
    {
        Prg_Id = fgenMV.Fn_Get_Mvar(frm_qstr, "U_FORMID");
        SQuery = "SELECT Userid,Username,Userid AS CODE FROM evas WHERE trim(nvl(close_by,'-'))='-' order by Username";
        if (Prg_Id == "P13003A") SQuery = "select acode,name as dept,acode as code from proj_mast where type='P8' order by acode";
    }
    ...
    void Type_Sel_query()
    {
        ...
        switch (Prg_Id)
        {
            ...
            case "P13003O":
                ...
                break;
            case "P13003Q":
                SQuery = "SELECT 'P9' AS FSTR,'Proj.Category Master' as NAME,'P9' AS CODE FROM dual";
                break;
            case "P13003D":
                SQuery = "SELECT 'D1' AS FSTR,'Designation Master' as NAME,'D1' AS CODE FROM dual";
                break;
            case "P13003N":
                SQuery = "SELECT 'M1' AS FSTR,'Milestone Master' as NAME,'M1' AS CODE FROM dual";
                break;
            case "P13003N1":
                SQuery = "SELECT 'MS' AS FSTR,'Milestone Status Master' as NAME,'MS' AS CODE FROM dual";
                break;
            case "P13003F":
                SQuery = "SELECT 'PD' AS FSTR,'Project Documentation Detail' as NAME,'PD' AS CODE FROM dual";
                break;
            case "P13003F1":
                SQuery = "SELECT 'DS' AS FSTR,'Documentation Status Master' as NAME,'DS' AS CODE FROM dual";
                break;
            case "P13003D1":
                SQuery = "SELECT 'CS' AS FSTR,'Customer Master' as NAME,'CS' AS CODE FROM dual";
                break;
            case "P13003B":
                SQuery = "SELECT 'A1' AS FSTR,'Activity Master' as NAME,'A1' AS CODE FROM dual";
                break;
            case "P13003M1":
                SQuery = "SELECT 'A7' AS FSTR,'Offload Assignee Master' as NAME,'A7' AS CODE FROM dual";
                break;
        }
    }
