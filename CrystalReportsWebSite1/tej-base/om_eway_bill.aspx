<%@ Page Language="C#" MasterPageFile="~/tej-base/Fin_Master2.master" AutoEventWireup="true" CodeFile="om_eway_bill.aspx.cs" Inherits="om_eway_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
        <section class="content-header">
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Label ID="lblheader" runat="server" Font-Bold="True" Font-Size="X-Large">E Way Bill Generation/Updation</asp:Label></td>
                    <td style="text-align: right">
                        ...
                        <button type="submit" id="btnlist" class="btn btn-info" style="width: 100px;" runat="server" accesskey="t" onserverclick="btnlist_ServerClick">E Way Bill Lis<u>t</u></button>
                        <button type="submit" id="btnshow" class="btn btn-info" style="width: 200px;" runat="server" accesskey="X" onserverclick="btnshow_ServerClick">Document List with E-way Bill</button>
                        <button type="submit" id="btncancel" class="btn btn-info" style="width: 100px;" runat="server" accesskey="c" onserverclick="btncancel_ServerClick"><u>C</u>ancel</button>
                        <button type="submit" id="btnprint" class="btn btn-info" style="width: 100px;" runat="server" accesskey="c" onserverclick="btnprint_ServerClick1">Print</button>
                        <button type="submit" id="btnexit" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" onserverclick="btnexit_ServerClick">E<u>x</u>it</button>

                        <button type="submit" id="btnjson" class="btn btn-info" style="width: 100px;" runat="server" visible="false" accesskey="X" onserverclick="btnjson_ServerClick">j<u>s</u>on</button>
                        <button type="submit" id="btnwebtel" class="btn btn-info" style="width: 100px;" runat="server" accesskey="X" visible="false" onserverclick="btnwebtel_ServerClick">Auto<u>ma</u>tic</button>
                        ...
                        <div class="box-body" style="">
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtvchnum" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl4a" runat="server" Width="350px" ReadOnly="true" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl7" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl7a" runat="server" Width="350px" ReadOnly="true" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl101" runat="server" Text="lbl101" CssClass="col-sm-2 control-label" Visible="false"></asp:Label></td>
                                    <td>
                                        <asp:ImageButton ID="btnlbl101" runat="server" ImageUrl="../tej-base/css/images/bdsearch5.png" Style="width: 22px; float: right;" OnClick="btnlbl101_Click" Visible="false" /></td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl101" runat="server" Width="80px" ReadOnly="true" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-sm-4">
                                            <asp:TextBox ID="txtlbl101a" runat="server" Width="350px" ReadOnly="true" Visible="false"></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="box-body" style="justify-content: center; align-items: center;">
                            <div class="col-sm-12">
                                <button type="submit" id="showbtn" class="btn btn-success" style="width: 300px; height: 30px; text-align: center" runat="server" accesskey="X" onserverclick="showbtn_ServerClick">1) Show Invoice To Update Eway Bill</button>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" id="command2" class="btn btn-success" style="width: 300px; height: 30px; text-align: center" runat="server" accesskey="X" onserverclick="command2_ServerClick">2)Generate Json File</button>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" id="jsonbtn" class="btn btn-success" style="width: 300px; height: 30px;" runat="server" accesskey="X" visible="true" onserverclick="jsonbtn_ServerClick">3) Automatically Generate Eway Bill No.</button>
                            </div>
                                        ...
                                        <asp:GridView ID="sg1" runat="server" ForeColor="#333333"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="sg1_t11" runat="server" Text='<%#Eval("sg1_t11") %>' Width="100%"  onkeyup="openBox(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
    ...
    <asp:HiddenField ID="hf_eway_ok" runat="server" />
    <asp:HiddenField ID="hf_filebase" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function downloadme() {
            ...
            var bs64 = $("[id*=hf_filebase]").val();
            if (bs64.length > 100) {
                var nm = $("[id*=filename]").val();
                var pdf = 'data:application/octet-stream;base64,' + bs64;
