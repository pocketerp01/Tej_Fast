...
var videoDialog = function videoDialog(opt) {
  ...
  var footer = ['<button type="button" href="#" class="note-btn note-btn-success note-video-btn disabled" disabled>', opt.lang.video.insert, '</button>'].join('');
  return dialog({
...
var imageDialog = function imageDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-success note-btn-large note-image-btn disabled" disabled>', opt.lang.image.insert, '</button>'].join('');
  return dialog({
...
var linkDialog = function linkDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-success note-link-btn disabled" disabled>', opt.lang.link.insert, '</button>'].join('');
  return dialog({
    className: 'link-dialog',
