...
!function($) {
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function setValidPosition(pos, validTest, fromSetValid, isSelection) {
            if (isSelection || opts.insertMode && void 0 !== getMaskSet().validPositions[pos] && void 0 === fromSetValid) {
                ...
                for (i = j = pos; lvp >= i; i++) {
                    ...
                    if (void 0 !== t) for (var posMatch = j, prevPosMatch = -1; posMatch < getMasklen() && (null == t.match.fn && vps[i] && (vps[i].match.optionalQuantifier === !0 || vps[i].match.optionality === !0) || null != t.match.fn); ) {
        ...
        function isValid(pos, c, strict, fromSetValid) {
            ...
            maskPos < getMasklen() && (result = _isValid(maskPos, c, strict, fromSetValid), 
        ...
        function keydownEvent(e) {
            ...
            opts.showTooltip && (input.title = opts.tooltip || getMaskSet().mask); else if (k === Inputmask.keyCode.END || k === Inputmask.keyCode.PAGE_DOWN) {
                ...
                opts.insertMode || caretPos !== getMasklen() || e.shiftKey || caretPos--, caret(input, e.shiftKey ? pos.begin : caretPos, caretPos, !0);
            ...
            pos.end = seekNext(pos.begin, !0), pos.end < getMasklen() && pos.end--), pos.begin < getMasklen() && (e.preventDefault(), 
            ...
            }, 0)) : (opts.insertMode = !opts.insertMode, caret(input, opts.insertMode || pos.begin !== getMasklen() ? pos.begin : pos.begin - 1));
        ...
        function pasteEvent(e) {
            ...
            var valueBeforeCaret = inputValue.substring(0, caretPos.begin), valueAfterCaret = inputValue.substring(caretPos.end, inputValue.length);
    ...
    return Inputmask.extendDefinitions({
        ...
        "dd/mm/yyyy": {
            ...
            getFrontValue: function(mask, buffer, opts) {
                ...
                return buffer.join("").substring(start, length);
            },
            definitions: {
                "1": {
                ...
                "2": {
                    validator: function(chrs, maskset, pos, strict, opts) {
                        ...
                        if (opts.mask.indexOf("2") === opts.mask.length - 1 && isValid) {
                            var dayMonthValue = maskset.buffer.join("").substring(4, 4) + chrs;
                            if (dayMonthValue !== opts.leapday) return !0;
                            var year = parseInt(maskset.buffer.join("").substring(0, 4), 10);
                ...
                y: {
                    validator: function(chrs, maskset, pos, strict, opts) {
                        if (opts.isInYearRange(chrs, opts.yearrange.minyear, opts.yearrange.maxyear)) {
                            var dayMonthValue = maskset.buffer.join("").substring(0, 6);
                            if (dayMonthValue !== opts.leapday) return !0;
                            ...
                            for (var mndx = 0; mndx < token.matches.length; mndx++) {
                                ...
                                if (matchToken.isGroup === !0) isvalid = validateRegexToken(matchToken, !0); else if (matchToken.isQuantifier === !0) {
                                    ...
                                    if ("[" == matchToken.charAt(0)) {
                                        ...
                                        testExp = regexPart, testExp += matchToken.substring(0, l + 1), testExp = testExp.replace(/\|$/, "");
                                        for (var j = 0; openGroupCount > j; j++) testExp += ")";
                                        var exp = new RegExp("^(" + testExp + ")$");
